...
type
  TInfoWIPWashingSubkonFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoWIPWashingSubkonFrm: TInfoWIPWashingSubkonFrm;

implementation

uses dm, Filter, DaftarPerkiraan, LaporanBC, InfoWIPCutting1,
  InfoWIPCutting2, InfoWIPCuttingSubkon;
...
procedure TInfoWIPWashingSubkonFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoWIPWashingSubkonFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoWIPWashingSubkonFrm:=Nil;
end;

procedure TInfoWIPWashingSubkonFrm.FormPaint(Sender: TObject);
begin
...
procedure TInfoWIPWashingSubkonFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TInfoWIPWashingSubkonFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TInfoWIPWashingSubkonFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TInfoWIPWashingSubkonFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoWIPWashingSubkonFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoWIPWashingSubkonFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoWIPWashingSubkonFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoWIPWashingSubkonFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoWIPWashingSubkonFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoWIPWashingSubkonFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoWIPWashingSubkonFrm.tbPrintClick(Sender: TObject);
begin
  {
...
procedure TInfoWIPWashingSubkonFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPWashingSubkonFrm.CheckBox3Click(Sender: TObject);
begin
  qB6.Filtered:=CheckBox3.Checked;  //qB6.Filtered:=CheckBox3.Checked;
end;

procedure TInfoWIPWashingSubkonFrm.qB6FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(
...
procedure TInfoWIPWashingSubkonFrm.qB6CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoWIPWashingSubkonFrm.qB6BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB6.RecordCount);
end;

procedure TInfoWIPWashingSubkonFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPWashingSubkonFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPWashingSubkonFrm.QRBand22BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPWashingSubkonFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TInfoWIPWashingSubkonFrm.qB6AfterOpen(DataSet: TDataSet);
begin
  CheckBox1.Checked:=False;
end;

procedure TInfoWIPWashingSubkonFrm.CheckBox1Click(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPWashingSubkonFrm.wwDBGrid5RowChanged(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPWashingSubkonFrm.qBdetailBeforeOpen(DataSet: TDataSet);
begin
