...
var
  HasilSewingFrm: THasilSewingFrm;

implementation

uses dm, Filter, PemakaianBahan, TerimaBB, HasilCutting;
...
procedure THasilSewingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure THasilSewingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  HasilSewingFrm:=Nil;
end;

procedure THasilSewingFrm.FormPaint(Sender: TObject);
begin
...
procedure THasilSewingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure THasilSewingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure THasilSewingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure THasilSewingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure THasilSewingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure THasilSewingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilSewingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure THasilSewingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure THasilSewingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure THasilSewingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure THasilSewingFrm.tsInputShow(Sender: TObject);
begin
...
procedure THasilSewingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  qBMasterKD_FORM.AsString:=vkd_transaksi;
  qBMasterTGL.AsDateTime:=vtgl_bukti;
  qBMasterKD_LOKASI.AsString:='62';
...
procedure THasilSewingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure THasilSewingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure THasilSewingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure THasilSewingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure THasilSewingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure THasilSewingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure THasilSewingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='214';
...
procedure THasilSewingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure THasilSewingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure THasilSewingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure THasilSewingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure THasilSewingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure THasilSewingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure THasilSewingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure THasilSewingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure THasilSewingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilSewingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure THasilSewingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure THasilSewingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure THasilSewingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure THasilSewingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure THasilSewingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure THasilSewingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilSewingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilSewingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilSewingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure THasilSewingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilSewingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilSewingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilSewingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilSewingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilSewingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilSewingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilSewingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilSewingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilSewingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilSewingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilSewingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilSewingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilSewingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure THasilSewingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure THasilSewingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure THasilSewingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure THasilSewingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('pno_bom').AsString:=FloatToStr(qBMasterNO_BOM.AsFloat);
end;

procedure THasilSewingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure THasilSewingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure THasilSewingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilSewingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure THasilSewingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure THasilSewingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure THasilSewingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure THasilSewingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure THasilSewingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure THasilSewingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure THasilSewingFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
...
procedure THasilSewingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
  qBomD.Close;
  qBomD.Open;
end;

procedure THasilSewingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
