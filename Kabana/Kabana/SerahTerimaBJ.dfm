object SerahTerimaBJFrm: TSerahTerimaBJFrm
        ...
        object qrMaster: TQuickRep
          ...
          object TitleBand1: TQRBand
            ...
            object QRLabel11: TQRLabel
              ...
              AutoSize = True
              AutoStretch = False
              Caption = 'REKAP SERAH TERIMA BARANG JADI'
              Color = clWhite
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -19
  ...
  object qBDetail2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vprint_hasil_produksi'
    ...
    object qBDetail2NO_REG_BUKTI: TFloatField
    ...
    object qBDetail2KD_LOKASI2: TStringField
      FieldName = 'KD_LOKASI2'
      Size = 12
    end
  end
  object qBDetail3: TSmartQuery
    ...
    object qBDetail3JENIS: TStringField
      FieldName = 'JENIS'
      Size = 50
    end
  end
  ...
  object qBDetail4: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select no_reg_os, kd_item, keterangan, sat_d, sum(qty_d) as qty_' +
        'd, sum(kg_d) as kg_d'
      'from VBON_WASTE_REKAP'
      'where no_reg_os=:no_reg_os'
    ...
    object qBDetail4NO_REG_OS: TFloatField
      FieldName = 'NO_REG_OS'
    end
    object qBDetail4KD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Size = 12
    end
    object qBDetail4KETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Size = 255
    end
    object qBDetail4SAT_D: TStringField
      FieldName = 'SAT_D'
      Size = 12
    end
  ...
  object qBom2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select a.* from'
      '('
      ' select a.*, b.no_reff, c.no_reff as no_reff2 from bom_d a'
      ' left join bom b on a.no_reg_os=b.no_reg_os and b.ispost='#39'1'#39
      ' left join kontrak c on b.no_reff=c.no_reg_os'
      ') a,'
      '('
      ' select distinct to_number(substr(b.kd_item,1,6)) as no_bom'
      ' from'
      '  wip_finishing a,'
      '  wip_finishing_d b'
      
        ' where a.no_bukti=:no_load and a.ispost='#39'1'#39' and a.no_reg_os=b.no' +
        '_reg_os'
      ') b'
      'where a.no_reg_d=b.no_bom')
    ReadOnly = True
    Left = 1139
    Top = 368
    ParamData = <
    ...
    object qBom2NO_REG_D: TFloatField
      FieldName = 'NO_REG_D'
      Required = True
    end
    object qBom2NO_REG_OS: TFloatField
      FieldName = 'NO_REG_OS'
      Required = True
    end
    object qBom2STYLE: TStringField
      FieldName = 'STYLE'
      Required = True
      Size = 128
    end
    object qBom2ITEM: TStringField
      FieldName = 'ITEM'
      Required = True
      Size = 50
    end
    object qBom2KELOMPOK: TStringField
      FieldName = 'KELOMPOK'
      Required = True
      Size = 50
    end
    object qBom2COLOR: TStringField
      FieldName = 'COLOR'
      Required = True
      Size = 50
    end
    object qBom2SATUAN: TStringField
      FieldName = 'SATUAN'
      Required = True
      Size = 12
    end
    object qBom2XXS: TFloatField
      FieldName = 'XXS'
      Required = True
    end
    object qBom2XS: TFloatField
      FieldName = 'XS'
      Required = True
    end
    object qBom2S: TFloatField
      FieldName = 'S'
      Required = True
    end
    object qBom2M: TFloatField
      FieldName = 'M'
      Required = True
    end
    object qBom2L: TFloatField
      FieldName = 'L'
      Required = True
    end
    object qBom2XL: TFloatField
      FieldName = 'XL'
      Required = True
    end
    object qBom2X0: TFloatField
      FieldName = 'X0'
      Required = True
    end
    object qBom2X1: TFloatField
      FieldName = 'X1'
      Required = True
    end
    object qBom2X2: TFloatField
      FieldName = 'X2'
      Required = True
    end
    object qBom2X3: TFloatField
      FieldName = 'X3'
      Required = True
    end
    object qBom2TOT_QTY: TFloatField
      FieldName = 'TOT_QTY'
      Required = True
    end
    object qBom2KETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Size = 255
    end
    object qBom2SIZE01: TFloatField
      FieldName = 'SIZE01'
      Required = True
    end
    object qBom2SIZE02: TFloatField
      FieldName = 'SIZE02'
      Required = True
    end
    object qBom2SIZE03: TFloatField
      FieldName = 'SIZE03'
      Required = True
    end
    object qBom2SIZE04: TFloatField
      FieldName = 'SIZE04'
      Required = True
    end
    object qBom2SIZE05: TFloatField
      FieldName = 'SIZE05'
      Required = True
    end
    object qBom2SIZE06: TFloatField
      FieldName = 'SIZE06'
      Required = True
    end
    object qBom2SIZE07: TFloatField
      FieldName = 'SIZE07'
      Required = True
    end
    object qBom2SIZE08: TFloatField
      FieldName = 'SIZE08'
      Required = True
    end
    object qBom2SIZE09: TFloatField
      FieldName = 'SIZE09'
      Required = True
    end
    object qBom2SIZE10: TFloatField
      FieldName = 'SIZE10'
      Required = True
    end
    object qBom2SIZE11: TFloatField
      FieldName = 'SIZE11'
      Required = True
    end
    object qBom2SIZE12: TFloatField
      FieldName = 'SIZE12'
      Required = True
    end
    object qBom2SIZE13: TFloatField
      FieldName = 'SIZE13'
      Required = True
    end
    object qBom2SIZE14: TFloatField
      FieldName = 'SIZE14'
      Required = True
    end
    object qBom2SIZE15: TFloatField
      FieldName = 'SIZE15'
      Required = True
    end
    object qBom2LXXS: TStringField
      FieldName = 'LXXS'
      Size = 50
    end
    object qBom2LXS: TStringField
      FieldName = 'LXS'
      Size = 50
    end
    object qBom2LS: TStringField
      FieldName = 'LS'
      Size = 50
    end
    object qBom2LM: TStringField
      FieldName = 'LM'
      Size = 50
    end
    object qBom2LL: TStringField
      FieldName = 'LL'
      Size = 50
    end
    object qBom2LXL: TStringField
      FieldName = 'LXL'
      Size = 50
    end
    object qBom2LX0: TStringField
      FieldName = 'LX0'
      Size = 50
    end
    object qBom2LX1: TStringField
      FieldName = 'LX1'
      Size = 50
    end
    object qBom2LX2: TStringField
      FieldName = 'LX2'
      Size = 50
    end
    object qBom2LX3: TStringField
      FieldName = 'LX3'
      Size = 50
    end
    object qBom2LSIZE01: TStringField
      FieldName = 'LSIZE01'
      Size = 50
    end
    object qBom2LSIZE02: TStringField
      FieldName = 'LSIZE02'
      Size = 50
    end
    object qBom2LSIZE03: TStringField
      FieldName = 'LSIZE03'
      Size = 50
    end
    object qBom2LSIZE04: TStringField
      FieldName = 'LSIZE04'
      Size = 50
    end
    object qBom2LSIZE05: TStringField
      FieldName = 'LSIZE05'
      Size = 50
    end
    object qBom2LSIZE06: TStringField
      FieldName = 'LSIZE06'
      Size = 50
    end
    object qBom2LSIZE07: TStringField
      FieldName = 'LSIZE07'
      Size = 50
    end
    object qBom2LSIZE08: TStringField
      FieldName = 'LSIZE08'
      Size = 50
    end
    object qBom2LSIZE09: TStringField
      FieldName = 'LSIZE09'
      Size = 50
    end
    object qBom2LSIZE10: TStringField
      FieldName = 'LSIZE10'
      Size = 50
    end
    object qBom2LSIZE11: TStringField
      FieldName = 'LSIZE11'
      Size = 50
    end
    object qBom2LSIZE12: TStringField
      FieldName = 'LSIZE12'
      Size = 50
    end
    object qBom2LSIZE13: TStringField
      FieldName = 'LSIZE13'
      Size = 50
    end
    object qBom2LSIZE14: TStringField
      FieldName = 'LSIZE14'
      Size = 50
    end
    object qBom2LSIZE15: TStringField
      FieldName = 'LSIZE15'
      Size = 50
    end
    object qBom2HRG: TFloatField
      FieldName = 'HRG'
      Required = True
    end
    object qBom2MU: TStringField
      FieldName = 'MU'
      Required = True
      Size = 3
    end
    object qBom2KURS: TFloatField
      FieldName = 'KURS'
      Required = True
    end
    object qBom2NO_REFF: TStringField
      FieldName = 'NO_REFF'
      ReadOnly = True
    end
    object qBom2NO_REFF2: TStringField
      FieldName = 'NO_REFF2'
      ReadOnly = True
      Size = 50
    end
  end
  object dsqBom2: TwwDataSource
    DataSet = qBom2
    Left = 1187
    Top = 368
  end
