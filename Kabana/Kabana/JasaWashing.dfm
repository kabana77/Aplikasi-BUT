object JasaWashingFrm: TJasaWashingFrm
  Left = 236
  Top = 152
  Width = 1340
  Height = 784
  Caption = 'JasaWashingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Pengiriman Jasa Washing'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_finishing where kd_form='#39'221'#39') a'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select distinct a.kd_item, a.keterangan as nama_item from wip_fi' +
        'nishing_d a'
      
        'left join (select * from wip_finishing where kd_form = '#39'218'#39' and' +
        ' ispost='#39'1'#39') b on a.no_reg_os=b.no_reg_os')
    Left = 832
    Top = 291
