...
begin
  ...
  begin
    DMFrm.pLogin;
    if DMFrm.vDivisi<>'SYS' then Proc_Aktifkan_Menu;
  end;
...
procedure TMainFrm.LoadingHasilSewingOUT1Click(Sender: TObject);
begin
if TFSewingFrm=nil then TFSewingFrm:=TTFSewingFrm.Create(Application);
  TFSewingFrm.Caption:=StringReplace((Sender as TMenuItem).Caption,'&','',[rfReplaceAll]);
  TFSewingFrm.pTop.Caption:=' '+UpperCase(TFSewingFrm.Caption);
  if DMFrm.qMenuUser.Locate('NAMA_MENU',(Sender as TMenuItem).Name,[loPartialKey]) then
  begin
     TFSewingFrm.vCanAdd:=(DMFrm.qMenuUserISADD.AsString='+');
     TFSewingFrm.vCanEdit:=(DMFrm.qMenuUserISEDIT.AsString='+');
     TFSewingFrm.vCanDel:=(DMFrm.qMenuUserISDEL.AsString='+');
     TFSewingFrm.vCanPrint:=(DMFrm.qMenuUserISPRINT.AsString='+');
     TFSewingFrm.vCanExport:=(DMFrm.qMenuUserISEXPORT.AsString='+');
     TFSewingFrm.vCanUnPost:=(DMFrm.qMenuUserISUNPOST.AsString='+');
  end
  else
  begin
     TFSewingFrm.vCanAdd:=False;
     TFSewingFrm.vCanEdit:=False;
     TFSewingFrm.vCanDel:=False;
     TFSewingFrm.vCanPrint:=False;
     TFSewingFrm.vCanExport:=False;
     TFSewingFrm.vCanUnPost:=False;
  end;
  TFSewingFrm.Show;
end;

procedure TMainFrm.erimaHasilSewingIN1Click(Sender: TObject);
begin
  if TerimaHslSewingFrm=nil then TerimaHslSewingFrm:=TTerimaHslSewingFrm.Create(Application);
     TerimaHslSewingFrm.Caption:=StringReplace((Sender as TMenuItem).Caption,'&','',[rfReplaceAll]);
     TerimaHslSewingFrm.pTop.Caption:=' '+UpperCase(TerimaHslSewingFrm.Caption);
  if DMFrm.qMenuUser.Locate('NAMA_MENU',(Sender as TMenuItem).Name,[loPartialKey]) then
  begin
     TerimaHslSewingFrm.vCanAdd:=(DMFrm.qMenuUserISADD.AsString='+');
     TerimaHslSewingFrm.vCanEdit:=(DMFrm.qMenuUserISEDIT.AsString='+');
     TerimaHslSewingFrm.vCanDel:=(DMFrm.qMenuUserISDEL.AsString='+');
     TerimaHslSewingFrm.vCanPrint:=(DMFrm.qMenuUserISPRINT.AsString='+');
     TerimaHslSewingFrm.vCanExport:=(DMFrm.qMenuUserISEXPORT.AsString='+');
     TerimaHslSewingFrm.vCanUnPost:=(DMFrm.qMenuUserISUNPOST.AsString='+');
  end
  else
  begin
     TerimaHslSewingFrm.vCanAdd:=False;
     TerimaHslSewingFrm.vCanEdit:=False;
     TerimaHslSewingFrm.vCanDel:=False;
     TerimaHslSewingFrm.vCanPrint:=False;
     TerimaHslSewingFrm.vCanExport:=False;
     TerimaHslSewingFrm.vCanUnPost:=False;
  end;
  TerimaHslSewingFrm.Show;
end;

procedure TMainFrm.InfoWIPSewing21Click(Sender: TObject);
begin
  if InfoWIPSewing2Frm=nil then InfoWIPSewing2Frm:=TInfoWIPSewing2Frm.Create(Application);
  InfoWIPSewing2Frm.Caption:=StringReplace((Sender as TMenuItem).Caption,'&','',[rfReplaceAll]);
  InfoWIPSewing2Frm.pTop.Caption:='     '+StringReplace(InfoWIPSewing2Frm.TabSheet6.Caption,'&','',[rfReplaceAll]);
  if DMFrm.qMenuUser.Locate('NAMA_MENU',(Sender as TMenuItem).Name,[loPartialKey]) then
  begin
     InfoWIPSewing2Frm.vCanAdd:=(DMFrm.qMenuUserISADD.AsString='+');
     InfoWIPSewing2Frm.vCanEdit:=(DMFrm.qMenuUserISEDIT.AsString='+');
     InfoWIPSewing2Frm.vCanDel:=(DMFrm.qMenuUserISDEL.AsString='+');
     InfoWIPSewing2Frm.vCanPrint:=(DMFrm.qMenuUserISPRINT.AsString='+');
     InfoWIPSewing2Frm.vCanExport:=(DMFrm.qMenuUserISEXPORT.AsString='+');
  end
  else
  begin
     InfoWIPSewing2Frm.vCanAdd:=False;
     InfoWIPSewing2Frm.vCanEdit:=False;
     InfoWIPSewing2Frm.vCanDel:=False;
     InfoWIPSewing2Frm.vCanPrint:=False;
     InfoWIPSewing2Frm.vCanExport:=False;
  end;
...
begin
  ...
  JasaWashingFrm.Caption:=StringReplace((Sender as TMenuItem).Caption,'&','',[rfReplaceAll]);
  JasaWashingFrm.pTop.Caption:=' '+UpperCase(JasaWashingFrm.Caption);
  if DMFrm.qMenuUser.Locate('NAMA_MENU',(Sender as TMenuItem).Name,[loPartialKey]) then
  begin
     JasaWashingFrm.vCanAdd:=(DMFrm.qMenuUserISADD.AsString='+');
     JasaWashingFrm.vCanEdit:=(DMFrm.qMenuUserISEDIT.AsString='+');
     JasaWashingFrm.vCanDel:=(DMFrm.qMenuUserISDEL.AsString='+');
     JasaWashingFrm.vCanPrint:=(DMFrm.qMenuUserISPRINT.AsString='+');
     JasaWashingFrm.vCanExport:=(DMFrm.qMenuUserISEXPORT.AsString='+');
     JasaWashingFrm.vCanUnPost:=(DMFrm.qMenuUserISUNPOST.AsString='+');
  end
  else
  begin
     JasaWashingFrm.vCanAdd:=False;
     JasaWashingFrm.vCanEdit:=False;
     JasaWashingFrm.vCanDel:=False;
     JasaWashingFrm.vCanPrint:=False;
     JasaWashingFrm.vCanExport:=False;
     JasaWashingFrm.vCanUnPost:=False;
  end;
  JasaWashingFrm.Show;
end;
