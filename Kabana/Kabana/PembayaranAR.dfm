object PembayaranARFrm: TPembayaranARFrm
  Left = 275
  Top = 186
  Width = 1191
  Height = 679
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'CARA_BAYAR'#9'12'#9'CARA BAYAR'#9'F'
            'NO_DT'#9'10'#9'SALES~INVOICE'#9'F'
            'KETERANGAN'#9'15'#9'KETERANGAN'#9'F'
            'NO_CEK_BG_TT'#9'8'#9'NO REFF'#9'F'
            'TGL_JTH_TEMPO'#9'10'#9'JTH TEMPO'#9'F'
            'NILAI'#9'10'#9'NILAI'#9'F'
            'BI_MATERAI'#9'10'#9'BI MATERAI'#9'F'
          ...
          object PageControl2: TPageControl
            ...
            object tsInputD: TTabSheet
              ...
              object dbGridD: TwwDBGrid
                ...
                Selected.Strings = (
                  'NO_BUKTI_KNTRK'#9'15'#9'KONTRAK'#9'F'#9'NOMOR BUKTI'
                  'NO_BUKTI_SJ'#9'15'#9'SURAT JALAN'#9'F'#9'NOMOR BUKTI'
                  'NO_BUKTI_SI'#9'15'#9'SLS INVOICE'#9'F'#9'NOMOR BUKTI'
                  'ID_OUTLET'#9'6'#9'KODE'#9'T'#9'C U S T O M E R'
                  'NAMA_OUTLET'#9'35'#9'NAMA'#9'T'#9'C U S T O M E R'
                  'TGL_JTH_TEMPO'#9'12'#9'JTH~TEMPO'#9'T'
                  'NILAI_FAKTUR'#9'13'#9'NILAI~TAGIHAN'#9'T'
                  'SISA_TAGIHAN'#9'13'#9'SISA~TAGIHAN'#9'T'
                  'VOUCHER_KLAIM'#9'10'#9'Klaim'#9'F'#9'VOUCHER'
                  'VOUCHER_LAIN'#9'10'#9'Lainnya'#9'F'#9'VOUCHER'
                  'BAYAR_TUNAI'#9'12'#9'Tunai'#9'F'#9'PEMBAYARAN'
                  'BAYAR_CEK'#9'11'#9'Cek/ BG'#9'F'#9'PEMBAYARAN'
                  'BAYAR_TT'#9'10'#9'Transfer'#9'F'#9'PEMBAYARAN'
                  'KOREKSI'#9'12'#9'KOREKSI'#9'T'
                  'SISA_BARU'#9'12'#9'SISA_BARU'#9'T'
                  'BI_MATERAI'#9'10'#9'BI_MATERAI'#9'F')
                IniAttributes.FileName = 'KUWUNG'
                IniAttributes.Delimiter = ';;'
                IniAttributes.CheckNewFields = True
                ExportOptions.ExportType = wwgetSYLK
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select * from (select * from vpembayaran_ar where ispost like :p' +
        'ispost)')
    ReadOnly = True
    ...
    object qB1BI_MATERAI: TFloatField
      FieldName = 'BI_MATERAI'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,#;(#,#);-'
    end
    object qB1ADJ: TFloatField
      FieldName = 'ADJ'
      ReadOnly = True
      DisplayFormat = '#,#;(#,#);-'
    end
    object qB1NO_BUKTI2: TStringField
      FieldName = 'NO_BUKTI2'
      ReadOnly = True
      Size = 15
    end
  ...
  object qBX: TOraQuery
    ...
    object qBXBI_MATERAI: TFloatField
      FieldName = 'BI_MATERAI'
    end
    object qBXADJ: TFloatField
      FieldName = 'ADJ'
    end
  end
  object qBMaster: TSmartQuery
    ...
    object qBMasterCARA_BAYAR: TStringField
      FieldName = 'CARA_BAYAR'
      Required = True
      OnChange = qBMasterCARA_BAYARChange
      Size = 12
    end
    ...
    object qBMasterBI_MATERAI: TFloatField
      FieldName = 'BI_MATERAI'
      DisplayFormat = '#,#;(#,#);-'
    end
    object qBMasterADJUSTMENT: TFloatField
      FieldName = 'ADJUSTMENT'
      DisplayFormat = '#,#;(#,#);-'
    end
    object qBMasterNO_BUKTI2: TStringField
      FieldName = 'NO_BUKTI2'
      Size = 15
    end
  end
  ...
  object qBDetail: TSmartQuery
    ...
    object qBDetailBI_MATERAI: TFloatField
      FieldName = 'BI_MATERAI'
      DisplayFormat = '#,#;(#,#);-'
    end
    ...
    object qBDetailNO_BUKTI_SI: TStringField
      FieldName = 'NO_BUKTI_SI'
      Size = 15
    end
  end
  ...
  object qBDetailX: TOraQuery
    ...
    object qBDetailXBI_MATERAI: TFloatField
      FieldName = 'BI_MATERAI'
    end
  end
  ...
  object qJurnal: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select no_reg_d, kd_perk, nama_perkiraan, debet, kredit from jur' +
        'nal'
      'where no_reg_os=:pno_reg_os'
    ...
    object qJurnalNO_REG_D: TFloatField
      FieldName = 'NO_REG_D'
      Required = True
    end
  end
  ...
  object qProc_AmbilData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_DT'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_DT(:PNO_REG_OS, :PNO_REG_OS_DT, :PDEL);'
      'end;')
    Left = 896
    Top = 195
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_DT:0'
  end
end
