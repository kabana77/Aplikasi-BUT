object InfoWIPSewing1Frm: TInfoWIPSewing1Frm
  Left = 266
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPSewing1Frm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Sewing 1'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_SEWING1'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_SEWING1(:PAWAL, :PAKHIR);'
      'end;')
    Left = 392
    Top = 291
    ParamData = <
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_sewing1'
