object TFSewingFrm: TTFSewingFrm
  Left = 278
  Top = 178
  Width = 1330
  Height = 656
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Transfer Hasil Sewing'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_sewing where kd_form='#39'216'#39') a'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'substr(b.kd_item,1,6)) as no_bom from wip_sewing a'
      'left join wip_sewing_d b on a.no_reg_os=b.no_reg_os'
      'where a.kd_form='#39'214'#39' and a.ispost='#39'1'#39
      ''
