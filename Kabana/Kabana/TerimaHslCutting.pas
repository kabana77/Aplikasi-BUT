...
type
  TTerimaHslCuttingFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  TerimaHslCuttingFrm: TTerimaHslCuttingFrm;
...
procedure TTerimaHslCuttingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TTerimaHslCuttingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  TerimaBBFrm:=Nil;
end;

procedure TTerimaHslCuttingFrm.FormPaint(Sender: TObject);
begin
...
procedure TTerimaHslCuttingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TTerimaHslCuttingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TTerimaHslCuttingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaHslCuttingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB1.RecordCount);
  //dbGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#);-', qBXSUB_TOTAL.AsFloat);
end;

procedure TTerimaHslCuttingFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TTerimaHslCuttingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TTerimaHslCuttingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TTerimaHslCuttingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TTerimaHslCuttingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TTerimaHslCuttingFrm.tsInputShow(Sender: TObject);
begin
  ...
  DMFrm.qJnsTransaksi.ParamByName('pnama_form').AsString:='TerimaHslCuttingFrm/ PENERIMAAN HASIL CUTTING';
  DMFrm.qJnsTransaksi.Open;
...
procedure TTerimaHslCuttingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaHslCuttingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TTerimaHslCuttingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TTerimaHslCuttingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaHslCuttingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TTerimaHslCuttingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TTerimaHslCuttingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  qBDetailNO_REG_OS.AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TTerimaHslCuttingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='212';
...
procedure TTerimaHslCuttingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TTerimaHslCuttingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TTerimaHslCuttingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TTerimaHslCuttingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TTerimaHslCuttingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TTerimaHslCuttingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
end;

procedure TTerimaHslCuttingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TTerimaHslCuttingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TTerimaHslCuttingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TTerimaHslCuttingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TTerimaHslCuttingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TTerimaHslCuttingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaHslCuttingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TTerimaHslCuttingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TTerimaHslCuttingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslCuttingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslCuttingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslCuttingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TTerimaHslCuttingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslCuttingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslCuttingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslCuttingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslCuttingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslCuttingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TTerimaHslCuttingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TTerimaHslCuttingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TTerimaHslCuttingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TTerimaHslCuttingFrm.BitBtn2Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TTerimaHslCuttingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('pno_reg_d2').AsFloat:=FloatField1.AsFloat;
end;

procedure TTerimaHslCuttingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TTerimaHslCuttingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TTerimaHslCuttingFrm.lcdBOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    BitBtn2Click(nil);
...
procedure TTerimaHslCuttingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslCuttingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TTerimaHslCuttingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TTerimaHslCuttingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TTerimaHslCuttingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaHslCuttingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TTerimaHslCuttingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TTerimaHslCuttingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
