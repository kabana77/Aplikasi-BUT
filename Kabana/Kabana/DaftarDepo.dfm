object DaftarDepoFrm: TDaftarDepoFrm
  Left = 229
  Top = 255
  Width = 1200
  Height = 591
  Caption = 'DaftarDepoFrm'
  Color = clWindow
  Ctl3D = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'KD_DEPO'#9'5'#9'KODE'#9'F'
            'NAMA_DEPO'#9'13'#9'NAMA_DEPO'#9'F'
            'ALAMAT'#9'24'#9'ALAMAT'#9#9
            'KOTA'#9'11'#9'KOTA'#9'F'
            'PROPINSI'#9'8'#9'PROPINSI'#9#9
            'KODEPOS'#9'8'#9'KODEPOS'#9#9
            'TELEPON'#9'8'#9'TELEPON'#9'F'
            'FAX'#9'12'#9'FAX'#9'F'
            'EMAIL'#9'5'#9'EMAIL'#9#9
            'CP'#9'9'#9'Sederhana'#9'F'#9'NO_SERI_PJK'
            'HP'#9'9'#9'Gabungan'#9'F'#9'NO_SERI_PJK'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_LOKASI'#9'50'#9'NAMA_LOKASI'#9#9)
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
          IniAttributes.Delimiter = ';;'
  ...
  object qB1: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from daftar_depo')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    IndexFieldNames = 'KD_DEPO'
  ...
  object qB2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from daftar_lokasi')
    IndexFieldNames = 'KD_LOKASI'
    Left = 803
    Top = 208
  ...
  object qB3: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from daftar_divisi')
    Active = True
    Left = 675
    Top = 184
    object qB3KD_DIV: TStringField
      FieldName = 'KD_DIV'
      Required = True
      Size = 3
    end
    object qB3DIVISI: TStringField
      FieldName = 'DIVISI'
      Size = 50
    end
  end
