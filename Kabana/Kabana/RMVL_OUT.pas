...
type
  TRMVL_OUTFrm = class(TForm)
    ...
    qB1KD_DEPO2: TStringField;
    qB1NAMA_DEPO2: TStringField;
    qBMasterKD_DEPO2: TStringField;
    qBMasterNAMA_DEPO2: TStringField;
    ...
    DBText6: TDBText;
    Label1: TLabel;
    qB1ID_EKSPEDISI: TStringField;
    qB1NAMA_EKSPEDISI: TStringField;
    QRLabel18: TQRLabel;
    QRDBText14: TQRDBText;
    QRLabel19: TQRLabel;
    QRDBText15: TQRDBText;
    qB2NAMA_EKSPEDISI: TStringField;
    qB2ID_EKSPEDISI: TStringField;
    QRLabel20: TQRLabel;
    QRLabel43: TQRLabel;
    ...
    procedure qBMasterKD_DEPO2Change(Sender: TField);
...
procedure TRMVL_OUTFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TRMVL_OUTFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.Proc_Refresh4;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.Proc_RefreshStokSales;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TRMVL_OUTFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  RMVL_OUTFrm:=Nil;
end;

procedure TRMVL_OUTFrm.FormPaint(Sender: TObject);
begin
...
procedure TRMVL_OUTFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TRMVL_OUTFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TRMVL_OUTFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TRMVL_OUTFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TRMVL_OUTFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TRMVL_OUTFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TRMVL_OUTFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TRMVL_OUTFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TRMVL_OUTFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TRMVL_OUTFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TRMVL_OUTFrm.tsInputShow(Sender: TObject);
begin
...
procedure TRMVL_OUTFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TRMVL_OUTFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TRMVL_OUTFrm.qBMasterKD_LOKASIChange(Sender: TField);
begin
...
procedure TRMVL_OUTFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TRMVL_OUTFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TRMVL_OUTFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TRMVL_OUTFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TRMVL_OUTFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  ...
  qBDetailKD_DEPO2.AsString:=qBMasterKD_DEPO2.AsString;
  qBDetailKD_LOKASI.AsString:=qBMasterKD_LOKASI.AsString;
end;

procedure TRMVL_OUTFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TRMVL_OUTFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TRMVL_OUTFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TRMVL_OUTFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TRMVL_OUTFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TRMVL_OUTFrm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TRMVL_OUTFrm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TRMVL_OUTFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailMODE_CALC.AsString:='1';
end;

procedure TRMVL_OUTFrm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TRMVL_OUTFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TRMVL_OUTFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TRMVL_OUTFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TRMVL_OUTFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TRMVL_OUTFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TRMVL_OUTFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TRMVL_OUTFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TRMVL_OUTFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TRMVL_OUTFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo.Caption:='0';
end;

procedure TRMVL_OUTFrm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TRMVL_OUTFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vhal:=vhal+1;
end;

procedure TRMVL_OUTFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
...
procedure TRMVL_OUTFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TRMVL_OUTFrm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TRMVL_OUTFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TRMVL_OUTFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.qB4CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TRMVL_OUTFrm.dbGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TRMVL_OUTFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TRMVL_OUTFrm.dbGrid4UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
  ...
  qB2X.Open;
  pLeft2.Caption:=FormatFloat('#,#;0',qB2XNDATA.AsInteger);
  dbGrid4.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#);-',qB2XSUB_TOTAL.AsFloat);
  dbGrid4.ColumnByName('KG_TOT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',qB2XKG_TOT.AsFloat);
end;

procedure TRMVL_OUTFrm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TRMVL_OUTFrm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TRMVL_OUTFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.TabSheet4Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TRMVL_OUTFrm.qrMaster4BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo4.Caption:='0';
end;

procedure TRMVL_OUTFrm.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.QRGroup4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:='0';
...
procedure TRMVL_OUTFrm.QRBand11BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:=IntToStr(StrToInt(qrlNo4D.Caption)+1);
end;

procedure TRMVL_OUTFrm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TRMVL_OUTFrm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TRMVL_OUTFrm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TRMVL_OUTFrm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TRMVL_OUTFrm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TRMVL_OUTFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TRMVL_OUTFrm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TRMVL_OUTFrm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TRMVL_OUTFrm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRMVL_OUTFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TRMVL_OUTFrm.qBMasterKD_DEPO2Change(Sender: TField);
begin
  if DMFrm.qDepo.Locate('KD_DEPO',qBMasterKD_DEPO2.AsString,[loPartialKey]) then
  begin
    qBMasterNAMA_DEPO2.AsString:=DMFrm.qDepoNAMA_DEPO.AsString;
    qBMasterALAMAT2.AsString:=DMFrm.qDepoALAMAT.AsString;
    qBMasterKOTA2.AsString:=DMFrm.qDepoKOTA.AsString;
    qBMasterTELEPON2.AsString:=DMFrm.qDepoTELEPON.AsString;
  end
  else
    ShowMessage('Data tidak ditemukan !');
end;

procedure TRMVL_OUTFrm.lcdEkspedisiEnter(Sender: TObject);
begin
  DMFrm.qEkspedisi.Open;
end;

procedure TRMVL_OUTFrm.lcdEkspedisiUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TRMVL_OUTFrm.qBMasterID_EKSPEDISIChange(Sender: TField);
begin
...
procedure TRMVL_OUTFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TRMVL_OUTFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TRMVL_OUTFrm.lcdNoSeriEnter(Sender: TObject);
begin
