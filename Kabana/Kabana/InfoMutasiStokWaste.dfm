object InfoMutasiStokWasteFrm: TInfoMutasiStokWasteFrm
  Left = 202
  Top = 128
  Width = 1198
  Height = 600
  Caption = 'InfoMutasiStokWasteFrm'
  Color = clWindow
  Ctl3D = False
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY_D'#9'15'#9'MASUK'#9'F'
            'QTY2_D'#9'15'#9'KELUAR'#9'F'
  ...
  object qB1: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from (select * from vkartu_stok_mutasi_waste_nilai'
