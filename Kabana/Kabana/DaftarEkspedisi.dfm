object DaftarEkspedisiFrm: TDaftarEkspedisiFrm
  Left = 254
  Top = 587
  Width = 1200
  Height = 600
  Caption = 'DaftarEkspedisiFrm'
  Color = clWindow
  Ctl3D = False
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_EKSPEDISI'#9'35'#9'NAMA_EKSPEDISI'#9'F'
      ...
      object TabSheet2: TTabSheet
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            'PKP;CheckBox;1;0')
          Selected.Strings = (
            'KD_PEL'#9'9'#9'KD_PEL'#9#9
            'NAMA_PELABUHAN'#9'50'#9'NAMA_PELABUHAN'#9#9)
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
          IniAttributes.Delimiter = ';;'
