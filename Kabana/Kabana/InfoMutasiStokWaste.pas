...
type
  TInfoMutasiStokWasteFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoMutasiStokWasteFrm: TInfoMutasiStokWasteFrm;

implementation

uses dm, Filter, InfoMutasiStok, InfoMutasiStokRev;

{$R *.dfm}

procedure TInfoMutasiStokWasteFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoMutasiStokWasteFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoMutasiStokWasteFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoMutasiStokWasteFrm:=Nil;
end;

procedure TInfoMutasiStokWasteFrm.FormPaint(Sender: TObject);
begin
...
procedure TInfoMutasiStokWasteFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoMutasiStokWasteFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoMutasiStokWasteFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
...
procedure TInfoMutasiStokWasteFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoMutasiStokWasteFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  {
  if vsql_org1<>'' then
  begin
...
procedure TInfoMutasiStokWasteFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoMutasiStokWasteFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoMutasiStokWasteFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoMutasiStokWasteFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoMutasiStokWasteFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoMutasiStokWasteFrm.tbPrintClick(Sender: TObject);
begin
  case PageControl1.TabIndex of
  0 : begin
...
procedure TInfoMutasiStokWasteFrm.qB1BeforeOpen(DataSet: TDataSet);
begin
  if CheckBox1.Checked then qB1.ParamByName('pnama_prinsipal').AsString:='%' else qB1.ParamByName('pnama_prinsipal').AsString:=sqDaftarPrinsipalNAMA_PRINSIPAL.AsString;
end;

procedure TInfoMutasiStokWasteFrm.CheckBox1Click(Sender: TObject);
begin
  lcPrinsipal.Enabled:=not CheckBox1.Checked;
end;

procedure TInfoMutasiStokWasteFrm.qBXBeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoMutasiStokWasteFrm.qB2BeforeOpen(DataSet: TDataSet);
begin
  qB2.ParamByName('pkd_item').AsString:=qB1KD_ITEM.AsString;
  qB2.ParamByName('pkd_lokasi').AsString:=lcLokasi.Text;
end;

procedure TInfoMutasiStokWasteFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TInfoMutasiStokWasteFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TInfoMutasiStokWasteFrm.qB1FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
{  Accept:=(
...
procedure TInfoMutasiStokWasteFrm.CheckBox3Click(Sender: TObject);
begin
  qB1.Filtered:=CheckBox3.Checked;
end;

procedure TInfoMutasiStokWasteFrm.TabSheet3Show(Sender: TObject);
begin
  qB5.Close;
...
procedure TInfoMutasiStokWasteFrm.qB1CalcFields(DataSet: TDataSet);
begin
