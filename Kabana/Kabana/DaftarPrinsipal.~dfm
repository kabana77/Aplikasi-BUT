object DaftarPrinsipalFrm: TDaftarPrinsipalFrm
  Left = 229
  Top = 134
  Width = 1336
  Height = 622
  Caption = 'DaftarPrinsipalFrm'
  Color = clWindow
  Ctl3D = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            'PKP;CheckBox;1;0'
            'JENIS;CustomEdit;lookJnsSuplier;F')
          Selected.Strings = (
            'JENIS'#9'13'#9'JENIS'#9'F'
            'ID_PRINSIPAL'#9'6'#9'NO. ID'#9'F'
            'NAMA_PRINSIPAL'#9'50'#9'NAMA PRINSIPAL/ REKANAN'#9'F'
            'ALAMAT'#9'24'#9'ALAMAT'#9#9
            'KOTA'#9'14'#9'KOTA'#9#9
            'PROPINSI'#9'8'#9'PROPINSI'#9#9
            'KODEPOS'#9'8'#9'KODEPOS'#9#9
            'KD_AREA'#9'8'#9'KD_AREA'#9'F'
            ...
            'PKP'#9'3'#9'PKP'#9'F'#9'DATA PAJAK'
            'NPWP'#9'5'#9'NPWP'#9'F'#9'DATA PAJAK'
            'NAMA_WP'#9'19'#9'Nama WP'#9'F'#9'DATA PAJAK'
            'ALAMAT_WP'#9'31'#9'Alamat'#9'F'#9'DATA PAJAK'
        ...
        object lookJnsSuplier: TwwDBLookupCombo
          Left = 144
          Top = 144
          Width = 121
          Height = 19
          ...
          Selected.Strings = (
            'JNS_PRINSIPAL'#9'30'#9'JNS_PRINSIPAL'#9'F')
          DataField = 'JENIS'
          DataSource = dsqB1
          LookupTable = DMFrm.qJenisSuplier
          LookupField = 'JNS_PRINSIPAL'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          DittoAttributes.ShortCutDittoRecord = 16429
          Selected.Strings = (
            'KD_AREA'#9'8'#9'Kode'#9'F'
            'KETERANGAN'#9'50'#9'Area'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
          IniAttributes.Delimiter = ';;'
  ...
  object qB2: TSmartQuery
    ...
    object qB2TGL_INSERT: TDateTimeField
      DisplayWidth = 18
      FieldName = 'TGL_INSERT'
      Required = True
      Visible = False
    end
    object qB2OPR_INSERT: TStringField
      DisplayWidth = 50
      FieldName = 'OPR_INSERT'
      Required = True
      Visible = False
    ...
    object qB2TGL_UPDATE: TDateTimeField
      DisplayWidth = 18
      FieldName = 'TGL_UPDATE'
      Visible = False
    end
    object qB2OPR_UPDATE: TStringField
      DisplayWidth = 50
      FieldName = 'OPR_UPDATE'
      Visible = False
      Size = 50
  ...
  object qBMaster: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select * from daftar_prinsipal where id_prinsipal = :pid_prinsip' +
        'al')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    IndexFieldNames = 'ID_PRINSIPAL'
    ...
    object qBMasterPROPINSI: TStringField
      FieldName = 'PROPINSI'
      Required = True
      Size = 50
    end
    object qBMasterKODEPOS: TStringField
      FieldName = 'KODEPOS'
      Required = True
      Size = 6
    end
    ...
    object qBMasterFAX: TStringField
      FieldName = 'FAX'
      Required = True
      Size = 50
    end
    object qBMasterEMAIL: TStringField
      FieldName = 'EMAIL'
      Required = True
      Size = 50
    end
    object qBMasterCP: TStringField
      FieldName = 'CP'
      Required = True
      Size = 50
    end
    object qBMasterHP: TStringField
      FieldName = 'HP'
      Required = True
      Size = 50
    end
    ...
    object qBMasterPKP: TStringField
      FieldName = 'PKP'
      Required = True
      Size = 5
    end
    ...
    object qBMasterNAMA_WP: TStringField
      FieldName = 'NAMA_WP'
      Size = 50
    end
    object qBMasterALAMAT_WP: TStringField
      FieldName = 'ALAMAT_WP'
      Size = 255
    end
    ...
    object qBMasterTGL_CLOSE_PO: TDateTimeField
      FieldName = 'TGL_CLOSE_PO'
    end
