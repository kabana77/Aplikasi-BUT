...
type
  TLoadingCuttingFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  LoadingCuttingFrm: TLoadingCuttingFrm;
...
procedure TLoadingCuttingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TLoadingCuttingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  LoadingCuttingFrm:=Nil;
end;

procedure TLoadingCuttingFrm.FormPaint(Sender: TObject);
begin
...
procedure TLoadingCuttingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TLoadingCuttingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TLoadingCuttingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TLoadingCuttingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TLoadingCuttingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TLoadingCuttingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TLoadingCuttingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TLoadingCuttingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
  ...
  1 : begin
            ...
            begin
                  ShowMessage('FORM belum terdaftar !');
                  ShowMessage(Name+'/ '+UpperCase(StringReplace(TabSheet1.Caption,'&','',[rfReplaceAll])));
            end;
...
procedure TLoadingCuttingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TLoadingCuttingFrm.tsInputShow(Sender: TObject);
begin
...
procedure TLoadingCuttingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TLoadingCuttingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TLoadingCuttingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TLoadingCuttingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TLoadingCuttingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='203';
...
procedure TLoadingCuttingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TLoadingCuttingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TLoadingCuttingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TLoadingCuttingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TLoadingCuttingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TLoadingCuttingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure TLoadingCuttingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TLoadingCuttingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TLoadingCuttingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TLoadingCuttingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TLoadingCuttingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLoadingCuttingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TLoadingCuttingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingCuttingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingCuttingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingCuttingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TLoadingCuttingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingCuttingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingCuttingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingCuttingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingCuttingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingCuttingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingCuttingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TLoadingCuttingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TLoadingCuttingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TLoadingCuttingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TLoadingCuttingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  //qItem.ParamByName('pno_bom').AsFloat:='%';
end;

procedure TLoadingCuttingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TLoadingCuttingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TLoadingCuttingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingCuttingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TLoadingCuttingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TLoadingCuttingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TLoadingCuttingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLoadingCuttingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TLoadingCuttingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TLoadingCuttingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TLoadingCuttingFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
