...
type
  TDaftarKendaraanFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
    ...
    qB1THN_PEROLEHAN: TFloatField;
    qB1TGL_STNK: TDateTimeField;
    qB1TGL_KIR: TDateTimeField;
    qB1TGL_PENYUSUTAN: TDateTimeField;
    qB1ATAS_NAMA: TStringField;
    qB1HRG_PEROLEHAN: TFloatField;
    qB1PENAGGUNG_JAWAB: TStringField;
    qB1KD_DEPO: TStringField;
    qB1FOTO: TStringField;
    qB1NAMA_DEPO: TStringField;
    lcDepo1: TwwDBLookupCombo;
    QRLabel13: TQRLabel;
    QRLabel14: TQRLabel;
    QRLabel15: TQRLabel;
...
var
  DaftarKendaraanFrm: TDaftarKendaraanFrm;
...
procedure TDaftarKendaraanFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarKendaraanFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarKendaraanFrm:=Nil;
end;

procedure TDaftarKendaraanFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarKendaraanFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarKendaraanFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarKendaraanFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarKendaraanFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TDaftarKendaraanFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TDaftarKendaraanFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarKendaraanFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarKendaraanFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure TDaftarKendaraanFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarKendaraanFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarKendaraanFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarKendaraanFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarKendaraanFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarKendaraanFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TDaftarKendaraanFrm.lcDepo1Enter(Sender: TObject);
begin
