object HasilFinishingFrm: THasilFinishingFrm
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Hasil Finishing'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.keterangan2'
      'from'
      '(select * from wip_finishing where kd_form='#39'230'#39') a'
      'left join wip_finishing_d b'
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_WIP_FINISHING'
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from wip_finishing'
