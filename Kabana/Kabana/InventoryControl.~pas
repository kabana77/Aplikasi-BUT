...
begin
  ...
  qBDetail9.Open;
                ...
                wwDBGrid3.Selected.Add('SIZE01'#9'10'#9+qBDetail9LSIZE01.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE02'#9'10'#9+qBDetail9LSIZE02.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE03'#9'10'#9+qBDetail9LSIZE03.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE04'#9'10'#9+qBDetail9LSIZE04.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE05'#9'10'#9+qBDetail9LSIZE05.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE06'#9'10'#9+qBDetail9LSIZE06.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE07'#9'10'#9+qBDetail9LSIZE07.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE08'#9'10'#9+qBDetail9LSIZE08.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE09'#9'10'#9+qBDetail9LSIZE09.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE10'#9'10'#9+qBDetail9LSIZE10.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE11'#9'10'#9+qBDetail9LSIZE11.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE12'#9'10'#9+qBDetail9LSIZE12.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE13'#9'10'#9+qBDetail9LSIZE13.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE14'#9'10'#9+qBDetail9LSIZE14.AsString+#9'F'#9'SIZE EXTRA');
                wwDBGrid3.Selected.Add('SIZE15'#9'10'#9+qBDetail9LSIZE15.AsString+#9'F'#9'SIZE EXTRA');
