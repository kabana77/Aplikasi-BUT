...
type
  TInfoWIPSewing2Frm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoWIPSewing2Frm: TInfoWIPSewing2Frm;
...
procedure TInfoWIPSewing2Frm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoWIPSewing2Frm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoWIPSewing2Frm:=Nil;
end;

procedure TInfoWIPSewing2Frm.FormPaint(Sender: TObject);
begin
...
procedure TInfoWIPSewing2Frm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TInfoWIPSewing2Frm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing2Frm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TInfoWIPSewing2Frm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoWIPSewing2Frm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoWIPSewing2Frm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoWIPSewing2Frm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoWIPSewing2Frm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoWIPSewing2Frm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoWIPSewing2Frm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoWIPSewing2Frm.tbPrintClick(Sender: TObject);
begin
  {
...
procedure TInfoWIPSewing2Frm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing2Frm.CheckBox3Click(Sender: TObject);
begin
  qB6.Filtered:=CheckBox3.Checked;  //qB6.Filtered:=CheckBox3.Checked;
end;

procedure TInfoWIPSewing2Frm.qB6FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(
...
procedure TInfoWIPSewing2Frm.qB6CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing2Frm.qB6BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB6.RecordCount);
end;

procedure TInfoWIPSewing2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing2Frm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing2Frm.QRBand22BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing2Frm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TInfoWIPSewing2Frm.qBdetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing2Frm.CheckBox1Click(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPSewing2Frm.qB6AfterOpen(DataSet: TDataSet);
begin
  CheckBox1.Checked:=False;
end;

procedure TInfoWIPSewing2Frm.wwDBGrid5RowChanged(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
