...
procedure TUmurPiutangFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TUmurPiutangFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
...
procedure TUmurPiutangFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TUmurPiutangFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  UmurPiutangFrm:=Nil;
end;

procedure TUmurPiutangFrm.FormPaint(Sender: TObject);
begin
...
procedure TUmurPiutangFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TUmurPiutangFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TUmurPiutangFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TUmurPiutangFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TUmurPiutangFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TUmurPiutangFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TUmurPiutangFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TUmurPiutangFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TUmurPiutangFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TUmurPiutangFrm.tbPrintClick(Sender: TObject);
begin
...
//  qB.DisableControls;
  ...
  dbGrid1.Selected.Add('TGL_JTH_TEMPO'#9'12'#9'JTH TEMPO'#9'F');
  dbGrid1.Selected.Add('OVERDUE'#9'12'#9'OVERDUE'#9'F');
  dbGrid1.Selected.Add('BB'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPBB.AsDateTime)+#9'F'#9'BULAN LALU');
  dbGrid1.Selected.Add('B3'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPB3.AsDateTime)+#9'F'#9'BULAN LALU');
  dbGrid1.Selected.Add('B2'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPB2.AsDateTime)+#9'F'#9'BULAN LALU');
  dbGrid1.Selected.Add('B1'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPB1.AsDateTime)+#9'F'#9'BULAN LALU');
  dbGrid1.Selected.Add('M4'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPM4.AsDateTime)+#9'F'#9'MINGGU LALU');
  dbGrid1.Selected.Add('M3'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPM3.AsDateTime)+#9'F'#9'MINGGU LALU');
  dbGrid1.Selected.Add('M2'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPM2.AsDateTime)+#9'F'#9'MINGGU LALU');
  dbGrid1.Selected.Add('M1'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPM1.AsDateTime)+#9'F'#9'MINGGU LALU');
  dbGrid1.Selected.Add('D6'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPD6.AsDateTime)+#9'F'#9'DALAM MINGGU INI');
  dbGrid1.Selected.Add('D5'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPD5.AsDateTime)+#9'F'#9'DALAM MINGGU INI');
  dbGrid1.Selected.Add('D4'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPD4.AsDateTime)+#9'F'#9'DALAM MINGGU INI');
  dbGrid1.Selected.Add('D3'#9'10'#9+FormatDateTime('dd mmm',qBUmurHPD3.AsDateTime)+#9'F'#9'DALAM MINGGU INI');
...
procedure TUmurPiutangFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TUmurPiutangFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qBX2.Close;
  qBX2.SQL.Clear;
...
procedure TUmurPiutangFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TUmurPiutangFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qBX3.Close;
  qBX3.SQL.Clear;
...
procedure TUmurPiutangFrm.BitBtn1Click(Sender: TObject);
begin
     ProcTransfer.Close;
...
procedure TUmurPiutangFrm.wwDBDateTimePicker1Change(Sender: TObject);
begin
  wwDBDateTimePicker2.Date:=wwDBDateTimePicker1.Date+7;
end;

procedure TUmurPiutangFrm.dbGrid4UpdateFooter(Sender: TObject);
var
  vjtrpp, vrppp : real;
begin
  qBX4.Close;
...
//  qB.DisableControls;
  qB2.Close;
          ...
          dbGrid2.Selected.Clear;
          dbGrid2.Selected.Add('ID_OUTLET'#9'8'#9'No. ID'#9'T'#9'CUSTOMER');
          dbGrid2.Selected.Add('NAMA_OUTLET'#9'28'#9'Nama'#9'F'#9'CUSTOMER');
