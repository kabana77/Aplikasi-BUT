...
type
  TDaftarDepoFrm = class(TForm)
    ...
    qB3KD_DIV: TStringField;
    qB3DIVISI: TStringField;
...
procedure TDaftarDepoFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarDepoFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TDaftarDepoFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarDepoFrm:=Nil;
end;

procedure TDaftarDepoFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarDepoFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarDepoFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarDepoFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarDepoFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TDaftarDepoFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TDaftarDepoFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarDepoFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarDepoFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TDaftarDepoFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarDepoFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarDepoFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarDepoFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarDepoFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarDepoFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TDaftarDepoFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarDepoFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TDaftarDepoFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
  qBX.SQL.Add('select count(*) as ndata from (');
...
procedure TDaftarDepoFrm.TabSheet3Show(Sender: TObject);
begin
  qB2.Close;
  qB2.Open;
end;
