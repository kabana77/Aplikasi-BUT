...
type
  TTerimaWasteFrm = class(TForm)
    ...
    qX: TOraQuery;
    qXKD_LOKASI: TStringField;
    qXNAMA_LOKASI: TStringField;
    qXKD_EXT: TStringField;
    dsqX: TwwDataSource;
...
var
  TerimaWasteFrm: TTerimaWasteFrm;

implementation

uses dm, Filter, SerahTerimaWaste;
...
procedure TTerimaWasteFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TTerimaWasteFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TTerimaWasteFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TTerimaWasteFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TTerimaWasteFrm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TTerimaWasteFrm.Proc_RefreshStokSales;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TTerimaWasteFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  TerimaWasteFrm:=Nil;
end;

procedure TTerimaWasteFrm.FormPaint(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TTerimaWasteFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaWasteFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TTerimaWasteFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TTerimaWasteFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TTerimaWasteFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TTerimaWasteFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaWasteFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TTerimaWasteFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TTerimaWasteFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TTerimaWasteFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TTerimaWasteFrm.tsInputShow(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  ...
  qBMasterxxs.AsFloat:=0;
  qBMasterxs.AsFloat:=0;
  qBMasters.AsFloat:=0;
  qBMasterm.AsFloat:=0;
  qBMasterl.AsFloat:=0;
  qBMasterxl.AsFloat:=0;
  qBMasterx0.AsFloat:=0;
  qBMasterx1.AsFloat:=0;
  qBMasterx2.AsFloat:=0;
  qBMasterx3.AsFloat:=0;
  qBMastertot_qty.AsFloat:=0;
  qBMastersize01.AsFloat:=0;
  qBMastersize02.AsFloat:=0;
  qBMastersize03.AsFloat:=0;
  qBMastersize04.AsFloat:=0;
  qBMastersize05.AsFloat:=0;
  qBMastersize06.AsFloat:=0;
  qBMastersize07.AsFloat:=0;
  qBMastersize08.AsFloat:=0;
  qBMastersize09.AsFloat:=0;
  qBMastersize10.AsFloat:=0;
  qBMastersize11.AsFloat:=0;
  qBMastersize12.AsFloat:=0;
  qBMastersize13.AsFloat:=0;
  qBMastersize14.AsFloat:=0;
  qBMastersize15.AsFloat:=0;
end;

procedure TTerimaWasteFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TTerimaWasteFrm.qBMasterKD_LOKASIChange(Sender: TField);
begin
...
procedure TTerimaWasteFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  ShowMessage(qBMasterISPOST.AsString);
  if not vCanDel then
  begin
...
procedure TTerimaWasteFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaWasteFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TTerimaWasteFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TTerimaWasteFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaWasteFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='239';
...
procedure TTerimaWasteFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TTerimaWasteFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TTerimaWasteFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TTerimaWasteFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TTerimaWasteFrm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TTerimaWasteFrm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TTerimaWasteFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailMODE_CALC.AsString:='1';
end;

procedure TTerimaWasteFrm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TTerimaWasteFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TTerimaWasteFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaWasteFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TTerimaWasteFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TTerimaWasteFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TTerimaWasteFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaWasteFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TTerimaWasteFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TTerimaWasteFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TTerimaWasteFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.MyIDR.Nilai:=qBMasterSUB_TOTAL.AsFloat;
end;

procedure TTerimaWasteFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TTerimaWasteFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaWasteFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
...
procedure TTerimaWasteFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaWasteFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TTerimaWasteFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TTerimaWasteFrm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TTerimaWasteFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TTerimaWasteFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TTerimaWasteFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TTerimaWasteFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TTerimaWasteFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaWasteFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaWasteFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TTerimaWasteFrm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TTerimaWasteFrm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(sub_total) as sub_total from (');
...
procedure TTerimaWasteFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaWasteFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaWasteFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaWasteFrm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TTerimaWasteFrm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TTerimaWasteFrm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TTerimaWasteFrm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TTerimaWasteFrm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TTerimaWasteFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TTerimaWasteFrm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TTerimaWasteFrm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TTerimaWasteFrm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.qBMasterKD_LOKASI2Change(Sender: TField);
begin
...
procedure TTerimaWasteFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TTerimaWasteFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TTerimaWasteFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TTerimaWasteFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  //qItem.ParamByName('pno_reg_d2').AsFloat:=FloatField1.AsFloat;
end;

procedure TTerimaWasteFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TTerimaWasteFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TTerimaWasteFrm.lcdBOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    BitBtn2Click(nil);
...
procedure TTerimaWasteFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaWasteFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TTerimaWasteFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
//  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TTerimaWasteFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
  //wwDBComboBox1.Items.Clear;
end;

procedure TTerimaWasteFrm.qBDetailKG_DChange(Sender: TField);
begin
  if (qBDetailRD.AsFloat > 0) then qBDetailQTY_D.AsFloat:=qBDetailKG_D.AsFloat/qBDetailRD.AsFloat;
end;

procedure TTerimaWasteFrm.qBDetailRDChange(Sender: TField);
begin
  if qBDetailKG_D.AsFloat > 0 then qBDetailQTY_D.AsFloat:=qBDetailRD.AsFloat/qBDetailKG_D.AsFloat;
end;

procedure TTerimaWasteFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
