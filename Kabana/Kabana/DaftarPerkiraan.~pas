...
type
  TDaftarPerkiraanFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
    ...
    qB1LVL: TFloatField;
    qB1ISDETAIL: TStringField;
    qB1NAMA_PERKIRAAN2: TStringField;
    qrlDetail: TQRLabel;
    qB1ISKAS_BESAR: TStringField;
    qB1IDX: TStringField;
    qB1IDX2: TStringField;
    btnLock: TButton;
...
var
  DaftarPerkiraanFrm: TDaftarPerkiraanFrm;
...
procedure TDaftarPerkiraanFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarPerkiraanFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarPerkiraanFrm:=Nil;
end;

procedure TDaftarPerkiraanFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarPerkiraanFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarPerkiraanFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarPerkiraanFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarPerkiraanFrm.tbRefreshClick(Sender: TObject);
begin
  qB1.Refresh;
end;

procedure TDaftarPerkiraanFrm.tbExportClick(Sender: TObject);
begin
...
procedure TDaftarPerkiraanFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarPerkiraanFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarPerkiraanFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TDaftarPerkiraanFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarPerkiraanFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarPerkiraanFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarPerkiraanFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarPerkiraanFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarPerkiraanFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TDaftarPerkiraanFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TDaftarPerkiraanFrm.btnLockClick(Sender: TObject);
begin
