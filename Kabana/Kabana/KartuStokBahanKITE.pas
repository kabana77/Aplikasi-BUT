...
type
  TKartuStokBahanKITEFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
    ...
    qB2: TSmartQuery;
    dsqB2: TwwDataSource;
    qB2NO_PIB: TFloatField;
    qB2KD_ITEM: TStringField;
    qB2NAMA_ITEM: TStringField;
    qB2NAMA_SUPLIER: TStringField;
    qB2SATUAN: TStringField;
    ...
    qB2D: TSmartQuery;
    dsqB2D: TwwDataSource;
    qB2DNO_REG_KSS: TFloatField;
    qB2DNO_REG_BUKTI: TFloatField;
    qB2DTGL: TDateTimeField;
    qB2DNAMA_LOKASI: TStringField;
    qB2DNO_BOM: TStringField;
    qB2DKD_LOKASI: TStringField;
    qB2DKD_ITEM: TStringField;
    qB2DNAMA_ITEM: TStringField;
    qB2DNAMA_SUPLIER: TStringField;
    qB2DSATUAN: TStringField;
    qB2DJML: TFloatField;
    qB2DNO_PIB: TFloatField;
    qB2DMASUK: TFloatField;
    qB2DKELUAR: TFloatField;
    qB2DKD_LOKASI2: TStringField;
    qB2DNAMA_LOKASI2: TStringField;
    Splitter1: TSplitter;
    wwDBGrid2: TwwDBGrid;
    ...
    procedure dsqB2DataChange(Sender: TObject; Field: TField);
...
var
  KartuStokBahanKITEFrm: TKartuStokBahanKITEFrm;
...
procedure TKartuStokBahanKITEFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TKartuStokBahanKITEFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  KartuStokBahanKITEFrm:=Nil;
end;

procedure TKartuStokBahanKITEFrm.FormPaint(Sender: TObject);
begin
...
procedure TKartuStokBahanKITEFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TKartuStokBahanKITEFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TKartuStokBahanKITEFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TKartuStokBahanKITEFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TKartuStokBahanKITEFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure TKartuStokBahanKITEFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TKartuStokBahanKITEFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TKartuStokBahanKITEFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKartuStokBahanKITEFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TKartuStokBahanKITEFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TKartuStokBahanKITEFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TKartuStokBahanKITEFrm.lcDepo1Enter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TKartuStokBahanKITEFrm.dsqB2DataChange(Sender: TObject;
  Field: TField);
begin
  qB2D.Close;
  qB2D.ParamByName('pkd_lokasi').AsString:=qB2KD_LOKASI.AsString;
  qB2D.ParamByName('pkd_item').AsString:=qB2KD_ITEM.AsString;
  qB2D.Open;
end;

procedure TKartuStokBahanKITEFrm.TabSheet2Show(Sender: TObject);
begin
  qB2.Open;
  qB2D.Open;
end;
