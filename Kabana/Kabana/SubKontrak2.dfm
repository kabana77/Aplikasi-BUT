object SubKontrak2Frm: TSubKontrak2Frm
  Left = 57
  Top = 251
  Width = 1290
  Height = 679
  Caption = 'SubKontrak2Frm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object tsInput: TTabSheet
        ...
        object pMaster: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'STYLE'#9'10'#9'Style'#9'T'#9'PRODUK JADI'
              'ITEM'#9'18'#9'Nama Item'#9'T'#9'PRODUK JADI'
              'COLOR'#9'8'#9'Color'#9'T'#9'PRODUK JADI'
              'SATUAN'#9'5'#9'Satuan'#9'T'#9'PRODUK JADI'
              'KELOMPOK'#9'10'#9'KELOMPOK'#9'T'
              'XXS'#9'4'#9'XXS'#9'T'#9'SIZE'
              'XS'#9'4'#9'XS'#9'T'#9'SIZE'
              'S'#9'4'#9'S'#9'T'#9'SIZE'
              'M'#9'4'#9'M'#9'T'#9'SIZE'
              'L'#9'4'#9'L'#9'T'#9'SIZE'
              'XL'#9'4'#9'XL'#9'T'#9'SIZE'
              'X0'#9'4'#9'X0'#9'T'#9'SIZE'
              'X1'#9'4'#9'X1'#9'T'#9'SIZE'
              'X2'#9'4'#9'X2'#9'T'#9'SIZE'
              'X3'#9'4'#9'X3'#9'T'#9'SIZE'
              'TOT_QTY'#9'6'#9'TOTAL'#9'T')
            IniAttributes.Enabled = True
            IniAttributes.SaveToRegistry = True
            IniAttributes.FileName = 'KUWUNG'
            IniAttributes.Delimiter = ';;'
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'KETERANGAN2'#9'59'#9'KETERANGAN'#9'T')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
            ...
            object lcdItem: TwwDBLookupComboDlg
              ...
              Selected.Strings = (
                ...
                'XSIZE'#9'12'#9'SIZE'#9'F'
                'TOT_QTY'#9'10'#9'KEBUTUHAN'#9'F'
                'WASTE_PSN'#9'10'#9'WASTE_PSN'#9'F'
                'ID_PRINSIPAL'#9'6'#9'ID_PRINSIPAL'#9'F'
                'NO_REG_D2'#9'10'#9'NO_BOM'#9'F')
              DataField = 'KD_ITEM'
              DataSource = dsqBDetail
              LookupTable = qItem
              LookupField = 'KD_ITEM'
      ...
      object TabSheet2: TTabSheet
        Caption = 'DaftarSub Kontrak &Detail'
        ImageIndex = 2
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'ID_SUB_KONTRAK'#9'6'#9'No. ID'#9'F'#9'REKANAN SUB KONTRAK'
            'NAMA_SUB_KONTRAK'#9'24'#9'Nama Rekanan'#9'F'#9'REKANAN SUB KONTRAK'
            ...
            'KETERANGAN2'#9'37'#9'KETERANGAN'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
          IniAttributes.Delimiter = ';;'
  ...
  object qBMaster: TSmartQuery
    ...
    object qBMasterNO_REFF_KONTRAK: TStringField
  ...
  object qB2: TSmartQuery
    ...
    object qB2ID_SUB_KONTRAK: TStringField
      FieldName = 'ID_SUB_KONTRAK'
      Size = 6
    end
    object qB2NAMA_SUB_KONTRAK: TStringField
      FieldName = 'NAMA_SUB_KONTRAK'
      Size = 50
    end
  end
