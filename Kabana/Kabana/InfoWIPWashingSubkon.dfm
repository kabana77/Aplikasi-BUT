object InfoWIPWashingSubkonFrm: TInfoWIPWashingSubkonFrm
  Left = 261
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPWashingSubkonFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Jasa Washing'
        ...
        object pData: TPanel
          ...
          object wwDBGrid5: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_ITEM'#9'25'#9'NAMA BARANG'#9'F'
              'SAT'#9'7'#9'SATUAN'#9'F'
              'QTY_AWAL'#9'15'#9'AWAL'#9'F'
              'QTY_IN'#9'10'#9'DIKIRIM'#9'F'
              'QTY_OUT'#9'10'#9'DITERIMA'#9'F'
              'CQTY_AKHIR'#9'20'#9'AKHIR~(SISA)'#9'F')
        ...
        object pDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'TGL'#9'12'#9'TGL'#9'F'
              'JUDUL_LAPORAN'#9'15'#9'JENIS'#9'F'#9'BUKTI'
              'NO_BUKTI'#9'15'#9'NOMOR'#9'F'#9'BUKTI'
              'QTY_IN'#9'10'#9'DIKIRIM'#9'F'
              'QTY_OUT'#9'10'#9'DITERIMA'#9'F'
              'NO_BOM'#9'10'#9'NO_BOM'#9'F'
  ...
  object qB6: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_mutasi_cutting_subkon'
      ''
      '/*select *'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_WASHING_SUBKON'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_WASHING_SUBKON(:PAWAL, :PAKHIR);'
      'end;')
    Left = 584
    Top = 211
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_WASHING_SUBKON:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_washing'
      'where kd_item=:pkd_item and tgl>=:pawal and tgl<=:pakhir')
    ReadOnly = True
    ...
    object qBdetailNO_BUKTI: TStringField
      FieldName = 'NO_BUKTI'
      Size = 15
    end
    object qBdetailNO_BOM: TStringField
      FieldName = 'NO_BOM'
      Size = 50
    end
    ...
    object qBdetailQTY_IN: TFloatField
      FieldName = 'QTY_IN'
      Required = True
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object qBdetailQTY_OUT: TFloatField
      FieldName = 'QTY_OUT'
      Required = True
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    ...
    object qBdetailJUDUL_LAPORAN: TStringField
