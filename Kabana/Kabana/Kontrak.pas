...
uses
  ...
  Wwdotdot, Wwdbcomb, Wwdbspin, Barcode;

type
  TKontrakFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
    ...
    qBDetailXLABEL_HARGA: TFloatField;
    qB1JNS_PPN: TStringField;
...
procedure TKontrakFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TKontrakFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
...
procedure TKontrakFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.Proc_Refresh4;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.Proc_Refresh7;
var
  i           : word;
  vpertama    : boolean;
...
procedure TKontrakFrm.Proc_Refresh8;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.Proc_RefreshStokSales;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TKontrakFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TKontrakFrm.FormPaint(Sender: TObject);
begin
...
procedure TKontrakFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TKontrakFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TKontrakFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TKontrakFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
  ...
  qBX.SQL.Add('sum(sub_total) as sub_total, sum(sub_total_ber_ppn) as sub_total_ber_ppn, sum(sub_total_non_ppn) as sub_total_non_ppn,');
  ...
  dbGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#0.00;(#,#0.00);-', qBXSUB_TOTAL.AsFloat);
...
procedure TKontrakFrm.FormCreate(Sender: TObject);
begin

  //sembunyikan tab yang belum butuh
  ...
  //end sembunyikan tab yang belum butuh
...
procedure TKontrakFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TKontrakFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TKontrakFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TKontrakFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TKontrakFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TKontrakFrm.tsInputShow(Sender: TObject);
begin
...
procedure TKontrakFrm.lcdSlsmanEnter(Sender: TObject);
begin
  qSlsman.Close;
  if vCanCancel then
  begin
...
procedure TKontrakFrm.qBMasterNIKChange(Sender: TField);
begin
...
procedure TKontrakFrm.qBMasterID_OUTLETChange(Sender: TField);
begin
...
procedure TKontrakFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TKontrakFrm.qBMasterKD_LOKASIChange(Sender: TField);
begin
...
procedure TKontrakFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TKontrakFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TKontrakFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TKontrakFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TKontrakFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  ...
  qBDetailKD_ITEM.AsString:='40000000';
end;

procedure TKontrakFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
  qBMasterMODE_INPUT.AsString:='GUI';
  vispost_new:=qBMasterISPOST.AsString;
  qBMasterSUB_TOTAL.AsFloat:=qBDetailXLABEL_HARGA.AsFloat;
  qBMasterOPR_UPDATE.AsString:=DMFrm.qDateTimeVUSER.AsString;
  qBMasterTGL_UPDATE.AsDateTime:=DMFrm.qDateTimeVDATETIME.AsDateTime;
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='179';
...
procedure TKontrakFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TKontrakFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TKontrakFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TKontrakFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
     ...
     qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
     //qBDetailPPN.AsString:=qBMasterJNS_PPN.AsString;
  end;
end;

procedure TKontrakFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TKontrakFrm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
//    dbe12.ReadOnly:=True;
  ...
  dbGridD.ColumnByName('LABEL_HARGA').FooterValue:=FormatFloat('#,#0.00;(#,#0.00);-',qBDetailXLABEL_HARGA.AsFloat);
...
procedure TKontrakFrm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TKontrakFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
...
procedure TKontrakFrm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TKontrakFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TKontrakFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TKontrakFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TKontrakFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
...
procedure TKontrakFrm.dbGridDEnter(Sender: TObject);
begin
...
procedure TKontrakFrm.qBMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKontrakFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKontrakFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKontrakFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TKontrakFrm.lcdOutletUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qOutlet.Close;
  qOutlet.Open;
...
procedure TKontrakFrm.lcdSlsmanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qSlsman.Close;
  qSlsman.Open;
...
procedure TKontrakFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah, vjumlah2 : String;
  vsub_total_ber_ppn, vsub_total_non_ppn, vsub_total, vdpp : Double;
begin

  {SKRIP BARU}
      //qBDetailSUB_TOTAL.AsFloat:=qBDetailHRG_D.AsFloat*qBDetailQTY_D.AsFloat
      vjumlah:='';
      if (qBDetailQTY_D.AsFloat>0) and (qBDetailHRG_D.AsFloat>0) then
        {if vjumlah<>'' then
        ...
        qBDetailLABEL_HARGA.AsFloat:=qBDetailQTY_D.AsFloat*(qBDetailHRG_D.AsFloat*qBMasterKURS.AsFloat);
  {END SKRIP BARU}
...
procedure TKontrakFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  vjumlah : String;
begin
  ...
  if qBDetailXQTY_D.AsFloat>0 then
     if vjumlah<>'' then
       ...
       begin
          vjumlah:=FormatFloat('#,#;(#,#);-',qBDetailXQTY_D.AsFloat)+' D';
       end;
...
procedure TKontrakFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TKontrakFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.dbGrid2UpdateFooter(Sender: TObject);
var
...
procedure TKontrakFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TKontrakFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TKontrakFrm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TKontrakFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TKontrakFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TKontrakFrm.qB4CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TKontrakFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TKontrakFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TKontrakFrm.dbGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2XX.Close;
  qB2XX.SQL.Clear;
...
procedure TKontrakFrm.dbGrid4UpdateFooter(Sender: TObject);
begin
  qB2XX.Close;
  qB2XX.SQL.Clear;
  qB2XX.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TKontrakFrm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2XX.Close;
  qB2XX.SQL.Clear;
  qB2XX.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TKontrakFrm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2XX.Close;
  qB2XX.SQL.Clear;
  qB2XX.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TKontrakFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.TabSheet4Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.qrMaster4BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo4.Caption:='0';
end;

procedure TKontrakFrm.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.QRGroup4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:='0';
...
procedure TKontrakFrm.QRBand11BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:=IntToStr(StrToInt(qrlNo4D.Caption)+1);
end;

procedure TKontrakFrm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TKontrakFrm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TKontrakFrm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TKontrakFrm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TKontrakFrm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TKontrakFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TKontrakFrm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TKontrakFrm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TKontrakFrm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TKontrakFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TKontrakFrm.lcdOutletUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TKontrakFrm.qBDetailAfterDelete(DataSet: TDataSet);
begin
    vModeInput:=True;
    dbGridDUpdateFooter(NIL);
end;

procedure TKontrakFrm.CheckBox1Click(Sender: TObject);
begin
  if CheckBox1.Checked then
  begin
    qBDetail2.Close;
...
procedure TKontrakFrm.Label37Click(Sender: TObject);
begin
  if vCanCancel then
  begin
     vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TKontrakFrm.tsInputDJurnalShow(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TKontrakFrm.qStokSalesXBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKontrakFrm.dbGrid7TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid7UpdateFooter(Sender: TObject);
begin
  qBXXX.Close;
  qBXXX.SQL.Clear;
...
procedure TKontrakFrm.TabSheet7Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.QRBand36BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.qrBuktiAfterPrint(Sender: TObject);
begin
...
procedure TKontrakFrm.dbGrid8TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TKontrakFrm.dbGrid8UpdateFooter(Sender: TObject);
begin
  qB8X.Close;
  qB8X.SQL.Clear;
...
procedure TKontrakFrm.TabSheet8Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TKontrakFrm.qB8BeforeOpen(DataSet: TDataSet);
begin
  qB8.ParamByName('pawal').AsDateTime:=vfield_awal;
  qB8.ParamByName('pakhir').AsDateTime:=vfield_akhir;
end;

procedure TKontrakFrm.cbNoSeriClick(Sender: TObject);
begin
  qBDetail.Close;
...
procedure TKontrakFrm.lcdNoSeriCloseUp(Sender: TObject;
...
procedure TKontrakFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TKontrakFrm.lcdNoSeriUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qLookNoSeri.Close;
  qLookNoSeri.Open;
...
procedure TKontrakFrm.qB8XBeforeOpen(DataSet: TDataSet);
begin
  qB8X.ParamByName('pawal').AsDateTime:=vfield_awal;
  qB8X.ParamByName('pakhir').AsDateTime:=vfield_akhir;
end;

procedure TKontrakFrm.BitBtn1Click(Sender: TObject);
begin
     ProcTransfer.Close;
...
procedure TKontrakFrm.lcdNoSeriUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TKontrakFrm.tbPrint11Click(Sender: TObject);
begin
...
procedure TKontrakFrm.qrBuktiXXBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhalXX:=0;
end;

procedure TKontrakFrm.QRBand41BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKontrakFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Barcode1.Text:=qBMasterNO_REG_OS.AsString;
...
procedure TKontrakFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoXX.Caption:=IntToStr(StrToInt(qrlNoXX.Caption)+1);
end;

procedure TKontrakFrm.QRBand45BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  vjumlah : String;
begin
...
procedure TKontrakFrm.tbPrint12Click(Sender: TObject);
begin
...
procedure TKontrakFrm.tbPrint13Click(Sender: TObject);
begin
  tbPrint11.Marked:=False;
  tbPrint12.Marked:=False;
...
procedure TKontrakFrm.wwExpandButton1BeforeExpand(Sender: TObject);
begin
  qShareStok.Close;
  qShareStok.Open;
end;

procedure TKontrakFrm.qShareStokBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKontrakFrm.wwDBLookupCombo1Change(Sender: TObject);
begin
  if qBMaster.Modified then
    qBMasterKURS.AsFloat:=DMFrm.qLookMUDEFAULT_KURS.AsFloat;
end;
