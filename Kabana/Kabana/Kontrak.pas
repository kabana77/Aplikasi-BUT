...
type
  TKontrakFrm = class(TForm)
    ...
    procedure QRBand47BeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
...
begin
  ...
  1 : begin
         ...
         if DMFrm.qJnsTransaksi.RecordCount>0 then
         begin
            if qBMasterISPOST.AsString= '0' then
...
procedure TKontrakFrm.QRBand47BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoUrut.Caption:='0';
end;

procedure TKontrakFrm.DetailBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
