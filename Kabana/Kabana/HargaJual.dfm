object HargaJualFrm: THargaJualFrm
  Left = 147
  Top = 96
  Width = 1200
  Height = 599
  Caption = 'HargaJualFrm'
  Color = clWindow
  Ctl3D = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'KATEGORI;CustomEdit;lookTipeHrgJual;F')
          Selected.Strings = (
            'KATEGORI'#9'12'#9'KATEGORI'#9'T'
            'KD_ITEM'#9'7'#9'KD_ITEM'#9'F'
            'NAMA_ITEM'#9'36'#9'NAMA_ITEM'#9'T'
            'NAMA_PRINSIPAL'#9'19'#9'PRINSIPAL'#9'T'
            'BRAND'#9'6'#9'BRAND'#9'T'
            'KELOMPOK'#9'9'#9'KELOMPOK'#9'T'
            'BKP'#9'3'#9'BKP'#9'T'
            'PPN'#9'3'#9'PPN'#9'T'
            'SAT_A'#9'5'#9'A'#9'T'#9'SATUAN'
            'SAT_T'#9'1'#9'T'#9'T'#9'SATUAN'
            'SAT_D'#9'5'#9'D'#9'T'#9'SATUAN'
            'RA'#9'4'#9'A'#9'T'#9'ISI/ RASIO'
            'RT'#9'2'#9'T'#9'T'#9'ISI/ RASIO'
            'RD'#9'1'#9'D'#9'T'#9'ISI/ RASIO'
            'HRG_A'#9'10'#9'A'#9'F'#9'H A R G A  J U A L'
            'HRG_T'#9'1'#9'T'#9'F'#9'H A R G A  J U A L'
            'HRG_D'#9'10'#9'D'#9'F'#9'H A R G A  J U A L'
            'PROFIT_PSN'#9'5'#9'%'#9'F'#9'PROFIT'
            'PROFIT_RP'#9'6'#9'Nilai'#9'F'#9'PROFIT'
        ...
        object lookTipeHrgJual: TwwDBLookupCombo
          Left = 264
          Top = 128
          Width = 121
          Height = 19
          ...
          Selected.Strings = (
            'TIPE_HARGA'#9'30'#9'TIPE_HARGA'#9'F'
            'PROFIT'#9'10'#9'PROFIT'#9#9)
          DataField = 'KATEGORI'
          DataSource = dsqB1
          LookupTable = DMFrm.qTipeHrgJual
          LookupField = 'TIPE_HARGA'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          DittoAttributes.ShortCutDittoRecord = 16429
          Selected.Strings = (
            'TIPE_HARGA'#9'50'#9'TIPE_HARGA'#9#9
            'PROFIT'#9'10'#9'PROFIT'#9#9)
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'a.tgl_berlaku, '
      'a.tgl_akhir'
      'from daftar_hrg_jual a'
      'left outer join vdaftar_item p on (a.kd_item=p.kd_item)')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    BeforeInsert = qB1BeforeInsert
    AfterInsert = qB1AfterInsert
    BeforeEdit = qB1BeforeEdit
    BeforeDelete = qB1BeforeDelete
    Left = 939
    Top = 24
    object qB1NO_REG: TFloatField
      FieldName = 'NO_REG'
      Required = True
    end
    ...
    object qB1PROFIT_PSN: TFloatField
      FieldName = 'PROFIT_PSN'
      Required = True
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object qB1PROFIT_RP: TFloatField
      FieldName = 'PROFIT_RP'
      Required = True
      DisplayFormat = '#,#;(#,#);-'
    end
  ...
  object qB2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from daftar_tipe_harga')
    AfterPost = qB2AfterPost
    Left = 1051
    Top = 48
    object qB2TIPE_HARGA: TStringField
