object DaftarItemImporFrm: TDaftarItemImporFrm
  Left = 225
  Top = 268
  Width = 1382
  Height = 664
  Caption = 'DaftarItemImporFrm'
  Color = clWindow
  Ctl3D = False
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'RBD;CheckBox;1;0')
          Selected.Strings = (
            'ID_PRINSIPAL'#9'5'#9'No. ID'#9'T'#9'SUPLIER'
            'PRINSIPAL'#9'14'#9'Nama Suplier'#9'T'#9'SUPLIER'
            'AKTIF'#9'5'#9'AKTIF'#9#9
            'KD_KEL'#9'4'#9'Kode'#9'F'#9'K E L O M P O K'
            'KELOMPOK'#9'21'#9'Kelompok'#9'T'#9'K E L O M P O K'
            'NO_PIB'#9'8'#9'NO_PIB'#9'T'
            'KD_EXT'#9'10'#9'KD_EXT'#9'F'
            'KD_PARENT'#9'10'#9'KD_PARENT'#9'F'
            'KD_ITEM'#9'8'#9'Kode'#9'F'#9'ITEM BARANG'
            'NAMA_ITEM'#9'21'#9'Keterangan'#9'F'#9'ITEM BARANG'
            'KETERANGAN'#9'31'#9'Spesifikasi Teknis'#9'F'#9'ITEM BARANG'
            'COLOR'#9'5'#9'Color'#9'F'#9'ITEM BARANG'
            'SUB_KELOMPOK'#9'11'#9'Sub Kelompok'#9'F'#9'ITEM BARANG'
            'SAT_D'#9'10'#9'Satuan'#9'F'#9'ITEM BARANG'
            'JML'#9'5'#9'Jumlah'#9'T'#9'DATA PIB'
            'HRG'#9'4'#9'Harga'#9'T'#9'DATA PIB'
            'MU'#9'3'#9'MU'#9'T'#9'DATA PIB'
            'KURS'#9'5'#9'Kurs'#9'T'#9'DATA PIB'
            'SUB_TOTAL'#9'10'#9'Sub Total'#9'T'#9'DATA PIB'
            'PPN_PSN'#9'3'#9'PPN'#9'T'#9'TARIF %'
            'PPH'#9'3'#9'PPh'#9'T'#9'TARIF %'
            'PPNBN'#9'6'#9'PPnBM'#9'T'#9'TARIF %'
            'PPN_BBS'#9'3'#9'PPN'#9'T'#9'DIBEBASKAN'
            'PPH_BBS'#9'3'#9'PPh'#9'T'#9'DIBEBASKAN'
            'PPNBN_BBS'#9'6'#9'PPnBM'#9'T'#9'DIBEBASKAN'
            'KG_BERSIH'#9'11'#9'BERAT~BERSIH (Kg)'#9'F'
            'BKP'#9'3'#9'BKP'#9'F'
            'PPN'#9'4'#9'PPN'#9'F'
            'BCODE_D'#9'20'#9'KD_PERK_BB'#9'F')
  ...
  object qB1: TSmartQuery
    ...
    object qB1PPNBN: TFloatField
      FieldName = 'PPNBN'
    end
    object qB1KG_BERSIH: TFloatField
      FieldName = 'KG_BERSIH'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object qB1JML_ISI: TFloatField
      FieldName = 'JML_ISI'
      DisplayFormat = '#,#;(#,#);-'
    end
    object qB1PPN_BBS: TFloatField
      FieldName = 'PPN_BBS'
    end
    object qB1PPH_BBS: TFloatField
      FieldName = 'PPH_BBS'
    end
    object qB1PPNBN_BBS: TFloatField
      FieldName = 'PPNBN_BBS'
    end
    ...
    object qB1KD_PARENT: TStringField
      FieldName = 'KD_PARENT'
      Size = 12
    end
  end
