object InfoWIPCuttingSubkonFrm: TInfoWIPCuttingSubkonFrm
  Left = 260
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPCuttingSubkonFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Jasa Bordir'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_CUTTING_SUBKON'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_CUTTING_SUBKON(:PAWAL, :PAKHIR);'
      'end;')
    Left = 584
    Top = 211
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_CUTTING_SUBKON:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_cuttings'
