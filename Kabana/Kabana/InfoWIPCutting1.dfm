object InfoWIPCutting1Frm: TInfoWIPCutting1Frm
  Left = 262
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPCutting1Frm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Cutting 1'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_CUTTING1'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_CUTTING1(:PAWAL, :PAKHIR);'
      'end;')
    Left = 392
    Top = 291
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_CUTTING1:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_cutting1'
