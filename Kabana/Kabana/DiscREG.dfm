object DiscREGFrm: TDiscREGFrm
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'DASAR_RING'#9'6'#9'DASAR~RING'#9'F'
            'JENIS'#9'11'#9'JENIS'#9'F'
            'KETERANGAN'#9'50'#9'KETERANGAN'#9'F'
            'TGL_AWAL'#9'13'#9'Awal'#9'F'#9'TANGGAL BERLAKU'
            'TGL_AKHIR'#9'13'#9'Akhir'#9'F'#9'TANGGAL BERLAKU'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Disc REGULER &Detail'
        ImageIndex = 2
  ...
  object ProcADDItem: TOraStoredProc
    StoredProcName = 'PROC_disc_reg_ITEM'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      
        '  PROC_disc_reg_ITEM(:PNO_REG_OS, :PPRINSIPAL, :PBRAND, :PKELOMP' +
        'OK, :PDEL);'
      'end;')
    Left = 904
    Top = 267
    ...
    CommandStoredProcName = 'PROC_disc_reg_ITEM:0'
  end
  ...
  object ProcADDOutlet: TOraStoredProc
    StoredProcName = 'PROC_disc_reg_OUTLET'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      
        '  PROC_disc_reg_OUTLET(:PNO_REG_OS, :PCHANNEL, :PKATEGORI, :PCLU' +
        'STER, :PDEL);'
      'end;')
    Left = 904
    Top = 299
    ...
    CommandStoredProcName = 'PROC_disc_reg_OUTLET:0'
  end
