...
type
  TDaftarEkspedisiFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  DaftarEkspedisiFrm: TDaftarEkspedisiFrm;
...
procedure TDaftarEkspedisiFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarEkspedisiFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarEkspedisiFrm:=Nil;
end;

procedure TDaftarEkspedisiFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarEkspedisiFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarEkspedisiFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarEkspedisiFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarEkspedisiFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TDaftarEkspedisiFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TDaftarEkspedisiFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarEkspedisiFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarEkspedisiFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure TDaftarEkspedisiFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarEkspedisiFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarEkspedisiFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarEkspedisiFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarEkspedisiFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarEkspedisiFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TDaftarEkspedisiFrm.TabSheet2Show(Sender: TObject);
begin
