object PBDepoHOFrm: TPBDepoHOFrm
  Left = 257
  Top = 205
  Width = 1290
  Height = 679
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'QTY_A'#9'7'#9'A'#9'F'#9'DIMINTA'
                'QTY_T'#9'3'#9'T'#9'F'#9'DIMINTA'
                'QTY_D'#9'3'#9'D'#9'F'#9'DIMINTA'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar PB Depo ke HO &Detail'
        ImageIndex = 2
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY_A'#9'4'#9'A'#9'F'#9'DITERIMA'
            'QTY_T'#9'3'#9'T'#9'F'#9'DITERIMA'
            'QTY_D'#9'3'#9'D'#9'F'#9'DITERIMA'
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_PBDEPOHO'
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from pbdepoho'
