object PembelianFrm: TPembelianFrm
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'PPN'#9'3'#9'PPN'#9'T'
                'QTY_D_ORDER'#9'3'#9'SISA PO'#9'T'
                'QTY_D'#9'3'#9'DITERIMA'#9'F'
                'HRG_D'#9'5'#9'H A R G A'#9'T'
                'SUB_TOTAL_GROSS'#9'9'#9'TOTAL~GROSS'#9'T'
                'DISC_X_PSN'#9'5'#9'%'#9'T'#9'DISC'
                'DISC_X_RP'#9'10'#9'RP'#9'T'#9'DISC'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'ISHADIAH;CheckBox;1;0')
          Selected.Strings = (
            'NO_REG_OS'#9'13'#9'NO LPB'#9'F'
            'TGL'#9'10'#9'TGL'#9'F'
            'ISPOST'#9'6'#9'ISPOST'#9'F'
            'ID_PRINSIPAL'#9'5'#9'ID'#9'F'#9'PRINSIPAL/ SUPLIER'
  ...
  object qB1: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vpembelian_d_lokal'
      ''
      '/*select * from vpembelian_lokal*/')
    ReadOnly = True
    Left = 1123
    Top = 8
  ...
  object qbvPO: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      
        'select b.no_reg_os as no_pib, decode(b.no_po, '#39#39', to_char(a.no_r' +
        'eg_os), b.no_po) as no_po2, a.no_bukti from po a'
      'left join pib b on to_char(a.no_reg_os)=b.no_po'
      'where to_char(a.no_reg_os)=:pno_po')
    ReadOnly = True
    Left = 1059
    Top = 8
    ParamData = <
    ...
    object qbvPONO_PO2: TStringField
      FieldName = 'NO_PO2'
      ReadOnly = True
      Size = 50
    end
    object qbvPONO_PIB: TFloatField
      FieldName = 'NO_PIB'
      ReadOnly = True
    end
    object qbvPONO_BUKTI: TStringField
      FieldName = 'NO_BUKTI'
      Size = 15
    end
  end
  object dsqBVpo: TwwDataSource
    DataSet = qbvPO
    Left = 1059
    Top = 56
  end
