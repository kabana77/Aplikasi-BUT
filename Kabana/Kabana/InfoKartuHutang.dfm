object InfoKartuHutangFrm: TInfoKartuHutangFrm
  Left = 417
  Top = 189
  Width = 1322
  Height = 677
  Caption = 'InfoKartuHutangFrm'
  Color = clWindow
  Ctl3D = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'NO_FAKTUR'#9'10'#9'NO_FAKTUR'#9'F'
            'TGL'#9'11'#9'TGL'#9'F'
            'NO_REFF'#9'9'#9'NO_REFF'#9'F'
            'NO_PL'#9'20'#9'NO_PL'#9'F'
            'NO_PO'#9'10'#9'NO_PO'#9'F'
            'NO_SJ'#9'20'#9'NO_SJ'#9'F'
            'ID_PRINSIPAL'#9'12'#9'No. ID'#9'F'#9'PRINSIPAL/ SUPLIER'
            'NAMA_PRINSIPAL'#9'30'#9'NAMA_PRINSIPAL'#9'F'#9'PRINSIPAL/ SUPLIER'
            'TOP'#9'3'#9'TOP'#9'F'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_PRINSIPAL'#9'29'#9'Nama'#9'F'#9'PRINSIPAL/ SUPLIER'
            'KETERANGAN'#9'29'#9'KETERANGAN'#9'F'
            'NO_REG_BUKTI'#9'11'#9'Nomer'#9'F'#9'BUKTI'
            'JNS_TRANSAKSI'#9'10'#9'Jenis'#9'F'#9'BUKTI'
            'NO_FAKTUR'#9'10'#9'NO_FAKTUR'#9'F'
            'NO_REFF_EXT'#9'12'#9'NO_REFF'#9'F'
            'TGL'#9'11'#9'TGL'#9'F'
      ...
      object TabSheet3: TTabSheet
        ...
        object dbGrid3: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KOREKSI'#9'7'#9'KOREKSI'#9'F'
            'BAYAR_TUNAI'#9'9'#9'Tunai'#9'F'#9'PEMBAYARAN'
            'BAYAR_CEK'#9'12'#9'Cek'#9'F'#9'PEMBAYARAN'
            'BAYAR_TT'#9'7'#9'Transfer'#9'F'#9'PEMBAYARAN'
            'BAYAR_PENDING'#9'11'#9'Pending'#9'F'#9'PEMBAYARAN'
            'SISA_TAGIHAN'#9'14'#9'SISA_TAGIHAN'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'KUWUNG'
          IniAttributes.Delimiter = ';;'
        ...
        object pGrid: TPanel
          ...
          object dbGrid4: TwwDBGrid
            ...
            ControlType.Strings = (
              ...
              'ISTERKIRIM;CheckBox;1;0')
            Selected.Strings = (
              'ID_PRINSIPAL'#9'6'#9'ID'#9'F'#9'REKANAN / SUPLIER'
              'NAMA_PRINSIPAL'#9'35'#9'NAMA'#9'F'#9'REKANAN / SUPLIER'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select * from (select * from vhutang_faktur where sisa_tagihan>:' +
        'pmin and sisa_tagihan<=:pmax)')
  ...
  object qB2: TSmartQuery
    ...
    object qB2NO_REG_KHU: TFloatField
      FieldName = 'NO_REG_KHU'
      Required = True
    end
  ...
  object qB3: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vresume_tagihan_prinsipal')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Left = 875
    Top = 184
  ...
  object qB4: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select a.id_prinsipal, a.nama_prinsipal, nvl(f.awal,0) as awal, ' +
        'nvl(c.debet,0) as debet, nvl(d.kredit,0) as kredit, decode(c.mu,' +
        ' '#39#39', '#39'x'#39', c.mu) as mu from daftar_prinsipal a'
      'left join ('
      
        ' select a.id_prinsipal, (a.awal-nvl(b.kredit,0)) as awal, decode' +
        '(a.mu, '#39#39', b.mu, a.mu) as mu from'
      ' ('
      '  select t.id_prinsipal, sum(t.k_hutang) as awal, t.mu'
      '  from VPEMBELIAN_JURNAL t'
      '  left join pembelian x on t.no_reg_os=x.no_reg_os'
      ...
      ') f on a.id_prinsipal=f.id_prinsipal'
      ''
      'left join ('
      
        'select t.id_prinsipal, sum(t.k_hutang) as debet, t.mu from VPEMB' +
        'ELIAN_JURNAL t'
      ' left join pembelian x on t.no_reg_os=x.no_reg_os'
        ...
        'mu=:pmu'
      ' group by t.id_prinsipal, t.mu, x.mu'
      ') c on a.id_prinsipal=c.id_prinsipal'
      ''
      'left join ('
      ...
      ' group by b.id_outlet, a.mu'
      ') d on a.id_prinsipal=d.id_outlet'
      ''
      'where a.nama_prinsipal like :pcustomer'
      'order by a.id_prinsipal')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    ...
    object qB4ID_PRINSIPAL: TStringField
      FieldName = 'ID_PRINSIPAL'
      Required = True
      Size = 6
    end
    object qB4NAMA_PRINSIPAL: TStringField
      FieldName = 'NAMA_PRINSIPAL'
      Required = True
      Size = 50
    end
  ...
  object qB5: TSmartQuery
    ...
    SQL.Strings = (
      ...
      '('
        ...
        'select a.tgl, a.id_prinsipal, a.no_reg_os as no_bukti, '#39'LPB'#39' as ' +
        'jenis, nvl(b.k_hutang,0) as debet, 0 as kredit, a.keterangan'
      'from pembelian a'
      'left join vpembelian_jurnal b on a.no_reg_os=b.no_reg_os'
      
        'where a.ispost='#39'1'#39' and trunc(a.tgl) >= :pawal and trunc(a.tgl) <' +
        '= :pakhir and b.mu=:pmu and a.id_prinsipal=:pcustomer'
      ' '
      'UNION'
      ''
      
        '(select a.tgl,  b.id_outlet, a.no_reg_os as no_bukti, '#39'DIBAYAR'#39' ' +
        'as jenis, 0 as debet, nvl(b.bayar_tunai+b.bayar_cek+b.bayar_tt+b' +
        '.bayar_pending,0) as kredit, a.keterangan'
      'from bukti_bayar a, pembayaran_d b'
      
        'where a.no_reg_os=b.no_reg_os and a.ispost2='#39'1'#39' and trunc(a.tgl)' +
        ' >= :pawal and trunc(a.tgl) <= :pakhir and a.mu=:pmu and b.id_ou' +
        'tlet=:pcustomer)'
      ')'
      'order by tgl')
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    ...
    object qB5ID_PRINSIPAL: TStringField
      FieldName = 'ID_PRINSIPAL'
      ReadOnly = True
      Size = 6
    end
