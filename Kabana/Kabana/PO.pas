...
uses
  ...
  Wwdotdot, Wwdbcomb, jpeg, Wwdbspin;
...
type
  TPOFrm = class(TForm)
    ...
    DBText15: TDBText;
    qBMasterSTS_PO: TStringField;
    qBMasterTGL_BERLAKU: TDateTimeField;
    Label12: TLabel;
    Label15: TLabel;
    wwDBDateTimePicker1: TwwDBDateTimePicker;
    qB1STS_PO: TStringField;
    qB1TGL_BERLAKU: TDateTimeField;
...
procedure TPOFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TPOFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.Proc_Refresh4;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.Proc_RefreshStokSales;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPOFrm.FormPaint(Sender: TObject);
begin
...
procedure TPOFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TPOFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TPOFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TPOFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TPOFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TPOFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPOFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TPOFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TPOFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TPOFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TPOFrm.tsInputShow(Sender: TObject);
begin
...
procedure TPOFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TPOFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TPOFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  ...
  qBDetailPPN.AsString:=qBMasterPPN.AsString;
  if qBDetailPPN.AsString='-' then qBDetailBKP.AsString:='0' else   qBDetailBKP.AsString:='1';
end;

procedure TPOFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='105';
...
procedure TPOFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TPOFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TPOFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TPOFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TPOFrm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TPOFrm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TPOFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
...
procedure TPOFrm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TPOFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TPOFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TPOFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPOFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TPOFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TPOFrm.dbGridDEnter(Sender: TObject);
begin
  qItem.Close;
...
procedure TPOFrm.qBMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPOFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPOFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPOFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TPOFrm.lcdOutletUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qPrinsipal.Close;
  qPrinsipal.Open;
...
procedure TPOFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  {qrlNo.Caption:='0';}
end;

procedure TPOFrm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TPOFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vhal:=vhal+1;
end;
...
procedure TPOFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
...
procedure TPOFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPOFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TPOFrm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TPOFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TPOFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.qB4CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPOFrm.dbGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPOFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPOFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPOFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPOFrm.dbGrid4UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPOFrm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPOFrm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPOFrm.TabSheet4Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPOFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPOFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPOFrm.qrMaster4BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo4.Caption:='0';
end;

procedure TPOFrm.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.QRGroup4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:='0';
...
procedure TPOFrm.QRBand11BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:=IntToStr(StrToInt(qrlNo4D.Caption)+1);
end;

procedure TPOFrm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TPOFrm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TPOFrm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TPOFrm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TPOFrm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TPOFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TPOFrm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TPOFrm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TPOFrm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TPOFrm.qBMasterID_PRINSIPALChange(Sender: TField);
begin
...
procedure TPOFrm.lcdEkspedisiEnter(Sender: TObject);
begin
  DMFrm.qEkspedisi.Open;
end;

procedure TPOFrm.lcdEkspedisiUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPOFrm.qBMasterID_EKSPEDISIChange(Sender: TField);
begin
...
procedure TPOFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TPOFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TPOFrm.DetailBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoUrut.Caption:=IntToStr(StrToInt(qrlNoUrut.Caption)+1);
  if (vhal=1) and (StrToInt(qrlNoUrut.Caption)>10) and (qBDetail.RecordCount>=11) then
    DetailBand3.ForceNewPage:=True
    else
    DetailBand3.ForceNewPage:=False;
end;

procedure TPOFrm.QRBand38BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.MyIDR.Nilai:=qBMasterNILAI_TAGIHAN.AsFloat;
  DMFrm.MyUSD.Nilai:=qBMasterNILAI_TAGIHAN.AsFloat;

  if qBMasterMU.AsString='IDR' then qrlTerbilang3.Caption:='#'+DMFrm.MyIDR.HasilKonversi+'#';
  if qBMasterMU.AsString='USD' then  qrlTerbilang3.Caption:='#'+DMFrm.MyUSD.HasilKonversi+'#';

 
  //Untuk DP
  if (qBMasterDISC_VAL_RP.AsFloat > 0) then
  begin
    QRLabel37.Enabled:=True;
    QRLabel185.Enabled:=True;
    QRDBText268.Enabled:=True;
  end
  else
  begin
    QRLabel37.Enabled:=False;
    QRLabel185.Enabled:=False;
    QRDBText268.Enabled:=False;
  end;

  //Untuk pembayaran kredit
  if qBMasterCARA_BAYAR.AsString = 'KREDIT' then
  begin
  ...
  //Untuk Masa berlaku
  if datetimetostr(qBMasterTGL_BERLAKU.AsDateTime) <> '' then
  begin
...
procedure TPOFrm.dbcCaraBayarChange(Sender: TObject);
begin

  if dbcCaraBayar.Value='KREDIT' then
  begin
    LTop.Caption:='hari setelah barang diterima';
    LTop.Visible:=true;
  ...
  begin
    ...
    if qBMaster.Modified then qBMasterTOP.AsInteger:=0;
  end;

  
end;

procedure TPOFrm.qBMasterPPNChange(Sender: TField);
begin
  if qBDetail.RecordCount > 0 then
  begin
    ShowMessage('Hapus detail terlebih dahulu sebelum merubah PPN!!');
    Abort;
  end;
end;
