...
type
  THasilFinishingFrm = class(TForm)
    ...
    qBomDITEM: TStringField;
    qBomDSTYLE: TStringField;
    qBomDCOLOR: TStringField;
...
uses dm, Filter, PemakaianBahan, TerimaBB, HasilCutting, HasilSewing;
...
procedure THasilFinishingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure THasilFinishingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  HasilFinishingFrm:=Nil;
end;

procedure THasilFinishingFrm.FormPaint(Sender: TObject);
begin
...
procedure THasilFinishingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure THasilFinishingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure THasilFinishingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure THasilFinishingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure THasilFinishingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure THasilFinishingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure THasilFinishingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure THasilFinishingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure THasilFinishingFrm.tsInputShow(Sender: TObject);
begin
...
procedure THasilFinishingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  qBMasterKD_FORM.AsString:=vkd_transaksi;
  qBMasterTGL.AsDateTime:=vtgl_bukti;
  qBMasterKD_LOKASI.AsString:='63';
  qBMasterKD_LOKASI2.AsString:='63';
...
procedure THasilFinishingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure THasilFinishingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure THasilFinishingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure THasilFinishingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure THasilFinishingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure THasilFinishingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure THasilFinishingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='230';
...
procedure THasilFinishingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure THasilFinishingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure THasilFinishingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure THasilFinishingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure THasilFinishingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure THasilFinishingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure THasilFinishingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure THasilFinishingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure THasilFinishingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure THasilFinishingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure THasilFinishingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure THasilFinishingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure THasilFinishingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure THasilFinishingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure THasilFinishingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilFinishingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilFinishingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilFinishingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure THasilFinishingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilFinishingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilFinishingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilFinishingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilFinishingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure THasilFinishingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THasilFinishingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure THasilFinishingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure THasilFinishingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure THasilFinishingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure THasilFinishingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('pno_bom').AsString:=FloatToStr(qBMasterNO_BOM.AsFloat);
end;

procedure THasilFinishingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure THasilFinishingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure THasilFinishingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure THasilFinishingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure THasilFinishingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure THasilFinishingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure THasilFinishingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure THasilFinishingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure THasilFinishingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure THasilFinishingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure THasilFinishingFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
...
procedure THasilFinishingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
  qBomD.Close;
  qBomD.Open;
end;

procedure THasilFinishingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  qBMasterKETERANGAN.AsString:=qBomDITEM.AsString+' - '+qBomDSTYLE.AsString+' - '+qBomDCOLOR.AsString+' - '+qBomDKD_PRODUKSI.AsString;
end;
