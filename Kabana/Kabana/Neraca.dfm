object NeracaFrm: TNeracaFrm
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'AKTIVA'#9'50'#9'PERKIRAAN'#9'F'#9'A K T I V A'
            'AKHIR'#9'15'#9'SALDO'#9'F'#9'A K T I V A'
            'PASIVA'#9'50'#9'PERKIRAAN'#9'F'#9'P A S I V A'
            'AKHIR2'#9'15'#9'SALDO'#9'F'#9'P A S I V A')
  ...
  object qB1: TSmartQuery
    ...
    object qB1PASIVA: TStringField
      FieldName = 'PASIVA'
      Size = 255
    end
    object qB1AWAL2: TFloatField
      FieldName = 'AWAL2'
      DisplayFormat = '#,#0.00;(#,#0.00);'
    end
    object qB1DEBET2: TFloatField
      FieldName = 'DEBET2'
      DisplayFormat = '#,#0.00;(#,#0.00);'
    end
    object qB1KREDIT2: TFloatField
      FieldName = 'KREDIT2'
      DisplayFormat = '#,#0.00;(#,#0.00);'
    end
    object qB1AKHIR2: TFloatField
      FieldName = 'AKHIR2'
      DisplayFormat = '#,#0.00;(#,#0.00);'
    end
    object qB1SPACE_BEFORE: TFloatField
      FieldName = 'SPACE_BEFORE'
      Required = True
    end
    object qB1SPACE_AFTER: TFloatField
      FieldName = 'SPACE_AFTER'
      Required = True
    end
    object qB1FONT_SIZE: TFloatField
      FieldName = 'FONT_SIZE'
      Required = True
    end
    object qB1FONT_STYLE: TStringField
      FieldName = 'FONT_STYLE'
      Required = True
      Size = 3
    end
    object qB1FONT_NAME: TStringField
      FieldName = 'FONT_NAME'
      Required = True
      Size = 50
    end
    object qB1LINE_BEFORE: TStringField
      FieldName = 'LINE_BEFORE'
      Required = True
      Size = 1
    end
    object qB1LINE_AFTER: TStringField
      FieldName = 'LINE_AFTER'
      Required = True
      Size = 2
    end
  end
