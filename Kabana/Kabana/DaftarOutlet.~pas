...
uses
  ...
  QuickRpt, Mask, wwdbedit, Wwdotdot, Wwdbcomb, Wwdbdlg, wwcheckbox;

type
  TDaftarOutletFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
    ...
    sqDaftarArea: TSmartQuery;
    sqDaftarAreaKD_AREA: TStringField;
    sqDaftarAreaAREA: TStringField;
    sqDaftarAreaKETERANGAN: TStringField;
    qB1AREA: TStringField;
    qB1SUB_AREA: TStringField;
    qB1SLSMAN: TStringField;
    sqDaftarRute: TSmartQuery;
    sqDaftarRuteRUTE_SLSMAN: TStringField;
    sqDaftarRuteTGL_AWAL: TDateTimeField;
    sqDaftarRuteTGL_AKHIR: TDateTimeField;
    sqDaftarRuteM1: TStringField;
    sqDaftarRuteM2: TStringField;
    sqDaftarRuteM3: TStringField;
    sqDaftarRuteM4: TStringField;
    sqDaftarRuteD1: TStringField;
    sqDaftarRuteD2: TStringField;
    sqDaftarRuteD3: TStringField;
    sqDaftarRuteD4: TStringField;
    sqDaftarRuteD5: TStringField;
    sqDaftarRuteD6: TStringField;
    sqDaftarRuteD7: TStringField;
    lcRuteSlsman: TwwDBLookupCombo;
    QFields: TListBox;
    QFields2: TListBox;
    pRight2: TPanel;
    lcRutePenagihan: TwwDBLookupCombo;
    lcRutePengiriman: TwwDBLookupCombo;
    qrMaster: TQuickRep;
    ...
    qrdbTTD42: TQRDBText;
    qrdbTTD43: TQRDBText;
    lcOutletKategori: TwwDBLookupCombo;
    sqDaftarArealLook: TSmartQuery;
    sqDaftarArealLookKD_AREA: TStringField;
    sqDaftarArealLookAREA: TStringField;
    sqDaftarArealLookKETERANGAN: TStringField;
    lcdArea: TwwDBLookupComboDlg;
    TabSheet2: TTabSheet;
    pTop2: TPanel;
    dbGrid2: TwwDBGrid;
    wwIButton1: TwwIButton;
    dsqB2: TwwDataSource;
    sqDaftarAreaKD_DEPO: TStringField;
    lcDepo2: TwwDBLookupCombo;
    qB2: TSmartQuery;
    ...
    qB1TIPE_HARGA: TStringField;
    lcbTipeHarga: TwwDBComboBox;
    qB1ID_EXT: TStringField;
    qB2TOP: TFloatField;
    qSlsman: TOraQuery;
    ...
    qB1MAX_KIRIM: TFloatField;
    qB1JARAK: TFloatField;
    qB1LAT: TFloatField;
    qB1LNG: TFloatField;
    ...
    procedure lcDepo1Enter(Sender: TObject);
    ...
    procedure lcdAreaEnter(Sender: TObject);
...
var
  DaftarOutletFrm: TDaftarOutletFrm;
...
procedure TDaftarOutletFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarOutletFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TDaftarOutletFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarOutletFrm:=Nil;
end;

procedure TDaftarOutletFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarOutletFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarOutletFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarOutletFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarOutletFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TDaftarOutletFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TDaftarOutletFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarOutletFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarOutletFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure TDaftarOutletFrm.lcDepo1Enter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TDaftarOutletFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarOutletFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarOutletFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarOutletFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarOutletFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarOutletFrm.tbPrintClick(Sender: TObject);
begin
...
procedure TDaftarOutletFrm.lcdAreaEnter(Sender: TObject);
begin
  sqDaftarArealLook.Close;
  sqDaftarArealLook.ParamByName('pkd_depo').AsString:=qB1KD_DEPO.AsString;
  sqDaftarArealLook.Open;
end;

procedure TDaftarOutletFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarOutletFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TDaftarOutletFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  if vsql_org2<>'' then
  begin
    qBX.Close;
...
procedure TDaftarOutletFrm.lcdSlsmanEnter(Sender: TObject);
begin
  qSlsman.Open;
end;

procedure TDaftarOutletFrm.lcdSlsmanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qSlsman.Close;
  qSlsman.Open;
