...
type
  TLoadingHslFinishingFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  LoadingHslFinishingFrm: TLoadingHslFinishingFrm;

implementation

uses dm, Filter, PemakaianBahan, TerimaBB, HasilCutting, LoadingCutting;
...
procedure TLoadingHslFinishingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TLoadingHslFinishingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  LoadingCuttingFrm:=Nil;
end;

procedure TLoadingHslFinishingFrm.FormPaint(Sender: TObject);
begin
...
procedure TLoadingHslFinishingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TLoadingHslFinishingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TLoadingHslFinishingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TLoadingHslFinishingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB1.RecordCount);
  //dbGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#);-', qBXSUB_TOTAL.AsFloat);
end;

procedure TLoadingHslFinishingFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TLoadingHslFinishingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TLoadingHslFinishingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TLoadingHslFinishingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
  ...
  1 : begin
            ...
            begin
                  ShowMessage('FORM belum terdaftar !');
                  ShowMessage(Name+'/ '+UpperCase(StringReplace(tsInput.Caption,'&','',[rfReplaceAll])));
            end;
...
procedure TLoadingHslFinishingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TLoadingHslFinishingFrm.tsInputShow(Sender: TObject);
begin
...
procedure TLoadingHslFinishingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  qBMasterKD_FORM.AsString:=vkd_transaksi;
  qBMasterTGL.AsDateTime:=vtgl_bukti;
  qBMasterKD_LOKASI.AsString:='65';
...
procedure TLoadingHslFinishingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TLoadingHslFinishingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TLoadingHslFinishingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TLoadingHslFinishingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TLoadingHslFinishingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TLoadingHslFinishingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  qBDetailNO_REG_OS.AsFloat:=qBMasterNO_REG_OS.AsFloat;
  qBDetailQTY_A.AsFloat:=0;
  qBDetailQTY_T.AsFloat:=0;
  qBDetailRA.AsFloat:=1;
  qBDetailRT.AsFloat:=1;
  qBDetailHRG_A.AsFloat:=0;
  qBDetailHRG_T.AsFloat:=0;
  qBDetailHRG_D.AsFloat:=0;
  qBDetailQTY_Y.AsFloat:=0;
  qBDetailSUB_TOTAL.AsFloat:=0;
end;

procedure TLoadingHslFinishingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='235';
...
procedure TLoadingHslFinishingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TLoadingHslFinishingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TLoadingHslFinishingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TLoadingHslFinishingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TLoadingHslFinishingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TLoadingHslFinishingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure TLoadingHslFinishingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TLoadingHslFinishingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TLoadingHslFinishingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TLoadingHslFinishingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TLoadingHslFinishingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TLoadingHslFinishingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLoadingHslFinishingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLoadingHslFinishingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TLoadingHslFinishingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingHslFinishingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingHslFinishingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingHslFinishingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TLoadingHslFinishingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingHslFinishingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingHslFinishingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingHslFinishingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingHslFinishingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLoadingHslFinishingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TLoadingHslFinishingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TLoadingHslFinishingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TLoadingHslFinishingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TLoadingHslFinishingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  //qItem.ParamByName('pno_bom').AsFloat:='%';
end;

procedure TLoadingHslFinishingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TLoadingHslFinishingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TLoadingHslFinishingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLoadingHslFinishingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TLoadingHslFinishingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TLoadingHslFinishingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TLoadingHslFinishingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLoadingHslFinishingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TLoadingHslFinishingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TLoadingHslFinishingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TLoadingHslFinishingFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
