object WasteFinishingFrm: TWasteFinishingFrm
  Left = 237
  Top = 153
  Width = 1382
  Height = 784
  Caption = 'WasteFinishingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Waste Finishing'
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'QTY_D'#9'12'#9'QTY'#9'F'
                'SAT_D'#9'8'#9'SATUAN'#9'F'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_finishing where kd_form='#39'232'#39') a'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select a.kd_item, a.nama_item as keterangan, substr(kd_item, 1, ' +
        '6) as no_bom, a.sat_d from daftar_item a'
      'where substr(kd_item, 1, 6) = to_char(:pno_bom)')
