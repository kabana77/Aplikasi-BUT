object ReturPembelianFrm: TReturPembelianFrm
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'TGL'#9'11'#9'TGL'#9'F'
            'TGL_KIRIM'#9'18'#9'TGL_KIRIM'#9'F'
            'NO_REFF'#9'8'#9'NO_REFF'#9'F'
            'ID_PRINSIPAL'#9'5'#9'No. ID'#9'F'#9'PRINSIPAL'
            'NAMA_PRINSIPAL'#9'16'#9'Nama Prinsipal'#9'F'#9'PRINSIPAL'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Retur Pembelian &Detail'
        ImageIndex = 2
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY_A'#9'4'#9'A'#9'F'#9'R E T U R'
            'QTY_T'#9'3'#9'T'#9'F'#9'R E T U R'
            'QTY_D'#9'3'#9'D'#9'F'#9'R E T U R'
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_RETUR_PEMBELIAN'
    Session = DMFrm.OS
    SQL.Strings = (
    ...
    object qBMasterID_PRINSIPAL: TStringField
      FieldName = 'ID_PRINSIPAL'
      OnChange = qBMasterID_PRINSIPALChange
      Size = 6
    end
    ...
    object qBMasterNO_REG_OS_REFF: TFloatField
      ...
      OnChange = qBMasterNO_REG_OS_REFFChange
    end
  end
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
      ...
      '  b.disc_val_psn, '
      '  b.disc_val_rp'
      'from vdaftar_item_aktif a, pembelian_d b'
      
        'where b.id_prinsipal=:pid_prinsipal and a.kd_item=b.kd_item and ' +
        'b.no_reg_os=1620100011')
    ...
    object qItemHRG_A: TFloatField
      FieldName = 'HRG_A'
    end
    object qItemHRG_T: TFloatField
      FieldName = 'HRG_T'
    end
    object qItemHRG_D: TFloatField
      FieldName = 'HRG_D'
    end
    object qItemQTY_A: TFloatField
      FieldName = 'QTY_A'
    end
    object qItemQTY_T: TFloatField
      FieldName = 'QTY_T'
    end
    object qItemQTY_D: TFloatField
      FieldName = 'QTY_D'
    end
    object qItemHRG_JUAL_A_GT: TFloatField
      FieldName = 'HRG_JUAL_A_GT'
    end
    object qItemHRG_JUAL_T_GT: TFloatField
      FieldName = 'HRG_JUAL_T_GT'
    end
    object qItemHRG_JUAL_D_GT: TFloatField
      FieldName = 'HRG_JUAL_D_GT'
    end
    object qItemHRG_JUAL_A_MT: TFloatField
      FieldName = 'HRG_JUAL_A_MT'
    end
    object qItemHRG_JUAL_T_MT: TFloatField
      FieldName = 'HRG_JUAL_T_MT'
    end
    object qItemHRG_JUAL_D_MT: TFloatField
      FieldName = 'HRG_JUAL_D_MT'
    end
    object qItemDISC_TPR_PSN: TFloatField
      FieldName = 'DISC_TPR_PSN'
    end
    object qItemDISC_TPR_RP: TFloatField
      FieldName = 'DISC_TPR_RP'
    end
    object qItemDISC_REG_PSN: TFloatField
      FieldName = 'DISC_REG_PSN'
    end
    object qItemDISC_REG_RP: TFloatField
      FieldName = 'DISC_REG_RP'
    end
    object qItemDISC_X_PSN: TFloatField
      FieldName = 'DISC_X_PSN'
    end
    object qItemDISC_X_RP: TFloatField
      FieldName = 'DISC_X_RP'
    end
    object qItemDISC_VAL_PSN: TFloatField
      FieldName = 'DISC_VAL_PSN'
    end
    object qItemDISC_VAL_RP: TFloatField
      FieldName = 'DISC_VAL_RP'
    end
  ...
  object qB2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vretur_pembelian_d')
    ReadOnly = True
  ...
  object qB3: TSmartQuery
    ...
    SQL.Strings = (
      ...
      '  sum(ppn10) as ppn10, '
      '  sum(total) as total'
      'from vretur_pembelian_per_item'
  ...
  object qB4: TSmartQuery
    ...
    SQL.Strings = (
      ...
      '  sum(ppn10) as ppn10, '
      '  sum(total) as total'
      'from vretur_pembelian_per_depo'
      'where ((tgl>=:pawal) and (tgl<trunc(:pakhir)+1-1/6400))'
      'group by'
      '  nama_depo,'
      '  kd_item, '
  ...
  object qB5: TSmartQuery
    ...
    SQL.Strings = (
      ...
      '  sum(ppn10) as ppn10, '
      '  sum(total) as total'
      'from vretur_pembelian_per_prinsipal'
      'where ((tgl>=:pawal) and (tgl<trunc(:pakhir)+1-1/6400))'
      'group by'
      '  nama_prinsipal2,'
      '  kd_item, '
  ...
  object qB6: TSmartQuery
    ...
    SQL.Strings = (
      ...
      '  sum(ppn10) as ppn10, '
      '  sum(total) as total'
      'from vretur_pembelian_per_lokasi'
      'where ((tgl>=:pawal) and (tgl<trunc(:pakhir)+1-1/6400))'
      'group by'
      '  nama_lokasi,'
      '  kd_item, '
