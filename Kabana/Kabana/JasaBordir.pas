...
procedure TJasaBordirFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TJasaBordirFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  JasaBordirFrm:=Nil;
end;

procedure TJasaBordirFrm.FormPaint(Sender: TObject);
begin
...
procedure TJasaBordirFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TJasaBordirFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TJasaBordirFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TJasaBordirFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TJasaBordirFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TJasaBordirFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TJasaBordirFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TJasaBordirFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TJasaBordirFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TJasaBordirFrm.tsInputShow(Sender: TObject);
begin
...
procedure TJasaBordirFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  qBMasterKD_FORM.AsString:=vkd_transaksi;
  qBMasterTGL.AsDateTime:=vtgl_bukti;
  qBMasterKD_LOKASI.AsString:='611';
  qBMasterKD_LOKASI2.AsString:='612';
...
procedure TJasaBordirFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TJasaBordirFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TJasaBordirFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TJasaBordirFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TJasaBordirFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TJasaBordirFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TJasaBordirFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='205';
...
procedure TJasaBordirFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TJasaBordirFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TJasaBordirFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TJasaBordirFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TJasaBordirFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TJasaBordirFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure TJasaBordirFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TJasaBordirFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TJasaBordirFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TJasaBordirFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TJasaBordirFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
      qBMaster.Post;
end;

procedure TJasaBordirFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TJasaBordirFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TJasaBordirFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TJasaBordirFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaBordirFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaBordirFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaBordirFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TJasaBordirFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaBordirFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaBordirFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaBordirFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaBordirFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaBordirFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaBordirFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TJasaBordirFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TJasaBordirFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TJasaBordirFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TJasaBordirFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  //qItem.ParamByName('pno_bom').AsFloat:='%';
end;

procedure TJasaBordirFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TJasaBordirFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TJasaBordirFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaBordirFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TJasaBordirFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TJasaBordirFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TJasaBordirFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TJasaBordirFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
end;
...
procedure TJasaBordirFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TJasaBordirFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
...
procedure TJasaBordirFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
  DMFrm.qRekananSubkon.Open;
end;

procedure TJasaBordirFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
