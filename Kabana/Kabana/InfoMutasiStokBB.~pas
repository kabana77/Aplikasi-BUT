...
type
  TInfoMutasiStokBBFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoMutasiStokBBFrm: TInfoMutasiStokBBFrm;
...
procedure TInfoMutasiStokBBFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoMutasiStokBBFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoMutasiStokBBFrm:=Nil;
end;

procedure TInfoMutasiStokBBFrm.FormPaint(Sender: TObject);
begin
...
procedure TInfoMutasiStokBBFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoMutasiStokBBFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoMutasiStokBBFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoMutasiStokBBFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoMutasiStokBBFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoMutasiStokBBFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoMutasiStokBBFrm.tbPrintClick(Sender: TObject);
begin
  case PageControl1.TabIndex of
  0 : begin
...
procedure TInfoMutasiStokBBFrm.qB1BeforeOpen(DataSet: TDataSet);
begin
  qB1.ParamByName('pnama_prinsipal').AsString:='%'
end;

procedure TInfoMutasiStokBBFrm.CheckBox1Click(Sender: TObject);
begin
  lcPrinsipal.Enabled:=not CheckBox1.Checked;
end;

procedure TInfoMutasiStokBBFrm.qBXBeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoMutasiStokBBFrm.qB2BeforeOpen(DataSet: TDataSet);
begin
  qB2.ParamByName('pkd_item').AsString:=qB1KD_ITEM.AsString;
  qB2.ParamByName('pkd_lokasi').AsString:='5';
end;

procedure TInfoMutasiStokBBFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TInfoMutasiStokBBFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TInfoMutasiStokBBFrm.TabSheet3Show(Sender: TObject);
begin
  qB5.Close;
...
procedure TInfoMutasiStokBBFrm.qB1CalcFields(DataSet: TDataSet);
begin
