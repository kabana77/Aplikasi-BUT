...
type
  TTerimaHslSewingFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  TerimaHslSewingFrm: TTerimaHslSewingFrm;
...
procedure TTerimaHslSewingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TTerimaHslSewingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  TerimaBBFrm:=Nil;
end;

procedure TTerimaHslSewingFrm.FormPaint(Sender: TObject);
begin
...
procedure TTerimaHslSewingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TTerimaHslSewingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TTerimaHslSewingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaHslSewingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TTerimaHslSewingFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB1.RecordCount);
  //dbGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#);-', qBXSUB_TOTAL.AsFloat);
end;

procedure TTerimaHslSewingFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TTerimaHslSewingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TTerimaHslSewingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TTerimaHslSewingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TTerimaHslSewingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TTerimaHslSewingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TTerimaHslSewingFrm.tsInputShow(Sender: TObject);
begin
  ...
  DMFrm.qJnsTransaksi.ParamByName('pnama_form').AsString:='TerimaHslSewingFrm/ PENERIMAAN HASIL SEWING';
  DMFrm.qJnsTransaksi.Open;
...
procedure TTerimaHslSewingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaHslSewingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TTerimaHslSewingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TTerimaHslSewingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaHslSewingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TTerimaHslSewingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TTerimaHslSewingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  qBDetailNO_REG_OS.AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TTerimaHslSewingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='218';
...
procedure TTerimaHslSewingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TTerimaHslSewingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TTerimaHslSewingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
end;

procedure TTerimaHslSewingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TTerimaHslSewingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TTerimaHslSewingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TTerimaHslSewingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TTerimaHslSewingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TTerimaHslSewingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaHslSewingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TTerimaHslSewingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TTerimaHslSewingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslSewingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslSewingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslSewingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TTerimaHslSewingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslSewingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslSewingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslSewingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslSewingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaHslSewingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaHslSewingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TTerimaHslSewingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TTerimaHslSewingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TTerimaHslSewingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TTerimaHslSewingFrm.BitBtn2Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TTerimaHslSewingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TTerimaHslSewingFrm.lcdBOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    BitBtn2Click(nil);
...
procedure TTerimaHslSewingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaHslSewingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TTerimaHslSewingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TTerimaHslSewingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TTerimaHslSewingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaHslSewingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TTerimaHslSewingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TTerimaHslSewingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
