...
type
  TInfoWIPCuttingSubkonFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoWIPCuttingSubkonFrm: TInfoWIPCuttingSubkonFrm;
...
procedure TInfoWIPCuttingSubkonFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoWIPCuttingSubkonFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoWIPCuttingSubkonFrm:=Nil;
end;

procedure TInfoWIPCuttingSubkonFrm.FormPaint(Sender: TObject);
begin
...
procedure TInfoWIPCuttingSubkonFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TInfoWIPCuttingSubkonFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoWIPCuttingSubkonFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoWIPCuttingSubkonFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoWIPCuttingSubkonFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoWIPCuttingSubkonFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoWIPCuttingSubkonFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoWIPCuttingSubkonFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoWIPCuttingSubkonFrm.tbPrintClick(Sender: TObject);
begin
  {
...
procedure TInfoWIPCuttingSubkonFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPCuttingSubkonFrm.CheckBox3Click(Sender: TObject);
begin
  qB6.Filtered:=CheckBox3.Checked;  //qB6.Filtered:=CheckBox3.Checked;
end;

procedure TInfoWIPCuttingSubkonFrm.qB6FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(
...
procedure TInfoWIPCuttingSubkonFrm.qB6CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoWIPCuttingSubkonFrm.qB6BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB6.RecordCount);
end;

procedure TInfoWIPCuttingSubkonFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPCuttingSubkonFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPCuttingSubkonFrm.QRBand22BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPCuttingSubkonFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TInfoWIPCuttingSubkonFrm.qB6AfterOpen(DataSet: TDataSet);
begin
  CheckBox1.Checked:=False;
end;

procedure TInfoWIPCuttingSubkonFrm.CheckBox1Click(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPCuttingSubkonFrm.wwDBGrid5RowChanged(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPCuttingSubkonFrm.qBdetailBeforeOpen(DataSet: TDataSet);
begin
