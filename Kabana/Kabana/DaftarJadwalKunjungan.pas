...
type
  TDaftarJadwalKunjunganFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  DaftarJadwalKunjunganFrm: TDaftarJadwalKunjunganFrm;
...
procedure TDaftarJadwalKunjunganFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TDaftarJadwalKunjunganFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  DaftarJadwalKunjunganFrm:=Nil;
end;

procedure TDaftarJadwalKunjunganFrm.FormPaint(Sender: TObject);
begin
...
procedure TDaftarJadwalKunjunganFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TDaftarJadwalKunjunganFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TDaftarJadwalKunjunganFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TDaftarJadwalKunjunganFrm.tbRefreshClick(Sender: TObject);
begin
  qB1.Refresh;
end;

procedure TDaftarJadwalKunjunganFrm.tbExportClick(Sender: TObject);
begin
...
procedure TDaftarJadwalKunjunganFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TDaftarJadwalKunjunganFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TDaftarJadwalKunjunganFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure TDaftarJadwalKunjunganFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TDaftarJadwalKunjunganFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TDaftarJadwalKunjunganFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TDaftarJadwalKunjunganFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TDaftarJadwalKunjunganFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TDaftarJadwalKunjunganFrm.tbPrintClick(Sender: TObject);
begin
