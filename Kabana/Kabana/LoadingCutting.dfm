object LoadingCuttingFrm: TLoadingCuttingFrm
  Left = 433
  Top = 191
  Width = 1330
  Height = 656
  ActiveControl = dbGrid1
  Caption = 'LoadingCuttingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Loading Hasil Cutting'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_cutting where kd_form='#39'203'#39') a'
      'left join wip_cutting_d b'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select distinct to_char(no_bom) as kd_item, keterangan as nama_i' +
        'tem, no_bom from wip_cutting'
      'where kd_form='#39'202'#39' and ispost='#39'1'#39
      ''
