object PembayaranAPFrm: TPembayaranAPFrm
  Left = 365
  Top = 273
  Width = 1291
  Height = 679
  Caption = 'Daftar Pembayaran AP'
  Color = clWindow
  Ctl3D = False
            ...
            object tsInputD: TTabSheet
              ...
              object dbGridD: TwwDBGrid
                ...
                Selected.Strings = (
                  ...
                  'TGL'#9'12'#9'TGL'#9'T'
                  'ID_OUTLET'#9'6'#9'No. ID'#9'T'#9'REKANAN/ PRINSIPAL'
                  'NAMA_OUTLET'#9'35'#9'Nama Rekanan/ Prinsipal'#9'T'#9'REKANAN/ PRINSIPAL'
                  'TGL_JTH_TEMPO'#9'12'#9'JTH_TEMPO'#9'T'
                  'NILAI_FAKTUR'#9'13'#9'NILAI_FAKTUR'#9'T'
                  'SISA_TAGIHAN'#9'13'#9'SISA_TAGIHAN'#9'T'
                  'VOUCHER_KLAIM'#9'11'#9'Klaim'#9'F'#9'VOUCHER'
                  ...
                  'BAYAR_PENDING'#9'12'#9'Pending'#9'F'#9'PEMBAYARAN'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
        ...
        'select * from (select * from vpembayaran_ap where ispost like :p' +
        'ispost)')
    ReadOnly = True
  ...
  object qFaktur: TOraQuery
    ...
    SQL.Strings = (
      ...
      'tgl_jth_tempo, '
      'nilai_tagihan, '
      'sisa_tagihan from vhutang_faktur_resume'
      'where no_reff=:pno_reg_os')
    Left = 786
    Top = 429
    ParamData = <
      item
    ...
    object qFakturNO_REFF: TStringField
      FieldName = 'NO_REFF'
      Required = True
    end
    object qFakturID_PRINSIPAL: TStringField
      FieldName = 'ID_PRINSIPAL'
      Required = True
      Size = 6
    end
    object qFakturNAMA_PRINSIPAL: TStringField
