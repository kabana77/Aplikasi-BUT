object OrderSalesFrm: TOrderSalesFrm
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            'NO_REG_OS'#9'10'#9'NO SJ'#9'F'
            'TGL'#9'12'#9'TGL'#9'F'
            'ID_OUTLET'#9'6'#9'ID CUST'#9'F'
            'NAMA_OUTLET'#9'20'#9'NAMA CUST'#9'F'
            'ALAMAT'#9'25'#9'ALAMAT'#9'F'
            'KETERANGAN'#9'25'#9'KETERANGAN'#9'F'
            'ISPOST'#9'4'#9'POST'#9'F'
            'KD_ITEM'#9'10'#9'KD ITEM'#9'F'
            'NO_SERIAL'#9'14'#9'STYLE'#9'F'
            'DESKRIPSI'#9'20'#9'DESKRIPSI'#9'F'
            'QTY_D'#9'10'#9'QTY'#9'F'
            'JENIS'#9'12'#9'JENIS'#9'F'
            'NIK'#9'15'#9'NO REFF'#9'F'
            'NO_REFF'#9'20'#9'NO KONTRAK'#9'F'
            'OPR_INSERT'#9'15'#9'INSERT BY'#9'F'
            'OPR_UPDATE'#9'15'#9'UPDATE BY'#9'F'
            'TGL_INSERT'#9'12'#9'TGL UPDATE'#9'F'
            'TGL_UPDATE'#9'12'#9'TGL UPDATE'#9'F')
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          DittoAttributes.ShortCutDittoRecord = 16429
          Selected.Strings = (
            'NO_REG_OS'#9'10'#9'NO SJ'#9'F'#9
            'TGL'#9'12'#9'TGL'#9'F'#9
            'ID_OUTLET'#9'6'#9'ID CUST'#9'F'#9
            'NAMA_OUTLET'#9'20'#9'NAMA CUST'#9'F'#9
            'ALAMAT'#9'25'#9'ALAMAT'#9'F'#9
            'KETERANGAN'#9'25'#9'KETERANGAN'#9'F'#9
            'ISPOST'#9'4'#9'POST'#9'F'#9
            'KD_ITEM'#9'10'#9'KD ITEM'#9'F'#9
            'NO_SERIAL'#9'14'#9'STYLE'#9'F'#9
            'DESKRIPSI'#9'20'#9'DESKRIPSI'#9'F'#9
            'QTY_D'#9'10'#9'QTY'#9'F'#9
            'NO_REFF'#9'20'#9'NO KONTRAK'#9'F'#9
            'JENIS'#9'12'#9'JENIS'#9#9
            'OPR_INSERT'#9'15'#9'INSERT BY'#9'F'#9
            'TGL_INSERT'#9'12'#9'TGL UPDATE'#9'F'#9
            'OPR_UPDATE'#9'15'#9'UPDATE BY'#9'F'#9
            'TGL_UPDATE'#9'12'#9'TGL UPDATE'#9'F'#9)
          IniAttributes.Delimiter = ';;'
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          ...
          Color = clWhite
          DataSource = dsqB1
          Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap, dgFooter3DCells, dgTrailingEllipsis]
          TabOrder = 2
          TitleAlignment = taLeftJustify
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'NO_BUKTI'#9'15'#9'NOMOR'#9'F'#9'DATA SURAT JALAN'
            'NO_REG_OS'#9'10'#9'NOMOR'#9'F'#9'DATA SURAT JALAN'
            'TGL'#9'12'#9'TANGGAL'#9'F'#9'DATA SURAT JALAN'
            'ID_OUTLET'#9'6'#9'ID CUST'#9'F'#9'DATA SURAT JALAN'
            'NAMA_OUTLET'#9'25'#9'NAMA CUSTOMER'#9'F'#9'DATA SURAT JALAN'
            'ALAMAT'#9'20'#9'ALAMAT'#9'F'#9'DATA SURAT JALAN'
            'KETERANGAN'#9'20'#9'KETERANGAN'#9'F'#9'DATA SURAT JALAN'
            'ISPOST'#9'5'#9'POST'#9'F'#9'DATA SURAT JALAN'
            'KD_ITEM'#9'12'#9'KD ITEM'#9'T'#9'DATA ITEM'
            'NO_SERIAL'#9'15'#9'STYLE'#9'T'#9'DATA ITEM'
            'DESKRIPSI'#9'20'#9'DESKRIPSI'#9'T'#9'DATA ITEM'
            'COLOR'#9'15'#9'COLOR'#9'T'#9'DATA ITEM'
            'QTY_D'#9'8'#9'QTY'#9'T'#9'DATA ITEM'
        ...
        object pMaster: TPanel
          ...
          object GroupBox2: TGroupBox
            ...
            object lcdOutlet: TwwDBLookupComboDlg
              ...
              Selected.Strings = (
                'ID_OUTLET'#9'6'#9'ID CUSTOMER'#9'F'
          ...
          object GroupBox3: TGroupBox
            ...
            object lcdKontrak: TwwDBLookupComboDlg
              Left = 10
              Top = 17
              Width = 121
              Height = 19
              ...
              MaxHeight = 209
              UserButton1Caption = '&Refresh'
              OnUserButton1Click = lcdKontrakUserButton1Click
              Selected.Strings = (
                'NO_REG_OS'#9'10'#9'NO_KONTRAK'#9'F'#9
                'NO_REFF'#9'30'#9'NO REFF'#9'F'
                'ID_OUTLET'#9'6'#9'NO ID'#9'F'#9
                'NAMA_OUTLET'#9'20'#9'CUSTOMER'#9'F'
                'TGL'#9'12'#9'TGL'#9'F'#9
                'JENIS'#9'12'#9'JENIS'#9'F'#9
                'JNS_PPN'#9'3'#9'JNS_PPN'#9'F'#9
                'MU'#9'3'#9'MU'#9'F'#9
                'KURS'#9'10'#9'KURS'#9'F'#9)
              DataField = 'NO_REFF'
              DataSource = dsqBMaster
              LookupTable = qKontrak
              LookupField = 'NO_REG_OS'
              TabOrder = 0
              AutoDropDown = False
              ShowButton = True
              AllowClearKey = False
              OnCloseUp = lcdKontrakCloseUp
              OnEnter = lcdKontrakEnter
            end
          end
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'NO_SERIAL'#9'17'#9'STYLE'#9'T'
                'KETERANGAN'#9'41'#9'DESCRIPTION'#9'T'
                'COLOR'#9'15'#9'COLOR'#9'F'
                'QTY_D_INFO'#9'10'#9'STOK'#9'T'
                'QTY_D_ORDER'#9'10'#9'SISA~ORDER'#9'T'
                'QTY_D_ORDER_ORG'#9'6'#9'QTY/PCS'#9'F')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
            ...
            object lcdItem: TwwDBLookupComboDlg
              ...
              Selected.Strings = (
                ...
                'STYLE'#9'11'#9'STYLE'#9'F'
                'NAMA_ITEM'#9'40'#9'DESCRIPTION'#9'F'
                'COLOR'#9'15'#9'COLOR'#9'F'
                'SAT_D'#9'6'#9'SATUAN'#9'F'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Order Sales &Detail'
        ImageIndex = 2
      ...
      object TabSheet7: TTabSheet
        Caption = 'Rekap Harian Order Per Sales'
        ImageIndex = 7
  ...
  object qB1: TSmartQuery
    ...
    object qB1NO_SERIAL: TStringField
      DisplayLabel = 'STYLE'
      DisplayWidth = 14
      FieldName = 'NO_SERIAL'
      Size = 50
    end
    object qB1DESKRIPSI: TStringField
      DisplayWidth = 20
      FieldName = 'DESKRIPSI'
      Size = 255
    end
  ...
  object qBDetail: TSmartQuery
    ...
    object qBDetailLABEL_SUB_TOTAL: TFloatField
      FieldKind = fkCalculated
      FieldName = 'LABEL_SUB_TOTAL'
      DisplayFormat = '#,#0.00;(#,#0.00);'
      Calculated = True
    end
  ...
  object qBMaster: TSmartQuery
    ...
    object qBMasterID_OUTLET2: TStringField
      ...
      OnChange = qBMasterID_OUTLET2Change
      Size = 6
    end
    ...
    object qBMasterNAMA_OUTLET2: TStringField
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
      'select * from('
      'select * from VDAFTAR_ITEM_BJ_40000000'
      'UNION'
    ...
    object qItemSTYLE: TStringField
      DisplayWidth = 11
      FieldName = 'STYLE'
      Size = 50
    end
  ...
  object qBDetailX: TOraQuery
    ...
    SQL.Strings = (
      'select '
      'count(*) as ndata,'
      'sum(qty_a_sj) as qty_a_sj,'
      'sum(qty_t_sj) as qty_t_sj,'
      'sum(qty_d_sj) as qty_d_sj,'
      'sum(qty_a) as qty_a,'
      'sum(qty_t) as qty_t,'
      'sum(qty_d) as qty_d,'
      ...
      'sum(dpp)+sum(ppn10) as label_sub_total'
      'from order_sales_d'
      'where no_reg_os=:pno_reg_os')
    ...
    object qBDetailXLABEL_SUB_TOTAL: TFloatField
      FieldName = 'LABEL_SUB_TOTAL'
    end
  end
  ...
  object qStokSales: TOraQuery
    ...
    SQL.Strings = (
      ...
      '  a.rt, '
      '  a.rd,'
      '  fx2a(p.qty_x,0,0,a.rd,'#39'A'#39') as qty_a,'
      '  fx2a(p.qty_x,0,0,a.rd,'#39'T'#39') as qty_t,'
      '  fx2a(p.qty_x,0,0,a.rd,'#39'D'#39') as qty_d ,  '
  ...
  object qKontrak: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vkontrak')
    Left = 873
    Top = 296
    object qKontrakNO_REG_OS: TFloatField
      DisplayLabel = 'NO_KONTRAK'
      DisplayWidth = 10
      FieldName = 'NO_REG_OS'
      Required = True
    end
    object qKontrakNO_REFF: TStringField
      DisplayLabel = 'NO REFF'
      DisplayWidth = 30
      FieldName = 'NO_REFF'
      Required = True
    end
    object qKontrakID_OUTLET: TStringField
      DisplayLabel = 'NO ID'
      DisplayWidth = 6
      FieldName = 'ID_OUTLET'
      Required = True
    ...
    object qKontrakNAMA_OUTLET: TStringField
    ...
    object qKontrakJENIS: TStringField
      DisplayWidth = 12
      FieldName = 'JENIS'
      Required = True
      Size = 12
    end
    object qKontrakJNS_PPN: TStringField
      DisplayWidth = 3
      FieldName = 'JNS_PPN'
      Required = True
      FixedChar = True
    ...
    object qKontrakMU: TStringField
      DisplayWidth = 3
      FieldName = 'MU'
      Required = True
      Size = 3
    end
    object qKontrakKURS: TFloatField
      DisplayWidth = 10
      FieldName = 'KURS'
      Required = True
    end
    object qKontrakSLSMAN: TStringField
      DisplayWidth = 20
      FieldName = 'SLSMAN'
      Required = True
      Visible = False
    ...
    object qKontrakID_SLSMAN: TStringField
      FieldName = 'ID_SLSMAN'
      Required = True
      Visible = False
      Size = 12
    end
    object qKontrakALAMAT: TStringField
      FieldName = 'ALAMAT'
      Required = True
      Visible = False
      Size = 255
    end
    object qKontrakKOTA: TStringField
      FieldName = 'KOTA'
      Required = True
      Visible = False
      Size = 50
    end
    object qKontrakTELEPON: TStringField
      FieldName = 'TELEPON'
      Required = True
      Visible = False
      Size = 50
  ...
  object ProcDeleteDetail: TOraStoredProc
    StoredProcName = 'PROC_DEL_OSD'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_DEL_OSD(:PVAL_NAME);'
      'end;')
    Left = 808
    Top = 227
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_DEL_OSD:0'
  end
end
