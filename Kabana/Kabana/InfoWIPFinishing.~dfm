object InfoWIPFinishingFrm: TInfoWIPFinishingFrm
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Finishing'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_FINISHING'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_FINISHING(:PAWAL, :PAKHIR);'
      'end;')
    Left = 392
    Top = 291
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_FINISHING:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_finishing'
