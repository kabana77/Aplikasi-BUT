object FakturGabFrm: TFakturGabFrm
  Left = 81
  Top = 258
  Width = 1300
  Height = 679
  Caption = 'FakturGabFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object qB1: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from pjk_faktur_gabungan')
    ReadOnly = True
    Active = True
    Left = 1123
    Top = 24
  ...
  object qBDetail: TSmartQuery
    ...
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from pjk_faktur_gabungan_d'
  ...
  object procCreate: TOraStoredProc
    StoredProcName = 'PROC_PJK_GAB'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_PJK_GAB(:PAWAL, :PAKHIR, :PNO_SERI);'
      'end;')
    Left = 816
    Top = 427
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_PJK_GAB:0'
  end
  object qB2: TSmartQuery
    ...
    SQL.Strings = (
      'select * from vorder_sales_d'
        ...
        'where no_reg_os in (select no_reg_os from pjk_faktur_gab where n' +
        'o_reg_os_gab=:pno_reg_os_gab)')
    ReadOnly = True
  ...
  object OraQuery1: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'update order_sales set no_seri_pjk=:pno_seri_pjk'
  ...
  object qMaxNoSeri: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select max(no_seri_faktur) as no_seri_pjk from pjk_faktur_gabung' +
        'an'
      'where tgl<:ptgl')
    Left = 576
    Top = 474
  ...
  object OraQuery2: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'update pjk_faktur_gabungan set no_seri_faktur=:pno_seri_pjk'
      'where no_reg_jual=:pno_reg_jual')
    Left = 944
    Top = 218
    ParamData = <
  ...
  object OraQuery3: TOraQuery
    ...
    SQL.Strings = (
        ...
        'update pjk_faktur_gabungan set ispost='#39'0'#39' where no_reg_jual=:pno' +
        '_reg_jual')
    Left = 608
    Top = 186
    ParamData = <
