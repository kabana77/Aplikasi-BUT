...
type
  TPengirimanFrm = class(TForm)
    ...
    Label21: TLabel;
    qSopir: TOraQuery;
    qSopirNIK: TStringField;
    qSopirNAMA_KARYAWAN: TStringField;
    qKendaraan: TOraQuery;
    ...
    qB1STD_M3: TFloatField;
    qB1STD_KG: TFloatField;
    qB1NAMA_SOPIR: TStringField;
    qB1NAMA_EKSPEDISI: TStringField;
    qB1KG_TOT: TFloatField;
    qB1M3_TOT: TFloatField;
    qB1EFF_KG: TFloatField;
    qB1EFF_M3: TFloatField;
    qBMasterJNS_EKSPEDISI: TStringField;
    qBMasterID_EKSPEDISI: TStringField;
    qBMasterNAMA_EKSPEDISI: TStringField;
    qBMasterNO_POLISI: TStringField;
    qBMasterSTD_M3: TFloatField;
    qBMasterSTD_KG: TFloatField;
    qBMasterID_SOPIR: TStringField;
    qBMasterNAMA_SOPIR: TStringField;
    qBMasterKG_TOT: TFloatField;
    qBMasterM3_TOT: TFloatField;
    qBMasterEFF_KG: TFloatField;
    qBMasterEFF_M3: TFloatField;
    lcdKendaraan: TwwDBLookupComboDlg;
    qSopirKD_DEPO: TStringField;
    qKendaraanNO_POLISI: TStringField;
    qKendaraanJENIS: TStringField;
    qKendaraanKD_DEPO: TStringField;
    qKendaraanSTD_M3: TFloatField;
    qKendaraanSTD_KG: TFloatField;
    Label1: TLabel;
    lcdSopir: TwwDBLookupComboDlg;
    Label2: TLabel;
    DBText1: TDBText;
    Label3: TLabel;
    Label4: TLabel;
    ...
    qB3M3_TOT: TFloatField;
    qB5M3_TOT: TFloatField;
    qB6M3_TOT: TFloatField;
    qB2XM3_TOT: TFloatField;
    qrBukti3: TQuickRep;
    QRBand14: TQRBand;
    ...
    procedure qSopirBeforeOpen(DataSet: TDataSet);
    ...
    procedure lcdKendaraanEnter(Sender: TObject);
    procedure lcdKendaraanUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure lcdSopirEnter(Sender: TObject);
    procedure lcdSopirUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure qBMasterID_SOPIRChange(Sender: TField);
    procedure qBMasterNO_POLISIChange(Sender: TField);
    procedure vNoRegKeyPress(Sender: TObject; var Key: Char);
    procedure TabSheet4Show(Sender: TObject);
    procedure qrBuktiYBeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
    ...
    procedure QRBand12BeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    procedure qrBukti3BeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
...
procedure TPengirimanFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TPengirimanFrm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPengirimanFrm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPengirimanFrm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPengirimanFrm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPengirimanFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  PengirimanFrm:=Nil;
end;

procedure TPengirimanFrm.FormPaint(Sender: TObject);
begin
...
procedure TPengirimanFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TPengirimanFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TPengirimanFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPengirimanFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TPengirimanFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TPengirimanFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TPengirimanFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TPengirimanFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPengirimanFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TPengirimanFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TPengirimanFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TPengirimanFrm.qSopirBeforeOpen(DataSet: TDataSet);
begin
//  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TPengirimanFrm.tsInputShow(Sender: TObject);
begin
...
procedure TPengirimanFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPengirimanFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TPengirimanFrm.qBMasterKD_LOKASIChange(Sender: TField);
begin
...
procedure TPengirimanFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TPengirimanFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
  vispost_old:=qBMasterISPOST.AsString;
end;

procedure TPengirimanFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TPengirimanFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TPengirimanFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPengirimanFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
      ShowMessage('Maaf, data tidak bisa menambah data langsung disini!');
      Abort;
end;

procedure TPengirimanFrm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
...
procedure TPengirimanFrm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TPengirimanFrm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
     vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TPengirimanFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TPengirimanFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TPengirimanFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TPengirimanFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TPengirimanFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TPengirimanFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPengirimanFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo.Caption:=IntToStr(StrToInt(qrlNo.Caption)+1);
end;

procedure TPengirimanFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo.Caption:='0';
end;

procedure TPengirimanFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
  vqtya:=0;
...
procedure TPengirimanFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vhal:=vhal+1;
end;

procedure TPengirimanFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPengirimanFrm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, 0 AS KG_TOT, 0 as M3_TOT from (');
  qB2X.SQL.Add(vsql_org2+vfilter2+')');                                   //GANTI
  qB2X.Open;
  pLeft2.Caption:=FormatFloat('#,#;0',qB2XNDATA.AsInteger);
  dbGrid2.ColumnByName('M3_TOT').FooterValue:=FormatFloat('#,#;(#,#);-',qB2XM3_TOT.AsFloat);
end;

procedure TPengirimanFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPengirimanFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TPengirimanFrm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TPengirimanFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TPengirimanFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPengirimanFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPengirimanFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPengirimanFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPengirimanFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPengirimanFrm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(m3_tot) as m3_tot from (');
  ...
  dbGrid3.ColumnByName('M3_TOT').FooterValue:=FormatFloat('#,#;(#,#);-',qB2XM3_TOT.AsFloat);
end;

procedure TPengirimanFrm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(M3_TOT) as M3_TOT from (');
  ...
  dbGrid5.ColumnByName('M3_TOT').FooterValue:=FormatFloat('#,#;(#,#);-',qB2XM3_TOT.AsFloat);
end;

procedure TPengirimanFrm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, sum(kg_tot) as kg_tot, sum(M3_TOT) as M3_TOT from (');
  ...
  dbGrid6.ColumnByName('M3_TOT').FooterValue:=FormatFloat('#,#;(#,#);-',qB2XM3_TOT.AsFloat);
end;

procedure TPengirimanFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPengirimanFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPengirimanFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPengirimanFrm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TPengirimanFrm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPengirimanFrm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TPengirimanFrm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TPengirimanFrm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TPengirimanFrm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPengirimanFrm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TPengirimanFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TPengirimanFrm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TPengirimanFrm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TPengirimanFrm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPengirimanFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TPengirimanFrm.BitBtn1Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
  begin
      qBMaster.Post;
  ...
  begin
     ...
     proc_ImpData.ParamByName('pnama_outlet').AsString:=qBMasterNAMA_OUTLET.AsString;
...
procedure TPengirimanFrm.qBDetailBeforeEdit(DataSet: TDataSet);
begin
      ShowMessage('Maaf, data tidak bisa di-EDIT disini!');
      Abort;
end;

procedure TPengirimanFrm.tsInputD2Show(Sender: TObject);
begin
  qBDetail2.Close;
  qBDetail2.Open;
end;

procedure TPengirimanFrm.tsInputD3Show(Sender: TObject);
begin
  qBDetail3.Close;
  qBDetail3.Open;
end;

procedure TPengirimanFrm.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoD2.Caption:='0';
end;

procedure TPengirimanFrm.QRBand11BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoD2.Caption:=IntToStr(StrToInt(qrlNoD2.Caption)+1);
  vqtya:=vqtya+qBDetail2QTY_A.AsFloat;
  vqtyt:=vqtya+qBDetail2QTY_T.AsFloat;
  vqtyd:=vqtya+qBDetail2QTY_D.AsFloat;
end;

procedure TPengirimanFrm.qBDetail2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPengirimanFrm.QRBand37BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPengirimanFrm.qBDetail3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPengirimanFrm.lcdKendaraanEnter(Sender: TObject);
begin
  qKendaraan.open;
end;

procedure TPengirimanFrm.lcdKendaraanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qKendaraan.Close;
  qKendaraan.open;
...
procedure TPengirimanFrm.lcdSopirEnter(Sender: TObject);
begin
  qSopir.Open;
end;

procedure TPengirimanFrm.lcdSopirUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
   qSopir.Close;
   qSopir.Open;
...
procedure TPengirimanFrm.qBMasterID_SOPIRChange(Sender: TField);
begin
  if qSopir.Locate('NIK',qBMasterID_SOPIR.AsString,[loPartialKey]) then
  begin
    qBMasterNAMA_SOPIR.AsString:=qSopirNAMA_KARYAWAN.AsString;
  end
  else
    ShowMessage('Data tidak ditemukan !');
...
procedure TPengirimanFrm.qBMasterNO_POLISIChange(Sender: TField);
begin
  if qKendaraan.Locate('NO_POLISI',qBMasterNO_POLISI.AsString,[loPartialKey]) then
  begin
    qBMasterSTD_M3.AsFloat:=qKendaraanSTD_M3.AsFloat;
    qBMasterSTD_KG.AsFloat:=qKendaraanSTD_KG.AsFloat;
  end
  else
    ShowMessage('Data tidak ditemukan !');
end;

procedure TPengirimanFrm.vNoRegKeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
  begin
      BitBtn1.SetFocus;
...
procedure TPengirimanFrm.TabSheet4Show(Sender: TObject);
begin
  DMFrm.qOutstandingSJ2DO.Close;
  DMFrm.qOutstandingSJ2DO.Open;
end;

procedure TPengirimanFrm.qrBuktiYBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TPengirimanFrm.QRBand41BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vhal:=vhal+1;
end;

procedure TPengirimanFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoY.Caption:='0';
end;

procedure TPengirimanFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoY.Caption:=IntToStr(StrToInt(qrlNoY.Caption)+1);
end;

procedure TPengirimanFrm.QRBand12BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  vjumlah : String;
begin
  ...
  if vqtya>0 then
  begin
     vjumlah:=FormatFloat('#,#;(#,#);-',vqtya)+' A';
  end;
  if vqtyt>0 then
     if vjumlah<>'' then
       vjumlah:=vjumlah+' '+FormatFloat('#,#;(#,#);-',vqtyt)+' T'
       else
       begin
          vjumlah:=FormatFloat('#,#;(#,#);-',vqtyt)+' T';
       end;
  if vqtyd>0 then
     if vjumlah<>'' then
       vjumlah:=vjumlah+' '+FormatFloat('#,#;(#,#);-',vqtyd)+' D'
       else
       begin
          vjumlah:=FormatFloat('#,#;(#,#);-',vqtyd)+' D';
       end;
   qrlQTY.Caption:=vjumlah;
end;

procedure TPengirimanFrm.qrBukti3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
  vqtya:=0;
...
procedure TPengirimanFrm.qrBukti2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
  vqtya:=0;
...
procedure TPengirimanFrm.QRBand38BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  vjumlah : String;
begin
