...
procedure TMasterFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TMasterFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  MasterFrm:=Nil;
end;

procedure TMasterFrm.FormPaint(Sender: TObject);
begin
...
procedure TMasterFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TMasterFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TMasterFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TMasterFrm.tbRefreshClick(Sender: TObject);
begin
  qB1.Refresh;
end;

procedure TMasterFrm.tbExportClick(Sender: TObject);
begin
...
procedure TMasterFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TMasterFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TMasterFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TMasterFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TMasterFrm.tbFilterClick(Sender: TObject);
begin
...
procedure TMasterFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TMasterFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TMasterFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TMasterFrm.tbPrintClick(Sender: TObject);
begin
