object InfoWIPFinishing2Frm: TInfoWIPFinishing2Frm
  Left = 267
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPFinishing2Frm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Finishing 2'
        ...
        object pData: TPanel
          ...
          object wwDBGrid5: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_ITEM'#9'30'#9'NAMA BARANG'#9'F'
              'SAT'#9'10'#9'SATUAN'#9'F'
              'QTY_AWAL'#9'10'#9'SALDO~AWAL'#9'F'
              'QTY_IN'#9'10'#9'MASUK'#9'F'
              'QTY_OUT'#9'10'#9'KELUAR'#9'F'
              'CQTY_AKHIR'#9'10'#9'SALDO~AKHIR'#9'F')
  ...
  object qB6: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_mutasi_cutting1')
    ReadOnly = True
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_FINISHING2'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_FINISHING2(:PAWAL, :PAKHIR);'
      'end;')
    Left = 392
    Top = 291
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_FINISHING2:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_sewing2'
