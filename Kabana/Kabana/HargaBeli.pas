...
procedure THargaBeliFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure THargaBeliFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  HargaBeliFrm:=Nil;
end;

procedure THargaBeliFrm.FormPaint(Sender: TObject);
begin
...
procedure THargaBeliFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure THargaBeliFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure THargaBeliFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure THargaBeliFrm.tbRefreshClick(Sender: TObject);
begin
  qB1.Refresh;
end;

procedure THargaBeliFrm.tbExportClick(Sender: TObject);
begin
...
procedure THargaBeliFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure THargaBeliFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure THargaBeliFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  if vsql_org1<>'' then
  begin
    qBX.Close;
...
procedure THargaBeliFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure THargaBeliFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure THargaBeliFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure THargaBeliFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure THargaBeliFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure THargaBeliFrm.tbPrintClick(Sender: TObject);
begin
...
procedure THargaBeliFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure THargaBeliFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
