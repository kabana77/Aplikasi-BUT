...
type
  TPemasukanWasteFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  PemasukanWasteFrm: TPemasukanWasteFrm;
...
procedure TPemasukanWasteFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TPemasukanWasteFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  PemasukanWasteFrm:=Nil;
end;

procedure TPemasukanWasteFrm.FormPaint(Sender: TObject);
begin
...
procedure TPemasukanWasteFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TPemasukanWasteFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TPemasukanWasteFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPemasukanWasteFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TPemasukanWasteFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TPemasukanWasteFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TPemasukanWasteFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TPemasukanWasteFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TPemasukanWasteFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TPemasukanWasteFrm.tsInputShow(Sender: TObject);
begin
...
procedure TPemasukanWasteFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPemasukanWasteFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TPemasukanWasteFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TPemasukanWasteFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TPemasukanWasteFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TPemasukanWasteFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TPemasukanWasteFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  qBDetailNO_REG_OS.AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TPemasukanWasteFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='197';
...
procedure TPemasukanWasteFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TPemasukanWasteFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TPemasukanWasteFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TPemasukanWasteFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TPemasukanWasteFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TPemasukanWasteFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
end;

procedure TPemasukanWasteFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TPemasukanWasteFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TPemasukanWasteFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TPemasukanWasteFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TPemasukanWasteFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TPemasukanWasteFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPemasukanWasteFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPemasukanWasteFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TPemasukanWasteFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TPemasukanWasteFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPemasukanWasteFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPemasukanWasteFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TPemasukanWasteFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPemasukanWasteFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TPemasukanWasteFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TPemasukanWasteFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TPemasukanWasteFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TPemasukanWasteFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPemasukanWasteFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TPemasukanWasteFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TPemasukanWasteFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPemasukanWasteFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TPemasukanWasteFrm.BitBtn2Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TPemasukanWasteFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('pno_reg_d2').AsFloat:=FloatField1.AsFloat;
end;

procedure TPemasukanWasteFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TPemasukanWasteFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TPemasukanWasteFrm.lcdBOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    BitBtn2Click(nil);
...
procedure TPemasukanWasteFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPemasukanWasteFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TPemasukanWasteFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TPemasukanWasteFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TPemasukanWasteFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPemasukanWasteFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TPemasukanWasteFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TPemasukanWasteFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
