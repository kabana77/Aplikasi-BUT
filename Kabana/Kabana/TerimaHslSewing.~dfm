object TerimaHslSewingFrm: TTerimaHslSewingFrm
  Left = 247
  Top = 133
  Width = 1382
  Height = 784
  Caption = 'TerimaHslSewingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object tsInput: TTabSheet
        Caption = '&Penerimaan Hasil Sewing'
        ImageIndex = 1
        OnShow = tsInputShow
        object qrBukti: TQuickRep
          ...
          object QRBand42: TQRBand
            ...
            object QRLabel212: TQRLabel
              ...
              AutoSize = True
              AutoStretch = False
              Caption = 'Penerimaan Hasil Cutting'
              Color = clWhite
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -21
        ...
        object pMaster: TPanel
          ...
          object Label18: TLabel
            ...
            Width = 150
            Height = 13
            Caption = 'No. Bukti Transfer Hasil Sewing'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'QTY_D'#9'12'#9'JUMLAH'#9'T'
                'KETERANGAN2'#9'50'#9'KETERANGAN'#9'T'
                'NO_BOM'#9'20'#9'BOM'#9'T')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_finishing where kd_form='#39'218'#39') a'
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_WIP_FINISHING'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_WIP_FINISHING(:PNO_REG_OS, :PNO_BUKTI);'
      'end;')
    Left = 944
    Top = 259
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_WIP_FINISHING:0'
  end
