...
procedure TPembelian2Frm.qBDetailBeforeEdit(DataSet: TDataSet);
begin
  vispost_old:=qBMasterISPOST.AsString;
  vispost2_old:=qBMasterISPOST2.AsString;
  if not vCanEdit then
...
procedure TPembelian2Frm.wwCheckBox2Click(Sender: TObject);
begin
...
procedure TPembelian2Frm.DetailBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
