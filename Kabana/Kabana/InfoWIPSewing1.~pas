...
type
  TInfoWIPSewing1Frm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoWIPSewing1Frm: TInfoWIPSewing1Frm;
...
procedure TInfoWIPSewing1Frm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoWIPSewing1Frm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoWIPSewing1Frm:=Nil;
end;

procedure TInfoWIPSewing1Frm.FormPaint(Sender: TObject);
begin
...
procedure TInfoWIPSewing1Frm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TInfoWIPSewing1Frm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing1Frm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TInfoWIPSewing1Frm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoWIPSewing1Frm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoWIPSewing1Frm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoWIPSewing1Frm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoWIPSewing1Frm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoWIPSewing1Frm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoWIPSewing1Frm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoWIPSewing1Frm.tbPrintClick(Sender: TObject);
begin
  {
...
procedure TInfoWIPSewing1Frm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing1Frm.CheckBox3Click(Sender: TObject);
begin
  qB6.Filtered:=CheckBox3.Checked;  //qB6.Filtered:=CheckBox3.Checked;
end;

procedure TInfoWIPSewing1Frm.qB6FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(
...
procedure TInfoWIPSewing1Frm.qB6CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing1Frm.qB6BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB6.RecordCount);
end;

procedure TInfoWIPSewing1Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing1Frm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPSewing1Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing1Frm.QRBand22BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPSewing1Frm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TInfoWIPSewing1Frm.qBdetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPSewing1Frm.CheckBox1Click(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPSewing1Frm.qB6AfterOpen(DataSet: TDataSet);
begin
  CheckBox1.Checked:=False;
end;

procedure TInfoWIPSewing1Frm.wwDBGrid5RowChanged(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
