object FakturTerkirimFrm: TFakturTerkirimFrm
  Left = 381
  Top = 382
  Width = 1289
  Height = 679
  Caption = 'FakturTerkirimFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Faktur Terkirim'
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'NO_REG_OS'#9'15'#9'NO_REGISTER'#9'F'
            'TGL'#9'11'#9'TGL'#9'F'
            'NO_REG_OS_REFF'#9'19'#9'NO_PENGIRIMAN/ DO'#9'F'
            'NO_POLISI'#9'12'#9'NO_POLISI'#9'F'
            'ISPOST'#9'3'#9'Post'#9'F'#9'STATUS'
            'ISBATAL'#9'4'#9'Batal'#9'F'#9'STATUS'
            'NAMA_DEPO'#9'13'#9'DEPO'#9'F'
        ...
        object PageControl2: TPageControl
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                'NO_REG_OS_REFF'#9'16'#9'NO_ORDER/~BUKTI'#9'F'
                'TGL_KIRIM'#9'12'#9'TGL_KEMBALI'#9'F'
                'KETERANGAN'#9'38'#9'KETERANGAN'#9'F'
                'TGL_ORDER'#9'12'#9'Faktur'#9'T'#9'TANGGAL'
                'TGL_LOADING'#9'12'#9'Loading'#9'T'#9'TANGGAL'
                'TGL_PENGIRIMAN'#9'12'#9'Kirim'#9'T'#9'TANGGAL'
                'NAMA_KARYAWAN'#9'16'#9'Slsman'#9'T'#9'DATA FAKTUR'
                'NAMA_OUTLET'#9'13'#9'Nama Outlet'#9'T'#9'DATA FAKTUR'
                'NILAI_FAKTUR'#9'13'#9'Nilai'#9'T'#9'DATA FAKTUR')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
          ...
          object TabSheet3: TTabSheet
            Caption = 'Info Faktur Belum Kembali'
            ImageIndex = 1
            ...
            object wwDBGrid3: TwwDBGrid
              ...
              Align = alClient
              Color = clWhite
              DataSource = DMFrm.dsqOutstandingDO2FT
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -11
              Font.Name = 'MS Sans Serif'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Faktur Terkirim &Detail'
        ImageIndex = 2
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NO_DO'#9'15'#9'NO_DO'#9'F'
            'NO_POLISI'#9'14'#9'NO_POLISI'#9'F'
            'NO_FAKTUR'#9'18'#9'NO_FAKTUR'#9'F'
            'TGL_ORDER'#9'18'#9'TGL_ORDER'#9'F'
            'TGL_LOADING'#9'18'#9'TGL_LOADING'#9'F'
            'TGL_PENGIRIMAN'#9'18'#9'TGL_PENGIRIMAN'#9'F'
  ...
  object qBDetail: TSmartQuery
    ...
    object qBDetailTGL_ORDER: TDateTimeField
      FieldName = 'TGL_ORDER'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qBDetailTGL_LOADING: TDateTimeField
      FieldName = 'TGL_LOADING'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qBDetailTGL_PENGIRIMAN: TDateTimeField
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_TERKIRIM'
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from faktur_terkirim'
  ...
  object qB2: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vfaktur_terkirim_d')
    ReadOnly = True
    Left = 1171
    Top = 24
    ...
    object qB2TGL_ORDER: TDateTimeField
      FieldName = 'TGL_ORDER'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qB2TGL_LOADING: TDateTimeField
      FieldName = 'TGL_LOADING'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qB2TGL_PENGIRIMAN: TDateTimeField
      FieldName = 'TGL_PENGIRIMAN'
      DisplayFormat = 'dd mmm yyyy'
    end
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_FAKTUR_TERKIRIM'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_FAKTUR_TERKIRIM(:PNO_REG_OS, :PNO_REG_OS_REFF);'
      'end;')
    Left = 928
    Top = 299
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_FAKTUR_TERKIRIM:0'
  end
end
