object PindahLokasiFrm: TPindahLokasiFrm
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'TGL'#9'11'#9'TGL'#9'F'
            'JENIS'#9'24'#9'JENIS'#9'F'
            'NO_REFF'#9'15'#9'NO_REFF'#9'F'
            'NO_PO'#9'5'#9'No. PO'#9'F'#9'DOKUMEN TAMBAHAN'
            'NO_BL'#9'5'#9'No. BL'#9'F'#9'DOKUMEN TAMBAHAN'
            'NO_CONTAINER'#9'10'#9'No. Container'#9'F'#9'DOKUMEN TAMBAHAN'
            'NO_SEAL'#9'6'#9'No. Seal'#9'F'#9'DOKUMEN TAMBAHAN'
            'NAMA_KAPAL'#9'9'#9'Nama Kapal'#9'F'#9'DOKUMEN TAMBAHAN'
            'NAMA_DEPO'#9'14'#9'DEPO'#9'F'
            'NAMA_LOKASI'#9'9'#9'Asal'#9'F'#9'LOKASI'
            'NAMA_LOKASI2'#9'8'#9'Tujuan'#9'F'#9'LOKASI'
      ...
      object tsInput: TTabSheet
        ...
        object pMaster: TPanel
          ...
          object GroupBox1: TGroupBox
            ...
            Width = 289
            Height = 113
            Caption = 'Dokumen Tambahan Pengiriman'
            TabOrder = 7
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'KETERANGAN'#9'67'#9'KETERANGAN'#9'T'
                ...
                'QTY_A_ORDER'#9'5'#9'A'#9'T'#9'ORDER'
                'QTY_T_ORDER'#9'1'#9'T'#9'T'#9'ORDER'
                'QTY_D_ORDER'#9'3'#9'D'#9'T'#9'ORDER'
                'QTY_A_INFO'#9'3'#9'A'#9'T'#9'STOK'
                'QTY_T_INFO'#9'1'#9'T'#9'T'#9'STOK'
                'QTY_D_INFO'#9'4'#9'D'#9'T'#9'STOK'
                'QTY_A'#9'7'#9'A'#9'T'#9'DIPINDAH'
                'QTY_T'#9'3'#9'T'#9'T'#9'DIPINDAH'
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_LOKASI2'#9'15'#9'Tujuan'#9'F'#9'LOKASI'
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_PL'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_PL(:PNO_REG_OS, :PNO_REG_OS_PO);'
      'end;')
    Left = 944
    Top = 259
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_PL:0'
  end
