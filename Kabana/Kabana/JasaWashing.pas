...
var
  JasaWashingFrm: TJasaWashingFrm;

implementation

uses dm, Filter, PemakaianBahan, TerimaBB, HasilCutting, JasaBordir;
...
procedure TJasaWashingFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TJasaWashingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  JasaWashingFrm:=Nil;
end;

procedure TJasaWashingFrm.FormPaint(Sender: TObject);
begin
...
procedure TJasaWashingFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TJasaWashingFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TJasaWashingFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TJasaWashingFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TJasaWashingFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TJasaWashingFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TJasaWashingFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TJasaWashingFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TJasaWashingFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TJasaWashingFrm.tsInputShow(Sender: TObject);
begin
...
procedure TJasaWashingFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
  qBMasterKD_FORM.AsString:=vkd_transaksi;
  qBMasterTGL.AsDateTime:=vtgl_bukti;
  qBMasterKD_LOKASI.AsString:='631';
  qBMasterKD_LOKASI2.AsString:='632';
...
procedure TJasaWashingFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TJasaWashingFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TJasaWashingFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TJasaWashingFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TJasaWashingFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TJasaWashingFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TJasaWashingFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    else if (qBMasterID_PRINSIPAL.AsString='') then
    begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='221';
...
procedure TJasaWashingFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TJasaWashingFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TJasaWashingFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TJasaWashingFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TJasaWashingFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TJasaWashingFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
  qBDetailQTY_X.AsFloat:=qBDetailQTY_D.AsFloat*qBDetailRD.AsFloat;
end;

procedure TJasaWashingFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TJasaWashingFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TJasaWashingFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TJasaWashingFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TJasaWashingFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
      qBMaster.Post;
end;

procedure TJasaWashingFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TJasaWashingFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TJasaWashingFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TJasaWashingFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaWashingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaWashingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaWashingFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TJasaWashingFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaWashingFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaWashingFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaWashingFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaWashingFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TJasaWashingFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TJasaWashingFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TJasaWashingFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TJasaWashingFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TJasaWashingFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TJasaWashingFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  //qItem.ParamByName('pno_bom').AsFloat:='%';
end;

procedure TJasaWashingFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TJasaWashingFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TJasaWashingFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJasaWashingFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TJasaWashingFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TJasaWashingFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TJasaWashingFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TJasaWashingFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
end;

procedure TJasaWashingFrm.QRBand44BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:=IntToStr(StrToInt(qrlNoZ.Caption)+1);
end;

procedure TJasaWashingFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TJasaWashingFrm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  qBDetailKETERANGAN.AsString:=qItemNAMA_ITEM.AsString;
...
procedure TJasaWashingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
  DMFrm.qRekananSubkon.Open;
end;

procedure TJasaWashingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  qBMasterNAMA_PRINSIPAL.AsString:=DMfrm.qRekananSubkonNAMA_PRINSIPAL.AsString;
end;
