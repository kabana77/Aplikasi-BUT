...
type
  TPembelian2Frm = class(TForm)
    ...
    qB2NO_PL: TStringField;
    qB2NO_POLISI: TStringField;
    qB2NO_PO: TStringField;
    qB2NO_SJ: TStringField;
    qB2NO_BL: TStringField;
    qB2NO_CONTAINER: TStringField;
    qB2NO_SEAL: TStringField;
    qB2NAMA_KAPAL: TStringField;
    qB2JENIS_IMPOR: TStringField;
    qB2MU: TStringField;
    qB2KURS: TFloatField;
    qB2TOTAL_IDR: TFloatField;
    qItemSPESIFIKASI_TEKNIS: TStringField;
    qItemJML: TFloatField;
    qItemDITERIMA: TFloatField;
    qItemSISA: TFloatField;
...
procedure TPembelian2Frm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TPembelian2Frm.Proc_Refresh2;
var
  i           : word;
  vpertama    : boolean;
...
procedure TPembelian2Frm.Proc_Refresh3;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPembelian2Frm.Proc_Refresh4;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPembelian2Frm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPembelian2Frm.Proc_Refresh6;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPembelian2Frm.Proc_RefreshStokSales;
var
  i           : word;
  vpertama    : boolean;
  vFieldName  : array[0..50] of String;
...
procedure TPembelian2Frm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  Pembelian2Frm:=Nil;
end;

procedure TPembelian2Frm.FormPaint(Sender: TObject);
begin
...
procedure TPembelian2Frm.tbRefreshClick(Sender: TObject);
begin
...
procedure TPembelian2Frm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TPembelian2Frm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TPembelian2Frm.dbGrid1UpdateFooter(Sender: TObject);
begin
  {qBX.Close;
  qBX.SQL.Clear;
  ...
  qBX.SQL.Add('sum(nilai_idr) as nilai_faktur, sum(bayar) as bayar,');
  ...
  dbGrid1.ColumnByName('NILAI_IDR').FooterValue:=FormatFloat('#,#;(#,#);-', qBXNILAI_FAKTUR.AsFloat);
...
procedure TPembelian2Frm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TPembelian2Frm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TPembelian2Frm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPembelian2Frm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TPembelian2Frm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TPembelian2Frm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TPembelian2Frm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TPembelian2Frm.tsInputShow(Sender: TObject);
begin
...
begin
  ...
  qBMasterJENIS.AsString:='IMPOR';
end;

procedure TPembelian2Frm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TPembelian2Frm.qBMasterKD_LOKASIChange(Sender: TField);
begin
...
procedure TPembelian2Frm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TPembelian2Frm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TPembelian2Frm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TPembelian2Frm.qBDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.qBMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TPembelian2Frm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TPembelian2Frm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TPembelian2Frm.qBDetailKD_ITEMChange(Sender: TField);
begin
  ...
  begin
     ...
     qBDetailQTY_D.AsFloat:=qItemSISA.AsFloat;
     qBDetailQTY_D_ORDER.AsFloat:=qItemSISA.AsFloat;
  end;
end;

procedure TPembelian2Frm.dbGridDUpdateFooter(Sender: TObject);
begin
  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TPembelian2Frm.qBDetailXBeforeOpen(DataSet: TDataSet);
begin
  qBDetailX.ParamByName('pno_reg_os').AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TPembelian2Frm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
...
procedure TPembelian2Frm.Label34Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TPembelian2Frm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TPembelian2Frm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TPembelian2Frm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TPembelian2Frm.dbGridD2UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TPembelian2Frm.dbGridDEnter(Sender: TObject);
begin
  qItem.Close;
...
procedure TPembelian2Frm.qBMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPembelian2Frm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPembelian2Frm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TPembelian2Frm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo.Caption:='0';
end;

procedure TPembelian2Frm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TPembelian2Frm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vhal:=vhal+1;
end;

procedure TPembelian2Frm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.dbGrid2UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
...
procedure TPembelian2Frm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPembelian2Frm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:='0';
...
procedure TPembelian2Frm.qrMaster2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo2.Caption:='0';
end;

procedure TPembelian2Frm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo2D.Caption:=IntToStr(StrToInt(qrlNo2D.Caption)+1);
end;

procedure TPembelian2Frm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.qB4CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
  vjumlah:='';
...
procedure TPembelian2Frm.dbGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPembelian2Frm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPembelian2Frm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TPembelian2Frm.dbGrid3UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPembelian2Frm.dbGrid4UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPembelian2Frm.dbGrid5UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPembelian2Frm.dbGrid6UpdateFooter(Sender: TObject);
begin
  qB2X.Close;
  qB2X.SQL.Clear;
  qB2X.SQL.Add('select count(*) as ndata, SUM(TOTAL) AS TOTAL, sum(qty_a) as qty_a,sum(qty_t) as qty_t,');
...
procedure TPembelian2Frm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.TabSheet4Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TPembelian2Frm.qrMaster4BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo4.Caption:='0';
end;

procedure TPembelian2Frm.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.QRGroup4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:='0';
...
procedure TPembelian2Frm.QRBand11BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo4D.Caption:=IntToStr(StrToInt(qrlNo4D.Caption)+1);
end;

procedure TPembelian2Frm.qrMaster5BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo5.Caption:='0';
end;

procedure TPembelian2Frm.QRBand16BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.QRGroup5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:='0';
...
procedure TPembelian2Frm.QRBand18BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo5D.Caption:=IntToStr(StrToInt(qrlNo5D.Caption)+1);
end;

procedure TPembelian2Frm.qrMaster6BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo6.Caption:='0';
end;

procedure TPembelian2Frm.QRBand23BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.QRBand25BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:=IntToStr(StrToInt(qrlNo6D.Caption)+1);
end;

procedure TPembelian2Frm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo6D.Caption:='0';
...
procedure TPembelian2Frm.qrMaster3BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlNo3.Caption:='0';
end;

procedure TPembelian2Frm.QRBand32BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNo3.Caption:=IntToStr(StrToInt(qrlNo3.Caption)+1);
end;

procedure TPembelian2Frm.QRBand30BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPembelian2Frm.tbFilter2Click(Sender: TObject);
begin
...
procedure TPembelian2Frm.lcdEkspedisiEnter(Sender: TObject);
begin
  DMFrm.qEkspedisi.Open;
end;

procedure TPembelian2Frm.lcdEkspedisiUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPembelian2Frm.qBMasterID_EKSPEDISIChange(Sender: TField);
begin
...
procedure TPembelian2Frm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
  ...
  begin
      ...
      qItem.SQL.Add('sub_kelompok like ''%'+vmyfilter+'%''');
      qItem.Open;
  end;
end;

procedure TPembelian2Frm.tsInputDJurnalShow(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
...
procedure TPembelian2Frm.lcdItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPembelian2Frm.BitBtn2Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TPembelian2Frm.cbNoSeriClick(Sender: TObject);
begin
  qBDetail.Close;
...
procedure TPembelian2Frm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('PNO_PIB').AsString:=qBMasterNO_REG_OS_REFF.AsString;
end;

procedure TPembelian2Frm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;
