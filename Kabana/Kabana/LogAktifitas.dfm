object LogAktifitasFrm: TLogAktifitasFrm
  Left = 210
  Top = 214
  Width = 1200
  Height = 600
  Caption = 'LogAktifitasFrm'
  Color = clWindow
  Ctl3D = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'JAM'#9'16'#9'JAM'#9'F'
            'USER_NAME'#9'11'#9'USER_NAME'#9'F'
            'NO_BUKTI'#9'10'#9'NO_BUKTI'#9#9
            'AKTIFITAS'#9'19'#9'AKTIFITAS'#9'F'
            'CATATAN'#9'79'#9'CATATAN'#9#9)
  ...
  object qB1: TSmartQuery
    ...
    Left = 939
    Top = 24
    object qB1JAM: TDateTimeField
      FieldName = 'JAM'
      Required = True
      DisplayFormat = 'dd mmm yyyy hh:mm'
    end
    object qB1USER_NAME: TStringField
      FieldName = 'USER_NAME'
      Required = True
      Size = 50
    end
    ...
    object qB1AKTIFITAS: TStringField
      FieldName = 'AKTIFITAS'
      Size = 50
    end
