object InfoMutasiStokNBBFrm: TInfoMutasiStokNBBFrm
  Left = 360
  Top = 211
  Width = 1198
  Height = 600
  Caption = 'InfoMutasiStokNBBFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      ' where nama_prinsipal like :pnama_prinsipal and'
        ...
        ' kelompok in ('#39'PERALATAN PRODUKSI'#39','#39'PERALATAN KANTOR'#39','#39'KOMUTER &' +
        ' ASSESORIS'#39','#39'RUMAH TANGGA & UMUM'#39','#39'LAIN-LAIN'#39')'
      ')'
      ''
