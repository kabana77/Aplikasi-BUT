object HasilSewingFrm: THasilSewingFrm
  Left = 317
  Top = 128
  Width = 1382
  Height = 784
  Caption = 'HasilSewingFrm'
  Color = clWindow
  Ctl3D = False
      ...
      object tsInput: TTabSheet
        ...
        object pMaster: TPanel
          ...
          object wwDBLookupComboDlg1: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              'NO_REG_D'#9'10'#9'BOM'#9'F'#9
              'KD_PRODUKSI'#9'10'#9'PO'#9'F'#9
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.keterangan2'
      'from'
      '(select * from wip_sewing where kd_form='#39'214'#39') a'
      'left join wip_sewing_d b'
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_WIP_SEWING'
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from wip_sewing'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
      ...
      'where kd_kel='#39'40'#39' and substr(kd_item, 1, 6) = :pno_bom')
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_WIP_CUTTING'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_WIP_CUTTING(:PNO_REG_OS, :PNO_BUKTI);'
      'end;')
    Left = 944
    Top = 259
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_WIP_CUTTING:0'
  end
  ...
  object qBomD: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'where a.no_reg_os=b.no_reg_os and'
      
        'a.no_reg_d in (select distinct to_number(substr(kd_item,1,6)) fr' +
        'om wip_sewing_d)'
    ...
    object qBomDITEM: TStringField
      DisplayWidth = 20
      FieldName = 'ITEM'
      Required = True
      Size = 50
    end
    object qBomDSTYLE: TStringField
      DisplayWidth = 20
      FieldName = 'STYLE'
      Required = True
      Size = 128
    end
    object qBomDCOLOR: TStringField
      DisplayWidth = 15
      FieldName = 'COLOR'
      Required = True
      Size = 50
