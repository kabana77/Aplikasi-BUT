object WasteCuttingFrm: TWasteCuttingFrm
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'SAT_T'#9'12'#9'SATUAN'#9'T'#9'KONVERSI'
                'RD'#9'10'#9'RASIO'#9'F'#9'KONVERSI'
                'QTY_X'#9'10'#9'JUMLAH'#9'T'#9'KONVERSI'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select a.kd_item, a.nama_item as keterangan, to_char(a.no_reg_d2' +
        ') as no_bom, a.satuan as sat_d'
      'from bom_bahan a'
      'where to_char(a.no_reg_d2)=:pno_bom')
