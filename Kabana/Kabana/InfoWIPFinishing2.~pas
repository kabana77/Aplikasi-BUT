...
type
  TInfoWIPFinishing2Frm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  InfoWIPFinishing2Frm: TInfoWIPFinishing2Frm;

implementation

uses dm, Filter, DaftarPerkiraan, LaporanBC, InfoWIPCutting1,
  InfoWIPSewing1, InfoWIPSewing2;
...
procedure TInfoWIPFinishing2Frm.Proc_Refresh5;
var
  i           : word;
  vpertama    : boolean;
...
procedure TInfoWIPFinishing2Frm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  InfoWIPFinishing2Frm:=Nil;
end;

procedure TInfoWIPFinishing2Frm.FormPaint(Sender: TObject);
begin
...
procedure TInfoWIPFinishing2Frm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TInfoWIPFinishing2Frm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TInfoWIPFinishing2Frm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TInfoWIPFinishing2Frm.tbRefreshClick(Sender: TObject);
begin
...
procedure TInfoWIPFinishing2Frm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TInfoWIPFinishing2Frm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TInfoWIPFinishing2Frm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TInfoWIPFinishing2Frm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoWIPFinishing2Frm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TInfoWIPFinishing2Frm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TInfoWIPFinishing2Frm.tbPrintClick(Sender: TObject);
begin
  {
...
procedure TInfoWIPFinishing2Frm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPFinishing2Frm.CheckBox3Click(Sender: TObject);
begin
  qB6.Filtered:=CheckBox3.Checked;  //qB6.Filtered:=CheckBox3.Checked;
end;

procedure TInfoWIPFinishing2Frm.qB6FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(
...
procedure TInfoWIPFinishing2Frm.qB6CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoWIPFinishing2Frm.qB6BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB6.RecordCount);
end;

procedure TInfoWIPFinishing2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPFinishing2Frm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TInfoWIPFinishing2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPFinishing2Frm.QRBand22BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TInfoWIPFinishing2Frm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TInfoWIPFinishing2Frm.qBdetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoWIPFinishing2Frm.CheckBox1Click(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
...
procedure TInfoWIPFinishing2Frm.qB6AfterOpen(DataSet: TDataSet);
begin
  CheckBox1.Checked:=False;
end;

procedure TInfoWIPFinishing2Frm.wwDBGrid5RowChanged(Sender: TObject);
var
  t1, t2 : Real;
  i : Integer;
begin
