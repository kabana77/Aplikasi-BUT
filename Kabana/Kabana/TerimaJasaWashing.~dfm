object TerimaJasaWashingFrm: TTerimaJasaWashingFrm
  Left = 364
  Top = 152
  Width = 1382
  Height = 784
  Caption = 'TerimaJasaWashingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Penerimaan Jasa Washing'
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NO_REFF2'#9'15'#9'NO. REFF'#9'F'
            'TGL'#9'11'#9'TGL'#9'F'
            'ISPOST'#9'5'#9'POST'#9'F'
            'NAMA_PRINSIPAL'#9'20'#9'REKANAN'#9'F'
            ...
            'TGL_INSERT'#9'18'#9'TGL'#9'F'#9'PREPARE BY'
      ...
      object tsInput: TTabSheet
        Caption = '&Penerimaan Jasa Washing'
        ImageIndex = 1
        OnShow = tsInputShow
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_finishing where kd_form='#39'225'#39') a'
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_WIP_FINIS_SUBKON'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_WIP_FINIS_SUBKON(:PNO_REG_OS, :PNO_BUKTI);'
      'end;')
    Left = 936
    Top = 219
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_WIP_FINIS_SUBKON:0'
  end
