object Pembelian3Frm: TPembelian3Frm
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'ID_PRINSIPAL'#9'6'#9'ID'#9'F'#9'SUPLIER/CUSTOMER'
            'NAMA_PRINSIPAL'#9'20'#9'NAMA'#9'F'#9'SUPLIER/CUSTOMER'
            'NO_BOM'#9'8'#9'NO. BOM'#9'F'
            'NO_KONTRAK'#9'12'#9'NO KONTRAK'#9'F'#9'KONTRAK'
            'NO_REFF2'#9'20'#9'NO.REFF KONTRAK'#9'F'#9'KONTRAK'
            'ISPOST'#9'6'#9'POSTED'#9'F'
            'KD_ITEM'#9'10'#9'KODE'#9'F'#9'ITEM'
            'KETERANGAN'#9'25'#9'NAMA'#9'F'#9'ITEM'
            'QTY_D'#9'10'#9'QTY'#9'F'#9'ITEM'
            'SAT_D'#9'10'#9'SATUAN'#9'F'#9'ITEM'
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'KETERANGAN'#9'59'#9'NAMA ITEM'#9'T'
                'QTY_D'#9'15'#9'JUMLAH DITERIMA'#9'F'
                'SAT_D'#9'12'#9'SATUAN'#9'T'
                'NO_SERIAL'#9'16'#9'NO BOM'#9'F')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
      ...
      object TabSheet2: TTabSheet
        ...
        object dbGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_PRINSIPAL'#9'30'#9'Nama Prinsipal/ Suplier'#9'F'#9'PRINSIPAL/ SUPLIER'
  ...
  object qB1: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vpembelian_d_lokal3'
      '/*select * from vpembelian_lokal3*/')
    ReadOnly = True
    Left = 1123
    Top = 16
    ...
    object qB1NO_KONTRAK: TStringField
  ...
  object qItem: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select a.*, b.nama_prinsipal from daftar_item a'
      'left join daftar_prinsipal b on a.id_prinsipal=b.id_prinsipal'
      'where substr(a.kd_kel, 1, 2) in ('#39'17'#39', '#39'18'#39')'
    ...
    object qItemBCODE_A: TStringField
      FieldName = 'BCODE_A'
      Visible = False
    end
    object qItemKD_PRNSIPAL: TStringField
    ...
    object qItemTGL_UPDATE: TDateTimeField
      FieldName = 'TGL_UPDATE'
      Visible = False
    end
    object qItemOPR_UPDATE: TStringField
      FieldName = 'OPR_UPDATE'
      Visible = False
    end
    object qItemAKTIF: TStringField
      FieldName = 'AKTIF'
      Required = True
      Visible = False
      FixedChar = True
    ...
    object qItemNO_PEB: TFloatField
      FieldName = 'NO_PEB'
      Visible = False
    end
    ...
    object qItemSUB_TOTAL: TFloatField
      FieldName = 'SUB_TOTAL'
      Required = True
      Visible = False
    end
    ...
    object qItemPPN_PSN: TFloatField
      FieldName = 'PPN_PSN'
      Required = True
      Visible = False
    end
    object qItemPPH: TFloatField
      FieldName = 'PPH'
      Required = True
      Visible = False
    end
    object qItemPPNBN: TFloatField
      FieldName = 'PPNBN'
      Required = True
      Visible = False
    end
    object qItemKG_BERSIH: TFloatField
      FieldName = 'KG_BERSIH'
      Required = True
      Visible = False
    end
    object qItemJML_ISI: TFloatField
      FieldName = 'JML_ISI'
      Required = True
      Visible = False
    end
    object qItemPPN_BBS: TFloatField
      FieldName = 'PPN_BBS'
      Required = True
      Visible = False
    end
    object qItemPPH_BBS: TFloatField
      FieldName = 'PPH_BBS'
      Required = True
      Visible = False
    end
    object qItemPPNBN_BBS: TFloatField
      FieldName = 'PPNBN_BBS'
      Required = True
      Visible = False
    end
    object qItemISIMPOR: TStringField
      FieldName = 'ISIMPOR'
      Required = True
      Visible = False
      FixedChar = True
    ...
    object qItemKD_PARENT: TStringField
      FieldName = 'KD_PARENT'
      Visible = False
      Size = 12
    end
    object qItemKD_PARENT2: TFloatField
      FieldName = 'KD_PARENT2'
      Visible = False
    end
    object qItemKD_PARENT3: TFloatField
      FieldName = 'KD_PARENT3'
      Visible = False
    end
