object TerimaWasteFrm: TTerimaWasteFrm
  Left = 235
  Top = 140
  Width = 1432
  Height = 723
  Caption = 'TerimaWasteFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Penerimaan Waste'
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'KG_D'#9'12'#9'KG'#9'T'#9'WASTE'
                'RD'#9'10'#9'RASIO'#9'T'#9'WASTE'
                'QTY_D'#9'8'#9'YARD / PCS'#9'T'#9'WASTE'
                'SAT_D'#9'7'#9'SATUAN DASAR'#9'T'#9'WASTE'
                'KETERANGAN2'#9'30'#9'KETERANGAN'#9'T')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_WIP_WASTE'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_WIP_WASTE(:PNO_REG_OS, :PNO_BUKTI);'
      'end;')
    Left = 944
    Top = 259
    ParamData = <
  ...
  object qX: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from daftar_lokasi where kd_lokasi in ('#39'63'#39','#39'64'#39')')
    Left = 968
    Top = 80
    object qXKD_LOKASI: TStringField
      FieldName = 'KD_LOKASI'
      Required = True
      Size = 12
    end
    object qXNAMA_LOKASI: TStringField
      FieldName = 'NAMA_LOKASI'
      Size = 50
    end
    object qXKD_EXT: TStringField
      FieldName = 'KD_EXT'
      Size = 12
    end
  end
  object dsqX: TwwDataSource
    DataSet = qX
    Left = 931
    Top = 104
  end
