object LoadingHslFinishingFrm: TLoadingHslFinishingFrm
  Left = 283
  Top = 178
  Width = 1330
  Height = 656
  ActiveControl = dbGrid1
  Caption = 'LoadingHslFinishingFrm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = '&Daftar Loading Barang Jadi'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_finishing where kd_form='#39'235'#39') a'
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select distinct b.kd_item, b.keterangan as nama_item, to_number(' +
        'substr(b.kd_item,1,6)) as no_bom from wip_finishing a'
      'left join wip_finishing_d b on a.no_reg_os=b.no_reg_os'
      'where a.kd_form='#39'230'#39' and a.ispost='#39'1'#39
      ''
      '/*select * from daftar_item_wip'
      'where jenis_wip='#39'CUTTING'#39' and ispost='#39'1'#39'*/')
    Left = 832
    Top = 291
    ...
    object qItemNO_BOM: TFloatField
      FieldName = 'NO_BOM'
    end
  end
