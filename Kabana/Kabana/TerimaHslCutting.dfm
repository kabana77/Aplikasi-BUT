object TerimaHslCuttingFrm: TTerimaHslCuttingFrm
  Left = 246
  Top = 133
  Width = 1382
  Height = 784
  Caption = 'TerimaHslCuttingFrm'
  Color = clWindow
  Ctl3D = False
      ...
      object tsInput: TTabSheet
        ...
        object pMaster: TPanel
          ...
          object Label18: TLabel
            ...
            Width = 145
            Height = 13
            Caption = 'No. Bukti Loading hasil Cutting'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
  ...
  object qB1: TSmartQuery
    ...
    SQL.Strings = (
      ...
      'b.qty_d,'
      'b.keterangan2'
      'from (select * from wip_sewing where kd_form='#39'212'#39') a'
  ...
  object proc_ImpData: TOraStoredProc
    StoredProcName = 'PROC_AMBIL_WIP_SEWING'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_AMBIL_WIP_SEWING(:PNO_REG_OS, :PNO_BUKTI);'
      'end;')
    Left = 944
    Top = 259
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_AMBIL_WIP_SEWING:0'
  end
