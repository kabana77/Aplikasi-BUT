object CekBGCairFrm: TCekBGCairFrm
  Left = 115
  Top = 235
  Width = 1291
  Height = 679
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            'ISPOST;CheckBox;1;0')
          Selected.Strings = (
            'NO_CEK_BG_TT'#9'15'#9'NO_CEK_BG_TT'#9'F'
            'TGL_JTH_TEMPO'#9'10'#9'JTH_TEMPO'#9'F'
            'KETERANGAN'#9'46'#9'KETERANGAN'#9'F'
            'NO_BUKTI'#9'10'#9'Nomer'#9'T'#9'BUKTI TANDA TERIMA'
            'TGL_BUKTI'#9'10'#9'Tanggal'#9'F'#9'BUKTI TANDA TERIMA'
            'JNS_BAYAR'#9'10'#9'Jenis'#9'F'#9'BUKTI TANDA TERIMA'
            'NILAI'#9'11'#9'Nilai'#9'F'#9'BUKTI TANDA TERIMA'
            'NO_REG_OS'#9'10'#9'Nomer'#9'T'#9'PENCAIRAN'
            'ISPOST'#9'5'#9'Posted'#9'F'#9'PENCAIRAN'
            'JNS_CAIR'#9'9'#9'Status'#9'F'#9'PENCAIRAN'
            'TGL_CAIR'#9'10'#9'Tanggal'#9'F'#9'PENCAIRAN'
            'KD_PERK2'#9'9'#9'Kode'#9'F'#9'PENCAIRAN'
            'NAMA_PERKIRAAN2'#9'17'#9'Nama Perkiraan'#9'F'#9'PENCAIRAN')
          ...
          object PageControl2: TPageControl
            ...
            object tsInputD: TTabSheet
              ...
              object dbGridD: TwwDBGrid
                ...
                DittoAttributes.ShortCutDittoRecord = 16429
                ControlType.Strings = (
                  'NO_CEK_BG_TT;CustomEdit;ldcCekBg;F'
                  'JNS_CAIR;CustomEdit;dcCair;F'
                  'KD_PERK;CustomEdit;lcdPerkAll;F')
                Selected.Strings = (
                  'NO_CEK_BG_TT'#9'20'#9'NO_CEK_BG_TT'#9'F'
                  'JNS_CAIR'#9'9'#9'STATUS'#9'F'
                  'TGL_CAIR'#9'12'#9'TGL_CAIR'#9'F'
                  'KD_PERK'#9'7'#9'Kode'#9'F'#9'DEBET'
                  'NAMA_PERKIRAAN'#9'17'#9'Nama Perkiraan'#9'T'#9'DEBET'
                  'KD_PERK2'#9'7'#9'Kode'#9'T'#9'KREDIT'
                  'NAMA_PERKIRAAN2'#9'18'#9'Nama Perkiraan'#9'T'#9'KREDIT'
                  'NILAI'#9'13'#9'NILAI'#9'T'
                  'BIAYA'#9'13'#9'BIAYA'#9'F'
                  'SISA'#9'13'#9'SISA'#9'T')
                IniAttributes.FileName = 'KUWUNG'
                IniAttributes.Delimiter = ';;'
                IniAttributes.CheckNewFields = True
                ExportOptions.ExportType = wwgetSYLK
              ...
              object ldcCekBg: TwwDBLookupComboDlg
                Left = 176
                Top = 112
                Width = 121
                Height = 19
                ...
                OnUserButton1Click = ldcCekBgUserButton1Click
                Selected.Strings = (
                  'NO_CEK_BG_TT'#9'20'#9'NO_CEK_BG_TT'#9'F'
                ...
                DataSource = dsqBDetail
                LookupTable = qCekBG
                LookupField = 'NO_CEK_BG_TT'
                TabOrder = 1
                AutoDropDown = False
                ShowButton = True
                AllowClearKey = False
                OnEnter = ldcCekBgEnter
              end
              object dcCair: TwwDBComboBox
                Left = 184
                Top = 80
                Width = 121
                Height = 19
  ...
  object qB1: TSmartQuery
    ...
    object qB1NO_BUKTI: TFloatField
      FieldName = 'NO_BUKTI'
      Required = True
    end
    object qB1TGL_BUKTI: TDateTimeField
      FieldName = 'TGL_BUKTI'
      Required = True
      DisplayFormat = 'dd mmm yyyy'
    end
    ...
    object qB1JNS_CAIR: TStringField
      FieldName = 'JNS_CAIR'
      Size = 6
    end
    object qB1TGL_CAIR: TDateTimeField
      FieldName = 'TGL_CAIR'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qB1KD_PERK2: TStringField
      FieldName = 'KD_PERK2'
    end
  ...
  object qBMaster: TSmartQuery
    KeyFields = 'NO_REG_OS'
    KeySequence = 'SEQ_JURNAL_CBC'
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from cek_bg_cair'
  ...
  object qPerkiraan: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select fkd_perk_bank from dual')
    Left = 476
    Top = 363
    object qPerkiraanFKD_PERK_BANK: TStringField
      FieldName = 'FKD_PERK_BANK'
      Size = 4000
    end
  end
  ...
  object qBDetail: TSmartQuery
    ...
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from cek_bg_cair_d where no_reg_os=:no_reg_os')
    ...
    object qBDetailJNS_CAIR: TStringField
      FieldName = 'JNS_CAIR'
      Size = 6
    end
    object qBDetailTGL_CAIR: TDateTimeField
      FieldName = 'TGL_CAIR'
    end
    object qBDetailISPOST: TStringField
      FieldName = 'ISPOST'
      FixedChar = True
      Size = 1
    end
    object qBDetailNO_CEK_BG_TT: TStringField
      FieldName = 'NO_CEK_BG_TT'
      OnChange = qBDetailNO_CEK_BG_TTChange
    end
    ...
    object qBDetailKD_PERK2: TStringField
      FieldName = 'KD_PERK2'
      OnChange = qBDetailKD_PERK2Change
    end
    object qBDetailNAMA_PERKIRAAN2: TStringField
      FieldName = 'NAMA_PERKIRAAN2'
      Size = 100
    end
    object qBDetailNILAI: TFloatField
      FieldName = 'NILAI'
      DisplayFormat = '#,#;(#,#);-'
    end
    object qBDetailBIAYA: TFloatField
      FieldName = 'BIAYA'
      DisplayFormat = '#,#;(#,#);-'
    end
    object qBDetailSISA: TFloatField
      FieldName = 'SISA'
      DisplayFormat = '#,#;(#,#);-'
    end
  ...
  object qBDetailX: TOraQuery
    ...
    object qBDetailXNILAI: TFloatField
      FieldName = 'NILAI'
    end
    object qBDetailXBIAYA: TFloatField
      FieldName = 'BIAYA'
    end
    object qBDetailXSISA: TFloatField
      FieldName = 'SISA'
    end
  end
  object qAwal: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select sum(debet-kredit) as saldo_awal from vbukti_kas_kecil'
      'where tgl<:pawal')
  ...
  object qCekBG: TOraQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vdaftar_cek_bg_outstanding')
    Left = 346
    Top = 445
    object qCekBGNO_CEK_BG_TT: TStringField
      DisplayWidth = 20
      FieldName = 'NO_CEK_BG_TT'
      Required = True
    end
    object qCekBGTGL_JTH_TEMPO: TDateTimeField
      DisplayLabel = 'JTH_TEMPO'
      DisplayWidth = 12
      FieldName = 'TGL_JTH_TEMPO'
      DisplayFormat = 'dd mmm yyyy'
    end
    object qCekBGJNS_BAYAR: TStringField
      DisplayWidth = 12
      FieldName = 'JNS_BAYAR'
      Required = True
      Size = 12
    end
    object qCekBGNILAI: TFloatField
      DisplayWidth = 12
      FieldName = 'NILAI'
      Required = True
      DisplayFormat = '#,#;(#,#);-'
    end
    object qCekBGKETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Visible = False
      Size = 308
    end
    object qCekBGNO_BUKTI: TFloatField
      FieldName = 'NO_BUKTI'
      Required = True
      Visible = False
    end
    object qCekBGTGL_BUKTI: TDateTimeField
      FieldName = 'TGL_BUKTI'
      Required = True
      Visible = False
      DisplayFormat = 'dd mmm yyyy'
