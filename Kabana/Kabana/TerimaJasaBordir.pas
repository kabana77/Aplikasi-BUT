...
type
  TTerimaJasaBordirFrm = class(TForm)
    pLeft: TPanel;
    pCenter: TPanel;
    pRight: TPanel;
    pTop: TPanel;
...
var
  TerimaJasaBordirFrm: TTerimaJasaBordirFrm;
...
procedure TTerimaJasaBordirFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TTerimaJasaBordirFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  TerimaJasaBordirFrm:=Nil;
end;

procedure TTerimaJasaBordirFrm.FormPaint(Sender: TObject);
begin
...
procedure TTerimaJasaBordirFrm.tbRefreshClick(Sender: TObject);
begin
...
procedure TTerimaJasaBordirFrm.tbExportClick(Sender: TObject);
begin
   case PageControl1.TabIndex of
   0 :  begin
...
procedure TTerimaJasaBordirFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
  vkeyfield:='';
...
procedure TTerimaJasaBordirFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  pLeft2.Caption:=FormatFloat('#,#;0',qB1.RecordCount);
  //dbGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#);-', qBXSUB_TOTAL.AsFloat);
end;

procedure TTerimaJasaBordirFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TTerimaJasaBordirFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
  vbukti : String;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TTerimaJasaBordirFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
...
procedure TTerimaJasaBordirFrm.tbPrintClick(Sender: TObject);
var
  vfield_order : String;
begin
  case PageControl1.TabIndex of
...
procedure TTerimaJasaBordirFrm.qSlsmanBeforeOpen(DataSet: TDataSet);
begin
  qSlsman.ParamByName('pkd_depo').AsString:=DMFrm.qDepoDefaultKD_DEPO.AsString;
end;

procedure TTerimaJasaBordirFrm.tsInputShow(Sender: TObject);
begin
...
procedure TTerimaJasaBordirFrm.qBMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaJasaBordirFrm.lcLokasiEnter(Sender: TObject);
begin
  if not (Sender as TwwDBLookupCombo).LookupTable.Active then
     (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TTerimaJasaBordirFrm.qBMasterBeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TTerimaJasaBordirFrm.qBMasterBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaJasaBordirFrm.qBMasterBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TTerimaJasaBordirFrm.qBMasterBeforeOpen(DataSet: TDataSet);
begin
  qBMaster.ParamByName('PNO_REG_OS').AsFloat:=vno_reg;
end;

procedure TTerimaJasaBordirFrm.qBDetailNewRecord(DataSet: TDataSet);
begin
  qBDetailNO_REG_OS.AsFloat:=qBMasterNO_REG_OS.AsFloat;
end;

procedure TTerimaJasaBordirFrm.qBMasterBeforePost(DataSet: TDataSet);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DMFrm.Fno_Bukti.ParamByName('pkode_form').AsString:='207';
...
procedure TTerimaJasaBordirFrm.qBDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
      ShowMessage('Maaf, anda tidak berhak TAMBAH data !');
...
procedure TTerimaJasaBordirFrm.lcdItemEnter(Sender: TObject);
begin
  qItem.Open;
end;

procedure TTerimaJasaBordirFrm.lcdItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  qItem.Close;
  qItem.Open;
...
procedure TTerimaJasaBordirFrm.qBDetailKD_ITEMChange(Sender: TField);
begin
...
procedure TTerimaJasaBordirFrm.dbGridDUpdateFooter(Sender: TObject);
begin
{  qBDetailX.Close;
  qBDetailX.Open;
  if vModeInput then
...
procedure TTerimaJasaBordirFrm.qBDetailBeforePost(DataSet: TDataSet);
begin
  vModeInput:=True;
...
procedure TTerimaJasaBordirFrm.wwCheckBox1Click(Sender: TObject);
begin
  if vCanUnPost then
  begin
...
procedure TTerimaJasaBordirFrm.qBDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TTerimaJasaBordirFrm.tsInputD2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.Button1Click(Sender: TObject);
begin
  qStokSales.Close;
  qStokSales.Open;
end;

procedure TTerimaJasaBordirFrm.dbGridD2UpdateFooter(Sender: TObject);
begin
  //pLeft2.Caption:=FormatFloat('#,#;0',qBXNDATA.AsInteger);
end;

procedure TTerimaJasaBordirFrm.dbGridDEnter(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
end;

procedure TTerimaJasaBordirFrm.qStokSalesBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaJasaBordirFrm.dbGridD2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TTerimaJasaBordirFrm.tsInputDShow(Sender: TObject);
begin
  dbNavigator.DataSource:=dsqBMaster;
end;

procedure TTerimaJasaBordirFrm.qBDetailCalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaJasaBordirFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaJasaBordirFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaJasaBordirFrm.qrBuktiBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vhal:=0;
end;

procedure TTerimaJasaBordirFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaJasaBordirFrm.TabSheet2Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.qB2CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaJasaBordirFrm.qB3CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaJasaBordirFrm.qB5CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaJasaBordirFrm.qB6CalcFields(DataSet: TDataSet);
var
  vjumlah : String;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.dbGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.TabSheet3Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.TabSheet5Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.TabSheet6Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TTerimaJasaBordirFrm.tbFilter2Click(Sender: TObject);
begin
...
procedure TTerimaJasaBordirFrm.lcdItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vmyfilter : String;
begin
...
procedure TTerimaJasaBordirFrm.lcdNoSeriCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TTerimaJasaBordirFrm.lcdNoSeriEnter(Sender: TObject);
begin
...
procedure TTerimaJasaBordirFrm.BitBtn2Click(Sender: TObject);
begin
  if qBMaster.State<>dsBrowse then
    qBMaster.Post;
  vno_reg:=qBMasterNO_REG_OS.AsFloat;
...
procedure TTerimaJasaBordirFrm.qItemBeforeOpen(DataSet: TDataSet);
begin
  qItem.ParamByName('pno_reg_d2').AsFloat:=FloatField1.AsFloat;
end;

procedure TTerimaJasaBordirFrm.lcdBOMUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
...
procedure TTerimaJasaBordirFrm.lcdBOMEnter(Sender: TObject);
begin
  DMFrm.BOM.Close;
  DMFrm.BOM.Open;
end;

procedure TTerimaJasaBordirFrm.lcdBOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    BitBtn2Click(nil);
...
procedure TTerimaJasaBordirFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TTerimaJasaBordirFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLNoXX.Caption:=IntToStr(StrToInt(QRLNoXX.Caption)+1);
end;

procedure TTerimaJasaBordirFrm.Label34xClick(Sender: TObject);
begin
  if vCanUnPost then
  begin
    DMFrm.vcatatan:='';
...
procedure TTerimaJasaBordirFrm.qBDetail9BeforeOpen(DataSet: TDataSet);
begin
  qBDetail9.ParamByName('no_reg_d').AsString:=qBMasterNO_REFF.AsString;
end;

procedure TTerimaJasaBordirFrm.qBDetailBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaJasaBordirFrm.QRBand42BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlNoZ.Caption:='0';
...
procedure TTerimaJasaBordirFrm.TabSheet4Show(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  qJurnal.Close;
