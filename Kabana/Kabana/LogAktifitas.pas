...
type
  TLogAktifitasFrm = class(TForm)
    ...
    QRLabel16: TQRLabel;
    qrlDetail: TQRLabel;
    qB1JAM: TDateTimeField;
    qB1USER_NAME: TStringField;
    qB1NO_BUKTI: TFloatField;
    qB1AKTIFITAS: TStringField;
...
var
  LogAktifitasFrm: TLogAktifitasFrm;
...
procedure TLogAktifitasFrm.Proc_Refresh1;
var
  i           : word;
  vpertama    : boolean;
...
procedure TLogAktifitasFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
  LogAktifitasFrm:=Nil;
end;

procedure TLogAktifitasFrm.FormPaint(Sender: TObject);
begin
...
procedure TLogAktifitasFrm.qB1BeforeInsert(DataSet: TDataSet);
begin
  if not vCanADD then
  begin
...
procedure TLogAktifitasFrm.qB1BeforeEdit(DataSet: TDataSet);
begin
...
procedure TLogAktifitasFrm.qB1BeforeDelete(DataSet: TDataSet);
begin
  if not vCanDel then
  begin
...
procedure TLogAktifitasFrm.tbRefreshClick(Sender: TObject);
begin
  qB1.Refresh;
end;

procedure TLogAktifitasFrm.tbExportClick(Sender: TObject);
begin
...
procedure TLogAktifitasFrm.TabSheet1Show(Sender: TObject);
var
  i : integer;
begin
...
procedure TLogAktifitasFrm.wwDBGrid1IButtonClick(Sender: TObject);
var
  vFixedCol : String;
begin
...
procedure TLogAktifitasFrm.dbGrid1UpdateFooter(Sender: TObject);
begin
  qBX.Close;
  qBX.SQL.Clear;
...
procedure TLogAktifitasFrm.FormCreate(Sender: TObject);
begin
  pTop.Color          := clpTop;
  pLeft.Color         := clpLeft;
...
procedure TLogAktifitasFrm.tbFilterClick(Sender: TObject);
var
  i : Word;
begin
...
procedure TLogAktifitasFrm.dbGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLogAktifitasFrm.dbGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TLogAktifitasFrm.pTopClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
