object InfoWIPCutting2Frm: TInfoWIPCutting2Frm
  Left = 261
  Top = 139
  Width = 1364
  Height = 726
  Caption = 'InfoWIPCutting2Frm'
  Color = clWindow
  Ctl3D = False
  ...
  object pCenter: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet6: TTabSheet
        Caption = 'Info Mutasi WIP Cutting 2'
        ...
        object pData: TPanel
          ...
          object wwDBGrid5: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'SAT'#9'8'#9'SAT'#9'F'
              'QTY_AWAL'#9'12'#9'AWAL'#9'F'
              'QTY_IN'#9'10'#9'MASUK'#9'F'
              'QTY_OUT'#9'10'#9'KELUAR'#9'F'
              'CQTY_AKHIR'#9'12'#9'AKHIR'#9'F')
  ...
  object qB6: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_mutasi_cutting2'
      ''
      '/*select *'
  ...
  object procB6: TOraStoredProc
    StoredProcName = 'PROC_WIP_MUTASI_CUTTING2'
    Session = DMFrm.OS
    SQL.Strings = (
      'begin'
      '  PROC_WIP_MUTASI_CUTTING2(:PAWAL, :PAKHIR);'
      'end;')
    Left = 280
    Top = 299
    ParamData = <
    ...
    CommandStoredProcName = 'PROC_WIP_MUTASI_CUTTING2:0'
  end
  ...
  object qBdetail: TSmartQuery
    Session = DMFrm.OS
    SQL.Strings = (
      'select * from vwip_detail_mutasi_cutting2'
