object POFrm: TPOFrm
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'CATATAN'#9'9'#9'KELOMPOK'#9'F'
            'TGL_BERLAKU'#9'13'#9'TGL~BERLAKU'#9'F'
            'NO_REFF'#9'10'#9'NO. REFF'#9'F'
            'ID_PRINSIPAL'#9'5'#9'ID'#9'F'#9'S U P L I E R'
            'NAMA_PRINSIPAL'#9'26'#9'Nama'#9'F'#9'S U P L I E R'
            'ISPOST'#9'3'#9'Post'#9'F'#9'STATUS'
            'ISBATAL'#9'4'#9'Batal'#9'F'#9'STATUS'
            'TOP'#9'3'#9'TOP'#9'F'
            'DISC_X_RP'#9'1'#9'%'#9'F'#9'DISC'
            'DISC_X_PSN'#9'11'#9'Rp'#9'F'#9'DISC'
            'DPP'#9'7'#9'DPP'#9'F'#9'PPN'
            'PPN10'#9'8'#9'PPn11%'#9'F'#9'PPN'
            'NILAI_FAKTUR'#9'12'#9'Nilai'#9'F'#9'T O T A L'
            'BAYAR'#9'12'#9'CD/ DN'#9'F'#9'T O T A L'
            'NILAI_TAGIHAN'#9'12'#9'Tagihan'#9'F'#9'T O T A L'
            'OPR_INSERT'#9'18'#9'OPR'#9'T'#9'PREPARE BY'
            'TGL_INSERT'#9'18'#9'TGL'#9'T'#9'PREPARE BY'
            'OPR_APPROVE2'#9'18'#9'OPR'#9'F'#9'REVIEW BY'
            'TGL_APPROVE2'#9'18'#9'TGL'#9'F'#9'REVIEW BY'
            'OPR_APPROVE'#9'18'#9'OPR'#9'F'#9'APPROVE BY'
            'TGL_APPROVE'#9'18'#9'TGL'#9'F'#9'APPROVE BY')
      ...
      object tsInput: TTabSheet
        ...
        object qrBukti: TQuickRep
          ...
          Frame.DrawLeft = False
          Frame.DrawRight = False
          AfterPreview = qrBuktiAfterPreview
          DataSet = qBDetail
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          ...
          object QRBand38: TQRBand
            ...
            object QRLabel8: TQRLabel
              ...
              AutoSize = False
              AutoStretch = False
              Caption = 'Pembayaran akan dilakukan '
              Color = clWhite
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -13
            ...
            object QRLabel21: TQRLabel
              ...
              AutoSize = False
              AutoStretch = False
              Caption = 'hari setelah barang diterima'
              Color = clWhite
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -13
            ...
            object QRLabel22: TQRLabel
              ...
              AutoSize = False
              AutoStretch = False
              Caption = 'Masa berlaku P.O sampai'
              Color = clWhite
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -13
            ...
            object QRLabel23: TQRLabel
              ...
              AutoStretch = False
              Caption = 
                'Otomatis BATAL jika sampai pada tanggal tersebut belum ada pengi' +
                'riman sama sekali.'
              Color = clWhite
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
        ...
        object pMaster: TPanel
          ...
          object dbcCaraBayar: TwwDBComboBox
            Left = 7
            Top = 136
            Width = 92
            Height = 19
          ...
          object tsInputD: TTabSheet
            ...
            object dbGridD: TwwDBGrid
              ...
              ControlType.Strings = (
                ...
                'NO_BOM;CustomEdit;lcdBOM;F')
              Selected.Strings = (
                'KD_ITEM'#9'9'#9'KODE'#9'F'
                'KETERANGAN'#9'41'#9'KETERANGAN'#9'T'
                'PPN'#9'3'#9'PPN'#9'T'
                'SAT_D'#9'12'#9'SATUAN'#9'F'
                'QTY_D'#9'3'#9'JUMLAH'#9'F'
                'HRG_D'#9'5'#9'H A R G A'#9'F'
                'DISC_X_PSN'#9'5'#9'%'#9'F'#9'DISC'
                'DISC_X_RP'#9'7'#9'Rp'#9'F'#9'DISC'
                'SUB_TOTAL_GROSS'#9'13'#9'SUB TOTAL'#9'T'
                'NO_BOM'#9'17'#9'NO. BOM'#9'F')
              IniAttributes.Enabled = True
              IniAttributes.SaveToRegistry = True
              IniAttributes.FileName = 'KUWUNG'
              IniAttributes.Delimiter = ';;'
            ...
            object lcdItem: TwwDBLookupComboDlg
              ...
              Selected.Strings = (
                ...
                'SAT_D'#9'12'#9'SATUAN'#9'F'
                'PPN'#9'3'#9'PPN'#9'F'
                'NAMA_PRINSIPAL'#9'40'#9'SUPLIER'#9'F')
              DataField = 'KD_ITEM'
              DataSource = dsqBDetail
              LookupTable = qItem
              LookupField = 'KD_ITEM'
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Purchase Order &Detail'
        ImageIndex = 2
  ...
  object qB1: TSmartQuery
    ...
    object qB1TGL_APPROVE2: TDateTimeField
      FieldName = 'TGL_APPROVE2'
    end
    object qB1OPR_APPROVE2: TStringField
  ...
  object qBDetail: TSmartQuery
    ...
    object qBDetailNO_BOM: TFloatField
      FieldName = 'NO_BOM'
    end
  end
  ...
  object qPrinsipal: TOraQuery
    ...
    SQL.Strings = (
      ...
      'where /*jenis<>'#39'PRINSIPAL'#39' or*/ id_prinsipal<>'#39'00'#39)
    Left = 921
    Top = 208
  ...
  object qBMaster: TSmartQuery
    ...
    ParamData = <
      item
        ...
        Name = 'pno_reg_os'
        ParamType = ptInput
        Value = 1611000003.000000000000000000
      end>
    ...
    object qBMasterSTS_PO: TStringField
      FieldName = 'STS_PO'
      Size = 6
    end
    object qBMasterTGL_BERLAKU: TDateTimeField
      FieldName = 'TGL_BERLAKU'
      DisplayFormat = 'dd mmm yyyy'
    end
  ...
  object qItem: TOraQuery
    ...
    SQL.Strings = (
        ...
        'select * from (select * from vdaftar_item_aktif_bb where id_prin' +
        'sipal=:pid_prinsipal or id_prinsipal IN ('#39'00'#39','#39'50'#39'))')
    Left = 968
    Top = 211
    ParamData = <
      item
